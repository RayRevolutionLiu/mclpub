...
{
	/// <summary>
	/// Summary description for S_SearchCust1.
	/// </summary>
	public class S_SearchCust1 : System.Web.UI.Page
	{
...
//				Response.Write(dv[0].Row["cust_otp1seq1"]);
				...
				Response.Redirect("S_CustDetail.aspx?id="+DataGrid1.SelectedItem.Cells[2].Text.Trim()+"&type1=01&function1=new");
