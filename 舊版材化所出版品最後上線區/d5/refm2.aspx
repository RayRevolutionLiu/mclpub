<%@ Page language="c#" Src="refm2.aspx.cs" Codebehind="refm2.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.refm2" %>
						...
						<TR>
							<TD align="left" width="100%" vAlign="top" height="22">
								<FONT color="#333333" size="2"><IMG height="10" src="../images/header/right02.gif" width="10" border="0">
									...
									轉 SAP 發票摘要檔資料維護 <FONT color="dimgray">(
							...
							<TD align="left" width="100%">
								<asp:DataGrid id="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderColor="Black">
									...
									<Columns>
										...
										<asp:BoundColumn DataField="rm_remark" HeaderText="發票事由"></asp:BoundColumn>
										<asp:BoundColumn DataField="rm_deptcd" HeaderText="業務部門代號"></asp:BoundColumn>
										<asp:BoundColumn DataField="rm_accddr" HeaderText="發票借方總帳科目"></asp:BoundColumn>
										<asp:BoundColumn DataField="rm_idescr" HeaderText="發票明細品名"></asp:BoundColumn>
										<asp:BoundColumn DataField="rm_iunit" HeaderText="發票明細單位"></asp:BoundColumn>
										<asp:BoundColumn DataField="rm_iremark" HeaderText="發票明細備註"></asp:BoundColumn>
						...
						<TR height="40">
							<TD align="left" width="100%">
								...
								<asp:DropDownList id="ddlQueryField" runat="server">
									<asp:ListItem Value="rm_remark" Selected="True">發票事由</asp:ListItem>
									<asp:ListItem Value="sys_nm">系統代碼名稱</asp:ListItem>
									<asp:ListItem Value="rm_deptcd">業務部門代號</asp:ListItem>
								</asp:DropDownList>
