<%@ Page language="c#" Src="mailer_addnew.aspx.cs" Codebehind="mailer_addnew.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.mailer_addnew" %>
...
<HTML>
	...
	<body>
		<form id="mailer_addnew" method="post" runat="server">
			<P>
						...
						<TR>
							<TD align="left" width="100%">
								<FONT color="#333333" size="2"><IMG height="10" src="../images/header/right02.gif" width="10" border="0">&nbsp;共同檔案
									...
									<IMG height="10" src="../images/header/right02.gif" width="10" border="0"> 新增寄件人資料
								</FONT>
							</TD>
						</TR>
					</TABLE>
