...
{
    public partial class PubFm_label : System.Web.UI.Page
    {
        PubFm_label_DB myPub = new PubFm_label_DB();
        ...
        private void GetLabelData()
        {
            ...
            DataSet ds1 = myPub.SelectC2_cont();
        ...
        private HtmlGenericControl TdInside(DataView dv1, int judge)
        {
            ...
            if (Context.Request.QueryString["fgmosea"] == "0")
            {
                ...
                spandate.InnerHtml = "合約起訖：&nbsp;&nbsp;" + dv1[judge]["cont_sedate"].ToString() + "&nbsp;&nbsp;&nbsp;&nbsp;有登本數：" + dv1[judge]["or_pubcnt"].ToString() + "<br />";
            ...
            else
            {
                ...
                if (dv1[judge]["or_addr"].ToString().Trim().Length > 23)
                {
                    td2.Attributes.Add("style", "font-size: 9.5pt; font-weight: bold; width: 35%;");
                }
                else
                {
                    td2.Attributes.Add("style", "font-size: 10pt; font-weight: bold; width: 35%;");
                }
                tr.Controls.Add(td2);
                table.Controls.Add(tr);
                td.Controls.Add(table);
