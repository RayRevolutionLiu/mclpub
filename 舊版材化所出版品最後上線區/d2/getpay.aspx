<%@ Page language="c#" Codebehind="getpay.aspx.cs" Src="getpay.aspx.cs" AutoEventWireup="false" Inherits="MRLPub_d2.getpay" %>
...
<HTML>
	...
	<BODY ondblclick="doReOrder()" bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		...
		<center>
			...
			<!-- 標題 -->
			<DIV align="center">
				<B><FONT color="darkblue" size="5">催款單</FONT></B>
			</DIV>
			<!-- Run at Server Form -->
			<form ID="getpay" name="getpay" method="post" runat="server">
				網頁建構中...
				<br>
			</form>
			<br>
