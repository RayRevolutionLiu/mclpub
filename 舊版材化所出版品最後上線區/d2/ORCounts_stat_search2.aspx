...
<%@ Page language="c#" Codebehind="ORCounts_stat_search2.aspx.cs" Src="ORCounts_stat_search2.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d2.ORCounts_stat_search2" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>郵寄本數統計表 當月未刊登 步驟一: 搜尋</title>
	...
	<body>
		<center>
				...
				<tr>
					<td align="middle">
						<font color="#333333" size="2"><IMG height="10" src="../images/header/right02.gif" width="10" border="0">
							...
							統計表 當月未刊登 步驟一: 搜尋<IMG height="10" src="../images/header/right02.gif" width="10" border="0">
							郵寄本數統計表</font>
					</td>
				</tr>
			</table>
			&nbsp; 
			<!-- Run at Server Form -->
			<form id="ORCounts_stat_search2" method="post" runat="server">
				<!-- 查詢條件 Table -->
