<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AdrQueryPublished.aspx.cs" Inherits="mclpub.Layout.AdrQueryPublished" MaintainScrollPositionOnPostback="true" %>
<%@ Register Src="../UserControl/Pager.ascx" TagName="UCPager" TagPrefix="uc3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <span class="font_size12 font_darkblue font_bold">目前位置:&nbsp;落版管理 / 網路廣告落版處理 / 美編上稿處理</span>
    <span class="stripeMe">
    ...
    <span class="font_size13 font_bold font_gray">
        <ol>
            ...
            <li>查出資料後，按下<span class="font_darkblue">選定落版</span>可進行[美編上稿處理]</li>
            <li>如輸入確定的合約編號, 按下<span class="font_darkblue">GO</span>可直接進行[美編上稿處理]</li>
        </ol>
    </span>
    ...
    <span class="stripeMe">
        <asp:GridView ID="dgdCont" runat="server" Width="99%" AutoGenerateColumns="false"
            AllowPaging="True" PagerSettings-Visible="false" CssClass="font_blacklink font_size12"
            OnRowDataBound="dgdCont_RowDataBound">
            <Columns>
