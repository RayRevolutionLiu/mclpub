...
namespace MRLPub.d5
{
	...
	public class proj : System.Web.UI.Page
	{
		...
		public void BindGrid()
		{
			...
			string SQL = "SELECT *, dbo.proj.*, dbo.book.bk_nm AS bk_nm, dbo.syscd.sys_nm AS sys_nm, fgitri.fgitri_name AS fgitri_nm FROM dbo.proj INNER JOIN dbo.syscd ON dbo.proj.proj_syscd = dbo.syscd.sys_syscd INNER JOIN fgitri ON dbo.proj.proj_fgitri = fgitri.fgitri_fgitri LEFT OUTER JOIN dbo.book ON dbo.proj.proj_bkcd = dbo.book.bk_bkcd";
		...
		{
			Response.Redirect("proj_addnew.aspx");
		}
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			SqlDataAdapter cmd=new SqlDataAdapter("delete from proj where proj_projid=@proj_projid",myConn);
		
			cmd.SelectCommand.Parameters.Add("@proj_projid",SqlDbType.Int,4).Value=e.Item.Cells[0].Text;
		...
		private void DataGrid1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("proj_edit.aspx?" + id);
		}
