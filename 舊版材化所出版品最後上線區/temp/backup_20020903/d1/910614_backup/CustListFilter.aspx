<%@ Page language="c#" Codebehind="CustListFilter.aspx.cs" src="CustListFilter.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d1.CustListFilter" %>
...
<HTML>
	...
	<body>
		<form id="CustListFilter" method="post" runat="server">
			<FONT color="#333333" size="2"><IMG height="10" src="images/header/right02.gif" width="10" border="0">
				雜誌叢書訂閱次系統 <IMG height="10" src="images/header/right02.gif" width="10" border="0">
				訂單處理 <IMG height="10" src="images/header/right02.gif" width="10" border="0">訂戶明細表查詢
			</FONT>
			<br>
			<asp:label id="Label1" runat="server" Font-Bold="True" ForeColor="Blue">請選擇條件</asp:label>
			<HR width="100%" SIZE="1">
			<asp:checkbox id="cbx1" runat="server" Text="訂戶別："></asp:checkbox>
			...
			<br>
			<asp:checkbox id="cbx6" runat="server" Text="郵寄類別："></asp:checkbox>
			...
			<br>
			<asp:checkbox id="cbx7" runat="server" Text="雜誌收件人姓名："></asp:checkbox>
			<asp:textbox id="tbxRecName" runat="server"></asp:textbox>
			<br>
			<asp:checkbox id="cbx8" runat="server" Text="訂閱起迄："></asp:checkbox>
			<asp:textbox id="tbxDate" runat="server" Width="82px"></asp:textbox>
			<IMG class="ico" title="日曆" onclick="pick_date(tbxDate.name)" src="../images/calendar01.gif">
			<asp:Label id="Label2" runat="server" ForeColor="#C00000" Font-Size="X-Small">(此日期為訂閱起迄所包含的日期)</asp:Label>
			<br>
			...
			<asp:datagrid id="DataGrid1" runat="server" AutoGenerateColumns="False">
				<Columns>
					...
					<asp:BoundColumn DataField="od_custno" HeaderText="訂戶編號"></asp:BoundColumn>
					...
					<asp:BoundColumn DataField="ra_mtpcd" HeaderText="郵寄類別"></asp:BoundColumn>
				</Columns>
			</asp:datagrid>
		</form>
