...
{
	/// <summary>
	/// Summary description for ContPubFm_search.
	/// </summary>
	public class ContPubFm_search : System.Web.UI.Page
	{
		...
		private void ShowPub()
		{
			...
			for(i=0; i< DataGrid1.Items.Count ; i++)
			{
				...
				// 已註銷註記
				string strfgcancel = DataGrid1.Items[i].Cells[13].Text.ToString().Trim();
		...
		{
			Response.Redirect("ContPubFm_search.aspx");
		}
