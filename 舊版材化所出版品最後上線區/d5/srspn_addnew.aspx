<%@ Page language="c#" Src="srspn_addnew.aspx.cs" Codebehind="srspn_addnew.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.srspn_addnew" %>
...
<HTML>
	...
	<body>
		<form id="srspn_addnew" method="post" runat="server">
			<P>
				<FONT face="新細明體">
			...
			<TABLE cellSpacing="1" cellPadding="3" width="77%" bgColor="#bfcff0" border="0">
				<TR bgColor="#214389">
					<TD colSpan="4">
						<FONT color="#ffffff">新增管理業務人員資料</FONT>
					</TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD colSpan="3">
						<asp:dropdownlist id="ddlsrspn_atype" runat="server">
							...
							<asp:ListItem Value="D">D - 院外業務人員</asp:ListItem>
							<asp:ListItem Value="E">E - 訂戶人員</asp:ListItem>
							<asp:ListItem Value="F">F - 會計人員</asp:ListItem>
						</asp:dropdownlist>
					</TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD style="WIDTH: 282px" colSpan="2">
						...
						<IMG class="ico" title="日曆" onclick="pick_date(srspn_date.name)" src="../images/calendar01.gif">
