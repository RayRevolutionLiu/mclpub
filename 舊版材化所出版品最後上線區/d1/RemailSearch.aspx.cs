...
//			}
		...
		private void DataGrid1_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			{
				string	strbuf;
				strbuf = "RemailForm.aspx?id=" + DataGrid1.SelectedItem.Cells[0].Text;
				strbuf = strbuf + "&oritem=" + DataGrid1.SelectedItem.Cells[4].Text;
				strbuf = strbuf + "&date=" + DataGrid1.SelectedItem.Cells[8].Text;
				strbuf = strbuf + DataGrid1.SelectedItem.Cells[9].Text;
