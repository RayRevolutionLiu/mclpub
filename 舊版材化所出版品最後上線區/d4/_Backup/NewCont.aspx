<%@ Page language="c#" Codebehind="NewCont.aspx.cs" Src="NewCont.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d4.NewCont" %>
...
<form id=NewCont method=post runat="server"><FONT face=新細明體>
<DIV align=center>
...
<asp:ListItem Value="0" Selected="True">否</asp:ListItem>
      ...
      >
        ...
        <TR>
          ...
          <TD><asp:textbox id=tbxDisc runat="server" Font-Size="XX-Small" Width="80px"></asp:textbox><FONT 
            color=red size=2>(例: 0.8表示八折)</FONT></TD><FONT 
          color=red size=2></FONT></TR>
        <TR>
          <TD>
            <P align=right><FONT size=2 
            >總製圖檔稿次數：</FONT></P></TD>
          ...
          <TD>
            <P align=right><FONT size=2 
            >已開立發票金額：</FONT></P></TD>
          <TD><FONT size=2><asp:label id=lblInvedAmt runat="server"></asp:label></FONT></TD></TR>
        <TR>
          <TD>
            <P align=right><FONT size=2 
            >總製網頁稿次數：</FONT></P></TD>
  ...
  <TR>
    <TD bgColor=#214389 style="HEIGHT: 24px"><FONT color=white size=2>其他資料<IMG 
      onclick='doOpenMisc(<% Response.Write("\""+lblContNo.Text+"\""); %>)' alt=新增 src="new.gif" name=imgMisc>
<asp:imagebutton id=imgRefMisc runat="server" CausesValidation="False" ImageUrl="refresh.gif"></asp:imagebutton></FONT></TD></TR>
  <TR>
    <TD>
      <TABLE cellSpacing=0 cellPadding=1 width="100%" border=0 
      >
        <TR>
          <TD width="25%" colSpan=4><FONT color=red 
            size=2>由此填入廣告推廣內文、期限、產品設備內文、材料特性、應用產業等相關資料</FONT></TD></TR></TABLE>    
    
    </TD></TR>
  <TR>
    <TD bgColor=#214389><FONT color=white size=2 
      >發票廠商收件人資料<IMG alt="新增" src="new.gif" name="imgAddIM" onclick='doOpenInvMfr(<% Response.Write("\""+hidCustNo.Value+"\""); %>, <% Response.Write("\""+lblContNo.Text+"\""); %>, <% Response.Write("\""+hidOldContNo.Value+"\""); %>)'><asp:imagebutton id=imbRefIM runat="server" ImageUrl="refresh.gif" CausesValidation="False"></asp:imagebutton></FONT></TD></TR>
  <TR>
...
<asp:BoundColumn DataField="im_fgitri" HeaderText="院所內註記"></asp:BoundColumn>
  ...
  <TR>
    <TD bgColor=#214389><FONT color=white size=2 
      >雜誌收件人及贈書資料<IMG alt="詳細" src="new.gif" name=imgAddFreeBk onclick='doOpenFreeBk(<% Response.Write("\""+hidCustNo.Value+"\""); %>, <% Response.Write("\""+lblContNo.Text+"\""); %>, <% Response.Write("\""+hidOldContNo.Value+"\""); %>)'><asp:imagebutton id=imbRefFreeBk runat="server" ImageUrl="refresh.gif" CausesValidation="False"></asp:imagebutton></FONT></TD></TR>
  <TR>
...
<asp:BoundColumn Visible="False" DataField="fbk_fbkitem" HeaderText="fbkitem"></asp:BoundColumn>
  ...
  <TR>
    <TD bgColor=#214389><FONT color=white size=2 
      >網路廣告資料<IMG onclick='doOpenAdr(<% Response.Write("\""+lblContNo.Text+"\""); %>)' alt="" src="new.gif" name=imgAddAdr > 
<asp:imagebutton id=imbRefAdr runat="server" ImageUrl="refresh.gif"></asp:imagebutton></FONT></TD></TR>
  <TR>
...
<asp:BoundColumn DataField="adr_adcate" HeaderText="頁面"></asp:BoundColumn>
...
<asp:BoundColumn Visible="False" DataField="adr_drafttp" HeaderText="圖稿類別"></asp:BoundColumn>
<asp:BoundColumn Visible="False" DataField="adr_urltp" HeaderText="URL類別"></asp:BoundColumn>
</Columns>
</asp:datagrid></TD></TR></TABLE></DIV></FONT>
<P align=center><asp:button id=btnSaveCont runat="server" Text="儲存合約" CausesValidation="False"></asp:button><asp:button id=btnDiscardCont runat="server" Text="放棄合約" CausesValidation="False"></asp:button><INPUT 
id=hidOldContNo type=hidden name=hidOldContNo runat="server"> 
<INPUT id=hidCustNo type=hidden name=hidCustNo runat="server"><input id=hidIMCount type=hidden name=hidIMCount runat="server"></P></form>
...
function doOpenInvMfr(custno, new_contno, old_contno)
{
	...
	window.open("AddInvMfr.aspx?Act=New&CustNo=" + custno + "&NewContNo=" + new_contno + "&OldContNo=" + old_contno , "Poping", "toolbar=no,menubar=no,scrollbars=yes,resizable=yes,width=800,height=600", false);
}

function doOpenAdr(new_contno)
{
	var strQS = "Act=New&NewContNo=" + new_contno+ "&OldContNo=" + document.all("hidOldContNo").value;
...
{
	window.open("AddFreeBk.aspx?Act=New&CustNo=" + custno + "&NewContNo=" + new_contno + "&OldContNo=" + old_contno , "Poping", "toolbar=no,menubar=no,scrollbars=yes,resizable=yes,width=800,height=600", false);
}
