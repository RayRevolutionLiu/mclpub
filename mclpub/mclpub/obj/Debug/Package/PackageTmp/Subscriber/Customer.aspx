...
<span class="font_size12 font_darkblue font_bold">目前位置:&nbsp;客戶管理 / 廣告客戶資料維護</span>  
    <span class="stripeMe">
...
<asp:Button ID="AddNewBtn" runat="server" Text="新增客戶資料" CssClass="btn_mouseout" 
        ...
        <asp:Button ID="ExportExcel" runat="server" Text="列印清單" 
...
<span class="stripeMe">
    ...
    <Columns>
                ...
                <asp:BoundField DataField="cust_fax" HeaderText="傳真" HeaderStyle-Width="10%" />
                <asp:BoundField DataField="cust_cell" HeaderText="手機"/>
