...
<asp:Content id="Content1" ContentPlaceholderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
				...
				<input id="hiddenXML" type="hidden" name="hiddenXML" runat="server"> <input id="btnSave" onclick="doSubmit()" type="button" value="儲存訂單" class="btn_mouseout" onmouseover="this.className='btn_mouseover'" onmouseout="this.className='btn_mouseout'">
        ...
        $("#<% =tbxOrderDate.ClientID%>").datepicker(
{
    ...
    currentText: "今天"
		...
		<script language="javascript">
		    ...
		    xmlDoc1.loadXML(document.all("<% =hiddenXML.ClientID%>").value);
