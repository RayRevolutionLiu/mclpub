<%@ Page language="c#" Src="cust_edit.aspx.cs" Codebehind="cust_edit.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.cust_edit" %>
				...
				<TABLE cellSpacing="1" cellPadding="3" width="95%" bgColor="#bfcff0" border="0">
					...
					<TR>
						...
						<TD style="WIDTH: 255px">
							...
							<asp:requiredfieldvalidator id="RequiredFieldValidator1" runat="server" Display="Dynamic" ErrorMessage="必填欄位!" ControlToValidate="cust_custno"></asp:requiredfieldvalidator>
							<asp:regularexpressionvalidator id="Regularexpressionvalidator1" runat="server" Display="Dynamic" ErrorMessage="請輸入 6 位數字!" ControlToValidate="cust_custno" ValidationExpression="[0-9]{6}"></asp:regularexpressionvalidator>
					...
					<TR>
						...
						<TD style="WIDTH: 255px">
							...
							<asp:requiredfieldvalidator id="Requiredfieldvalidator2" runat="server" Display="Dynamic" ErrorMessage="必填欄位!" ControlToValidate="cust_nm"></asp:requiredfieldvalidator>
						</TD>
						<TD style="WIDTH: 81px">
							<P align="right">
								客戶職稱:
					...
					<TR>
						...
						<TD colSpan="2">
							...
							<asp:regularexpressionvalidator id="RegularExpressionValidator3" runat="server" ErrorMessage="格式錯誤!" ControlToValidate="cust_email" ValidationExpression=".{1,}@.{3,}"></asp:regularexpressionvalidator>
						</TD>
					</TR>
					<TR>
						<TD style="WIDTH: 83px">
						...
						<TD style="WIDTH: 255px">
							...
							<asp:regularexpressionvalidator id="Regularexpressionvalidator2" runat="server" Display="Dynamic" ErrorMessage="請依範例格式輸入!" ControlToValidate="cust_regdate" ValidationExpression="[0-9]{8}"></asp:regularexpressionvalidator>
						</TD>
						<TD style="WIDTH: 81px">
							<P align="right">
								修改日期:
					...
					<TR>
						...
						<TD vAlign="top" colSpan="4">
							<asp:checkboxlist id="cblcust_itpcd" tabIndex="1" runat="server" Width="98%" BorderStyle="Inset" BorderWidth="1px" RepeatColumns="6" RepeatDirection="Horizontal" BackColor="#E2EAFC"></asp:checkboxlist>
						</TD>
					</TR>
					<TR>
						<TD style="WIDTH: 83px">
						...
						<TD colSpan="4">
							<asp:checkboxlist id="cblcust_btpcd" tabIndex="1" runat="server" Width="98%" BorderStyle="Inset" BorderWidth="1px" RepeatColumns="6" RepeatDirection="Horizontal" BackColor="#E2EAFC"></asp:checkboxlist>
						</TD>
					</TR>
					<TR>
						<TD style="WIDTH: 83px">
						...
						<TD colSpan="4">
							<asp:checkboxlist id="cblcust_rtpcd" tabIndex="1" runat="server" Width="98%" BorderStyle="Inset" BorderWidth="1px" RepeatColumns="6" RepeatDirection="Horizontal" BackColor="#E2EAFC"></asp:checkboxlist>
						</TD>
					</TR>
					<TR>
						<TD colSpan="5">
