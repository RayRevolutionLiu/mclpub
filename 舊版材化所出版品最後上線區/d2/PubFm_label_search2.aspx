<%@ Page language="c#" Codebehind="PubFm_label_search2.aspx.cs" SRC="PubFm_label_search2.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d2.PubFm_label_search2" %>
<%@ Register TagPrefix="kw" TagName="Header" Src="../usercontrol/header.ascx" %>
<%@ Register TagPrefix="kw" TagName="Footer" Src="../usercontrol/footer.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>平面廣告標籤 當月未刊登 步驟一: 搜尋</title>
		...
		<table dataFld="items" id="tbItems" align="left" border="0">
			<tr>
				<td align="middle"><font color="#333333" size="2"><IMG height="10" src="../images/header/right02.gif" width="10" border="0">
						...
						平面廣告標籤: 當月未刊登 步驟一: 搜尋</font>
				</td>
			</tr>
		</table>
		&nbsp; 
		<!-- Run at Server Form -->
		<form id="PubFm_label_search2" method="post" runat="server">
