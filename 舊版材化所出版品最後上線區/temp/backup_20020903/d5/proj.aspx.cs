...
namespace MRLPub.d5
{
	...
	public class proj : System.Web.UI.Page
	{
		...
		public void BindGrid()
		{
			...
			string SQL = "SELECT dbo.proj.*, dbo.syscd.sys_nm AS sys_nm, dbo.book.bk_nm AS bk_nm FROM dbo.proj INNER JOIN dbo.syscd ON dbo.proj.proj_syscd = dbo.syscd.sys_syscd INNER JOIN dbo.book ON dbo.proj.proj_bkcd = dbo.book.bk_bkcd";
