<%@ Page language="c#" Codebehind="filterremaillabel.aspx.cs" src="filterremaillabel.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d1.filterremaillabel" %>
...
<HTML>
	...
	<body>
		<form id="filterremaillabel" method="post" runat="server">
