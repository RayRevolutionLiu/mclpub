<%@ Page language="c#" Codebehind="adpgsize_addnew.aspx.cs" Src="adpgsize_addnew.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d2.adpgsize_addnew" %>
...
<HTML>
	...
	<body>
		<center>
			...
			&nbsp; 
			<!-- Run at Server Form -->
			<form id="adpgsize_addnew" method="post" runat="server">
				<!-- 新增 Table -->
				<TABLE cellSpacing="1" cellPadding="3" width="55%" bgColor="#bfcff0" border="0">
					<TR bgColor="#214389">
						<TD colSpan="4">
							<FONT color="#ffffff">新增廣告篇幅</FONT>
						</TD>
					</TR>
					<TR>
						<TD width="30%">
