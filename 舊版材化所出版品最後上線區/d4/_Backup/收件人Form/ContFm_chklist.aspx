...
<HTML>
	...
	<body>
		...
		<form id="ContFm_chklist" method="post" runat="server">
			<asp:label id="lblQuery" runat="server">簽約日期區間：</asp:label>
			<asp:textbox id="tbxDate1" runat="server" MaxLength="10" Width="70px"></asp:textbox>
			<IMG class="ico" title="日曆" onclick="pick_date(tbxDate1.name)" src="../images/calendar01.gif">
			～<asp:textbox id="tbxDate2" runat="server" MaxLength="10" Width="70px"></asp:textbox>
			<IMG class="ico" title="日曆" onclick="pick_date(tbxDate2.name)" src="../images/calendar01.gif">
