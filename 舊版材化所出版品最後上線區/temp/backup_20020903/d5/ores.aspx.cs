...
namespace MRLPub.d5
{
	...
	/// </summary>
	public class ores : System.Web.UI.Page
	{
		...
		public void BindGrid()
		{
			...
			string DSN = System.Configuration.ConfigurationSettings.AppSettings["mrlpub2"].ToString();
		...
		{
			Response.Redirect("ores_addnew.aspx");
		}
		...
		{
			String strConn=System.Configuration.ConfigurationSettings.AppSettings["mrlpub2"].ToString();
			SqlConnection myConn=new SqlConnection(strConn);
			SqlDataAdapter cmd=new SqlDataAdapter("delete from c1_ores where ores_oresid=@ores_oresid",myConn);
		
			cmd.SelectCommand.Parameters.Add("@ores_oresid",SqlDbType.Int,4).Value=e.Item.Cells[0].Text;
		...
		private void DataGrid1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("ores_edit.aspx?" + id);
		}
