...
{
    public partial class PubFm_label_Internet : System.Web.UI.Page
    {
        ...
        private HtmlGenericControl TdInside(DataView dv1, int judge)
        {
            ...
            if (strfgMOSea == "0")
            {
                ...
                spandate.InnerHtml = "贈閱起訖：&nbsp;&nbsp;" + dv1[judge]["ma_sdate"].ToString() + "~" + dv1[judge]["ma_edate"].ToString() + "&nbsp;&nbsp;&nbsp;有登本數：" + dv1[judge]["ma_mnt"].ToString() + "<br />";
