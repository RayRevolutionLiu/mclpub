...
<script language="javascript">
    ...
    <span class="font_size12 font_darkblue font_bold">目前位置:&nbsp;廣告合約管理 / 平面廣告合約書 步驟三:修改合約書內容</span> 
    <center>
    <span class="stripeMe">
				<!--Table 開始-->
	<TABLE cellSpacing="0" cellPadding="4" width="92%" border="0" class="font_blacklink font_size13">
					...
					<TR>
						...
						<TD>
							<FONT color="red">*</FONT>
							<asp:textbox id="tbxSignDate" runat="server" MaxLength="10" CssClass="UniqueDate"></asp:textbox>
							&nbsp;<br>
