<%@ Page language="c#" Src="rtp_edit.aspx.cs" Codebehind="rtp_edit.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.rtp_edit" %>
...
<HTML>
	...
	<body>
		<form id="rtp_edit" method="post" runat="server">
			<P>
				<FONT face="新細明體">
			...
			<TABLE cellSpacing="1" cellPadding="3" width="60%" bgColor="#bfcff0" border="0">
				<TR bgColor="#214389">
					<TD colSpan="4">
						<FONT color="#ffffff">修改閱讀代碼資料</FONT>
					</TD>
				</TR>
				<TR>
					<TD style="WIDTH: 87px">
