<%@ Page language="c#" Src="refm2_addnew.aspx.cs" Codebehind="refm2_addnew.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.refm2_addnew" %>
...
<HTML>
	...
	<body>
		<form id="refm_addnew" method="post" runat="server">
			<P>
				<FONT face="新細明體">
			...
			<TABLE cellSpacing="1" cellPadding="3" width="77%" bgColor="#bfcff0" border="0">
				<TR bgColor="#214389">
					<TD colSpan="4">
						<FONT color="#ffffff">新增轉 SAP 發票摘要檔資料</FONT>
					</TD>
				</TR>
				<TR>
