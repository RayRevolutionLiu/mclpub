<%@ Page language="c#" Codebehind="payment.aspx.cs" Src="payment.aspx.cs" AutoEventWireup="false" Inherits="MRLPub_d2.payment" %>
...
<HTML>
	...
	<BODY ondblclick="doReOrder()" bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		...
		<center>
			...
			<!-- 標題 -->
			<DIV align="center">
				<B><FONT color="darkblue" size="5">繳款單</FONT></B>
			</DIV>
			<!-- Run at Server Form -->
			<form ID="payment" name="payment" method="post" runat="server">
				網頁建構中...
				<br>
			</form>
			<br>
