...
{
	/// <summary>
	/// Summary description for RptAdrBillQuery.
	/// </summary>
	public class RptAdrBillQuery : MRLPub.d4.Pages.Page
	{
		...
		protected System.Web.UI.WebControls.Button btnPrintBill;
		...
		private void btnPrintBill_Click(object sender, System.EventArgs e)
		{
			Literal1.Text = "";
			...
			else
			{
				...
				string strbuf;
				strbuf="RptAdrBill.aspx?whoami=" + this.WhoAmI.CName;
