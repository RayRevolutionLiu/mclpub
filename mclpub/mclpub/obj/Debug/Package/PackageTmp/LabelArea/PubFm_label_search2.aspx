<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PubFm_label_search2.aspx.cs" Inherits="mclpub.LabelArea.PubFm_label_search2"  MasterPageFile="~/MasterPage.Master"%>

<asp:Content id="Content1" ContentPlaceholderID="ContentPlaceHolder1" runat="server">
    <span class="font_size12 font_darkblue font_bold">目前位置:&nbsp;標籤管理 / 平面廣告標籤處理 / 合約內未刊登標籤</span>
<span class="stripeMe">
