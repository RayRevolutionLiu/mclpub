    ...
    public class contfm_chk_DB
    {
        ...
        public DataTable SelectC2_pub(string dpstr)
        {
            ...
            if (dpstr.ToString() == "1")
            {
                ...
                sb.Append(@"cont.cont_empno = dbo.srspn.srspn_empno WHERE 1=1 AND (cont_clrtm = 0) AND (cont_getclrtm = 0) AND (cont_menotm = 0) ORDER BY c2_cont.cont_contno DESC");
            }
            if (dpstr.ToString() == "2")
            {
                ...
                sb.Append(@" WHERE 1=1 AND (cont_fgtemp = '0') AND (cont_fgcancel = '0') AND (cont_fgpubed = '1') ORDER BY c2_cont.cont_contno DESC");
            }
