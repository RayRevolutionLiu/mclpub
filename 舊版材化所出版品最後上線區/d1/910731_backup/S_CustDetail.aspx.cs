...
{
	/// <summary>
	/// Summary description for S_CustDetail.
	/// </summary>
	public class S_CustDetail : System.Web.UI.Page
	{
		...
		private void dgdOrder_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			else if(e.CommandName=="OK")
			{
				...
				{
					if(Context.Request.QueryString["type1"]=="01")
						Response.Redirect("S_OrderForm.aspx?id="+Context.Request.QueryString["id"]+"&type1="+Context.Request.QueryString["type1"]+"&seq="+dgdOrder.SelectedItem.Cells[0].Text.Trim());
//					else if(Context.Request.QueryString["type1"]=="02")
...
//				}
		...
		{
			if(Context.Request.QueryString["type1"]=="01")
				Response.Redirect("S_OrderForm.aspx?id="+Context.Request.QueryString["id"]+"&type1="+Context.Request.QueryString["type1"]+"&seq1=000");
//			else if(Context.Request.QueryString["type1"]=="02")
