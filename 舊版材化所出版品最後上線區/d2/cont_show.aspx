<%@ Page language="c#" Codebehind="cont_show.aspx.cs" Src="cont_show.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d2.cont_show" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<TITLE>顯示合約書之歷史資料</TITLE>
	...
	<body>
		<center>
			...
			<!-- Run at Server Form -->
			<form id="cont_show" method="post" runat="server">
				<!--Table 開始-->
											...
											<TABLE dataFld="客戶資料" id="CustData" style="WIDTH: 100%" dataSrc="#DSO1" cellSpacing="0" cellPadding="4" bgColor="#bfcff0">
												<TR vAlign="center">
													...
													<TD class="cssData" width="32%">
														...
														&nbsp;&nbsp;(<asp:label dataFld="客戶編號" id="lblCustNo" ForeColor="Maroon" Runat="server"></asp:label>
							...
							<TD colSpan="4">
								<TABLE dataFld="合約書基本資料" id="ContBasicData" style="WIDTH: 100%" dataSrc="#DSO1" cellSpacing="0" cellPadding="4" bgColor="#bfcff0">
									...
									<TR>
										...
										<TD class="cssData">
											<FONT color="red">*</FONT> <INPUT dataFld="簽約日期" id="tbxSignDate" style="COLOR: gray" readOnly type="text" maxLength="10" size="10" name="tbxSignDate" runat="server">&nbsp;
									...
									<TR>
										...
										<TD class="cssData">
											&nbsp;&nbsp; <SELECT dataFld="書籍類別代碼" id="ddlBookCode" disabled name="ddlBookCode" runat="server"></SELECT>&nbsp;
									...
									<TR>
										...
										<TD class="cssData" noWrap>
											<FONT color="red">*</FONT> <INPUT dataFld="合約起日" id="tbxStartDate" style="WIDTH: 45px" disabled type="text" maxLength="7" size="7" name="tbxStartDate" runat="server">&nbsp;
											<font size="3">~</font> <FONT color="red">*</FONT> <INPUT dataFld="合約迄日" id="tbxEndDate" style="WIDTH: 45px" disabled type="text" maxLength="7" size="7" name="tbxEndDate" runat="server">
										...
										<TD class="cssData">
											<FONT color="red">* </FONT><SELECT id="ddlEmpNo" name="ddlEmpNo" runat="server" disabled></SELECT>&nbsp;
											<INPUT dataFld="承辦業務員工號" id="hiddenEmpNo" style="WIDTH: 45px" type="hidden" size="7" name="hiddenEmpNo" runat="server">
											<INPUT dataFld="" id="hiddenLoginEmpNo" style="WIDTH: 45px" type="hidden" size="7" name="hiddenLoginEmpNo" runat="server">&nbsp;
									...
									<TR>
										...
										<TD class="cssData" noWrap>
											&nbsp;&nbsp; <SELECT dataFld="一次付清註記" id="ddlfgPayOnce" disabled name="ddlfgPayOnce" runat="server">
												<OPTION value="1">
													是</OPTION>
									...
									<TR>
										...
										<TD class="cssData" noWrap>
											&nbsp;&nbsp; <SELECT dataFld="結案註記" id="ddlfgClosed" disabled name="ddlfgClosed" runat="server">
												<OPTION value="1">
													是</OPTION>
												<OPTION value="0" selected>
													否</OPTION></SELECT>
										...
										<TD class="cssData" vAlign="top">
											&nbsp;&nbsp;&nbsp; <INPUT dataFld="舊合約編號" id="tbxOldContNo" disabled type="text" maxLength="7" size="7" name="tbxOldContNo" runat="server">
										</TD>
									</TR>
									<TR>
										<TD class="cssTitle" noWrap align="right" bgColor="#bfcff0">
										...
										<TD class="cssData" vAlign="top">
											&nbsp;&nbsp;&nbsp; <SELECT id="ddlModEmpNo" name="ddlModEmpNo" runat="server" disabled></SELECT>&nbsp;
											<INPUT dataFld="" id="hiddenModEmpNo" style="WIDTH: 45px" type="hidden" size="7" name="hiddenModEmpNo" runat="server">&nbsp;
											<FONT face="新細明體" color="#c00000">(預設值: 登入者)</FONT>
										</TD>
									</TR>
								</TABLE>
										...
										<TD class="cssTitle" vAlign="center" align="middle" colSpan="4">
											<TABLE borderColor="#214389" cellSpacing="1" cellPadding="1" width="90%" border="0">
												<TR vAlign="center" align="left">
													...
													<TD class="cssData">
														<FONT color="red">*</FONT> <INPUT dataFld="總製稿次數" id="tbxTotalJTime" disabled maxLength="3" size="2" name="tbxTotalJTime" runat="server">
													</TD>
													<TD class="cssTitle" noWrap align="right">
														總刊登次數：
													</TD>
													<TD class="cssData">
														<FONT color="red">*</FONT> <INPUT dataFld="總刊登次數" id="tbxTotalTime" disabled maxLength="3" size="2" name="tbxTotalTime" runat="server">
													</TD>
													<TD class="cssTitle" align="right">
														<FONT color="#cc0099">(11)</FONT> 合約總金額：
													</TD>
													<TD class="cssData">
														<FONT color="red">* </FONT>$ <INPUT dataFld="合約總金額" id="tbxTotalAmt" disabled maxLength="8" size="5" name="tbxTotalAmt" runat="server">&nbsp;
												...
												<TR vAlign="center" align="left">
													...
													<TD class="cssData">
														&nbsp;&nbsp; <INPUT dataFld="已製稿次數" id="tbxMadeJTime" disabled maxLength="3" size="2" name="tbxMadeJTime" runat="server">
													</TD>
													<TD class="cssTitle" noWrap align="right">
														已刊登次數：
													</TD>
													<TD class="cssData">
														&nbsp;&nbsp; <INPUT dataFld="已刊登次數" id="tbxPubTime" disabled maxLength="3" size="2" name="tbxPubTime" runat="server">
													</TD>
													<TD class="cssTitle" align="right">
														已繳金額：
													</TD>
													<TD class="cssData">
														&nbsp; &nbsp; $ <INPUT dataFld="已繳金額" id="tbxPaidAmt" disabled maxLength="8" size="5" name="tbxPaidAmt" runat="server">
													</TD>
												</TR>
												<TR vAlign="center" align="left">
													<TD class="cssTitle" noWrap align="right">
													...
													<TD class="cssData">
														&nbsp;&nbsp; <INPUT dataFld="剩餘製稿次數" id="tbxRestJTime" disabled maxLength="3" size="2" name="tbxRestJTime" runat="server">
													</TD>
													<TD class="cssTitle" noWrap align="right">
														剩餘刊登次數：
													</TD>
													<TD class="cssData">
														&nbsp;&nbsp; <INPUT dataFld="剩餘刊登次數" id="tbxRestTime" disabled maxLength="3" size="2" name="tbxRestTime" runat="server">
													</TD>
													<TD class="cssTitle" align="right">
														剩餘金額：
													</TD>
													<TD class="cssData">
														&nbsp;&nbsp; $ <INPUT dataFld="剩餘金額" id="tbxRestAmt" disabled maxLength="8" size="5" name="tbxRestAmt" runat="server">
													</TD>
												</TR>
												<TR vAlign="center" align="left">
													<TD class="cssTitle" noWrap align="right">
													...
													<TD class="cssData">
														&nbsp;&nbsp; <INPUT dataFld="換稿次數" id="tbxChangeJTime" disabled maxLength="3" size="2" name="tbxChangeJTime" runat="server">
													</TD>
													<TD class="cssTitle" noWrap align="right">
														<FONT color="#cc0099">(9)</FONT> 贈送次數：
													</TD>
													<TD class="cssData">
														&nbsp;&nbsp; <INPUT dataFld="贈送次數" id="tbxFreeTime" disabled maxLength="3" size="2" name="tbxFreeTime" runat="server">
													</TD>
													<TD class="cssTitle" align="right">
														<FONT color="#cc0099">(9)</FONT> 優惠折數：
													</TD>
													<TD class="cssData">
														<FONT color="red">*&nbsp;&nbsp;&nbsp; </FONT><INPUT dataFld="優惠折數" id="tbxDiscount" disabled maxLength="6" size="4" name="tbxDiscount" runat="server">
												...
												<TR vAlign="center" align="left">
													...
													<TD class="cssData">
														&nbsp;&nbsp; <INPUT dataFld="彩色次數" id="tbxColorTime" disabled maxLength="3" size="2" name="tbxColorTime" runat="server">
													</TD>
													<TD class="cssTitle" noWrap align="right">
														黑白次數：
													</TD>
													<TD class="cssData">
														&nbsp;&nbsp; <INPUT dataFld="黑白次數" id="tbxMenoTime" disabled maxLength="3" size="2" name="tbxMenoTime" runat="server">
													</TD>
													<TD class="cssTitle" align="right">
														套色次數：
													</TD>
													<TD class="cssData">
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <INPUT dataFld="套色次數" id="tbxGetColorTime" disabled maxLength="3" size="2" name="tbxGetColorTime" runat="server">
													</TD>
												</TR>
											</TABLE>
										</TD>
							...
							<TD colSpan="4">
								<TABLE dataFld="廣告聯絡人資料" id="AdContactor" style="WIDTH: 100%" dataSrc="#DSO1" cellSpacing="0" cellPadding="4" bgColor="#bfcff0">
									...
									<TR>
										...
										<TD class="cssData">
											<FONT color="red">* </FONT><INPUT dataFld="廣告聯絡人姓名" id="tbxAuName" disabled maxLength="30" size="10" name="tbxAUName" runat="server">
									...
									<TR>
										...
										<TD class="cssData">
											<FONT color="red">* </FONT><INPUT dataFld="廣告聯絡人電話" id="tbxAUTel" disabled maxLength="30" size="10" name="tbxAUTel" runat="server">
											&nbsp; <FONT face="新細明體" color="#c00000">(預設同客戶資料!)</FONT>
										</TD>
										<TD class="cssTitle" noWrap align="right" bgColor="#bfcff0">
											傳真：
										...
										<TD class="cssData">
											&nbsp;&nbsp; <INPUT dataFld="廣告聯絡人傳真" id="tbxAUFax" disabled maxLength="30" size="10" name="tbxAUFax" runat="server">
											&nbsp; <FONT face="新細明體" color="#c00000">(預設同客戶資料!)</FONT>
										</TD>
									</TR>
									<TR>
										...
										<TD class="cssData">
											&nbsp;&nbsp; <INPUT dataFld="廣告聯絡人手機" id="tbxAUCell" disabled maxLength="30" size="10" name="tbxAUCell" runat="server">
										</TD>
										<TD class="cssTitle" noWrap align="right" bgColor="#bfcff0">
											Email：
										</TD>
										<TD class="cssData">
											&nbsp;&nbsp; <INPUT dataFld="廣告聯絡人Email" id="tbxAUEmail" disabled maxLength="80" size="20" name="tbxAUEmail" runat="server">
										</TD>
									</TR>
								</TABLE>
							</TD>
						...
						<TD>
							<TABLE dataFld="落版明細表" id="Table2" style="WIDTH: 100%" dataSrc="#DSO1" cellSpacing="0" cellPadding="4" bgColor="#bfcff0" border="0">
								<THEAD>
									<TR bgColor="#214389">
										<TD style="WIDTH: 100%" colSpan="11">
											<FONT color="#ffffff">(10~12) 合約書落版刊登資料</FONT>&nbsp; <FONT color="yellow" size="2">(若 
												"刊登年月" 一欄資料未填, 則該筆落版資料暫不做新增處理, 日後可再新增.)</FONT>
										</TD>
									</TR>
									<TR align="middle" borderColor="#bfcff0" bgColor="#bfcff0">
										...
										<TD>
											...
											<br>
											/ 書籍期別 <IMG class="ico" title="書籍期別參考資料" onclick="doGetBookp(tbxPubDate)" src="../images/edit.gif" border="0">
										</TD>
										<TD>
											刊登
											<br>
								...
								<TR align="middle" borderColor="#bfcff0" bgColor="#e2eafc">
									...
									<TD>
										<INPUT dataFld="序號" id="tbxPubSeq" disabled readOnly type="text" maxLength="2" size="2" value="1" name="tbxPubSeq">
									</TD>
									<TD>
										<FONT color="red">* </FONT><INPUT dataFld="刊登年月" id="tbxPubDate" disabled type="text" maxLength="6" size="6" name="tbxPubDate">
										/ <INPUT dataFld="書籍期別" id="tbxBkpPno" disabled type="text" maxLength="4" size="3" name="tbxBkpPno">
									</TD>
									<TD>
										<INPUT dataFld="刊登頁碼" id="tbxPageNo" disabled type="text" maxLength="3" size="3" name="tbxPageNo">
									</TD>
									<TD>
										<INPUT dataFld="固定頁次註記" id="tbxfgFixPage" disabled type="text" maxLength="1" size="3" name="tbxfgFixPage">
									</TD>
									<TD>
										<SELECT dataFld="廣告色彩代碼" id="ddlColorCode" disabled name="ddlColorCode" runat="server"></SELECT>
									</TD>
									<TD>
										<SELECT dataFld="廣告篇幅代碼" id="ddlPageSizeCode" disabled name="ddlPageSizeCode" runat="server"></SELECT>
									</TD>
									<TD>
										<SELECT dataFld="廣告版面代碼" id="ddlLTypeCode" disabled name="ddlLTypeCode" runat="server"></SELECT>
									</TD>
									<TD>
										<INPUT dataFld="到稿註記" id="" disabled type="text" maxLength="1" size="1" value="0" name="tbxfgGot">
									</TD>
									<TD>
		...
		//alert("xmlHeader.xml= " + xmlHeader.xml);
		...
		// 合約書落版刊登資料的功能按鈕: doAddNew, doDelete
			...
			function doAddNew(obj)	
			{
				...
				// 下二行 coding 與 cont_new3.aspx / cont_main3.aspx 不同
				xmlAdpubData.childNodes.item(idx).selectSingleNode("落版最後修改日期").text=PubModDate;
				xmlAdpubData.childNodes.item(idx).selectSingleNode("落版修改業務員工號").text=window.document.all("tbxEmpNo").value;
		...
		function doSubmit()
		{
			// 本段不同於 cont_new3.aspx & cont_main3.aspx
			// 本網頁不需要此功能, 因不須做 "儲存新增" 或 "儲存修改"
		}
		//-->
		</script>
	</body>
