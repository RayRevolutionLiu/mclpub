<%@ Page language="c#" Codebehind="cust_addnew.aspx.cs" src="cust_addnew.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.cust_addnew" %>
				...
				<TABLE cellSpacing="1" cellPadding="3" width="95%" bgColor="#bfcff0" border="0">
					...
					<TR>
						...
						<TD style="WIDTH: 255px">
							...
							<asp:requiredfieldvalidator id="RequiredFieldValidator1" runat="server" ControlToValidate="cust_custno" ErrorMessage="必填欄位!"
								Display="Dynamic"></asp:requiredfieldvalidator>
							<asp:regularexpressionvalidator id="Regularexpressionvalidator1" runat="server" ControlToValidate="cust_custno"
								ErrorMessage="請輸入 6 位數字!" Display="Dynamic" ValidationExpression="[0-9]{6}"></asp:regularexpressionvalidator>
					...
					<TR>
						...
						<TD style="WIDTH: 255px">
							...
							<asp:requiredfieldvalidator id="Requiredfieldvalidator2" runat="server" ControlToValidate="cust_nm" ErrorMessage="必填欄位!"
								Display="Dynamic"></asp:requiredfieldvalidator>
						</TD>
						<TD style="WIDTH: 81px">
							<P align="right">
					...
					<TR>
						...
						<TD colSpan="2">
							...
							<asp:regularexpressionvalidator id="RegularExpressionValidator3" runat="server" ControlToValidate="cust_email" ErrorMessage="格式錯誤!"
					...
					<TR>
						...
						<TD style="WIDTH: 255px">
							...
							<asp:regularexpressionvalidator id="Regularexpressionvalidator2" runat="server" ControlToValidate="cust_regdate"
								ErrorMessage="請依範例格式輸入!" Display="Dynamic" ValidationExpression="[0-9]{8}"></asp:regularexpressionvalidator>
						</TD>
						<TD style="WIDTH: 81px">
							<P align="right">
								修改日期:
					...
					<TR>
						...
						<TD vAlign="top" colSpan="4">
							<asp:checkboxlist id="cblcust_itpcd" tabIndex="1" runat="server" Width="98%" RepeatDirection="Horizontal"
								RepeatColumns="6" BorderWidth="1px" BorderStyle="Inset" BackColor="#E2EAFC"></asp:checkboxlist>
						</TD>
					</TR>
					<TR>
						<TD style="WIDTH: 83px">
						...
						<TD colSpan="4">
							<asp:checkboxlist id="cblcust_btpcd" tabIndex="1" runat="server" Width="98%" RepeatDirection="Horizontal"
								RepeatColumns="6" BorderWidth="1px" BorderStyle="Inset" BackColor="#E2EAFC"></asp:checkboxlist>
						</TD>
					</TR>
					<TR>
						...
						<TD colSpan="4">
							<asp:checkboxlist id="cblcust_rtpcd" tabIndex="1" runat="server" Width="98%" RepeatDirection="Horizontal"
								RepeatColumns="6" BorderWidth="1px" BorderStyle="Inset" BackColor="#E2EAFC"></asp:checkboxlist>
						</TD>
					</TR>
					<TR>
