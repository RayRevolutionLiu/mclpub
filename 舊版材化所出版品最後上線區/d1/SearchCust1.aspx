<%@ Page language="c#" Codebehind="SearchCust1.aspx.cs" src="SearchCust1.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d1.SearchCust1" %>
		...
		<form id="SearchCust1" method="post" runat="server">
			<center>
					...
					<tr>
						<td style="WIDTH: 627px" align="left">
							<font color="#333333" size="2"><IMG height="10" src="images/header/right02.gif" width="10" border="0">
								雜誌叢書訂閱次系統 <IMG height="10" src="images/header/right02.gif" width="10" border="0"><asp:label id="lblTitle1" Runat="server"></asp:label><IMG height="10" src="images/header/right02.gif" width="10" border="0">
								<asp:label id="lblTitle2" Runat="server"></asp:label>
								<IMG height="10" src="images/header/right02.gif" width="10" border="0">訂戶查詢 </font>
						</td>
					</tr>
				</table>
				<TABLE style="WIDTH: 610px" cellSpacing="0" cellPadding="2" bgColor="#bfcff0">
					...
					<TR>
						<td colSpan="2">
							<asp:datagrid id="DataGrid1" Runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderColor="#3366CC" BorderWidth="1px" BackColor="White" BorderStyle="None" CellPadding="2">
