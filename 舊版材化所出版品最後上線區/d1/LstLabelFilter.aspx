<%@ Page language="c#" Codebehind="LstLabelFilter.aspx.cs" src="LstLabelFilter.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d1.LstLabelFilter" %>
...
<HTML>
	...
	<body>
		<form id="LstLabelFilter" method="post" runat="server">
