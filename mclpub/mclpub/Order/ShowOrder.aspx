...
//        xmlDoc1.async = false;
//        xmlDoc1 = (new DOMParser()).parseFromString(document.all("hiddenXML").value, "text/xml");
//    } catch (e) {//Chrome,Safari  
//        var xmlhttpChrome = new window.XMLHttpRequest();
//        xmlhttpChrome.open("GET", document.all("hiddenXML").value, false);
//        xmlhttpChrome.send(null);
//        xmlDoc1 = xmlhttpChrome.responseXML.documentElement;
//    }
...
<script language="javascript">
    ...
    function doSelectrec(obj, win_height, win_width) {
        var idxtmp = obj.parentNode.parentNode.parentNode.getElementsByTagName("td")[0].firstChild.value;
