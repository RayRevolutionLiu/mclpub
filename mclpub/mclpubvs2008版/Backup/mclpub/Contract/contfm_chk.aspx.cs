        ...
        protected void GridView1OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string strconttp = e.Row.Cells[1].Text.Trim();
                    ...
                    BtnEdit.PostBackUrl = string.Format("javascript:location.href=\"PlaneCont2Edit.aspx?cust_custno={0}&cont_contno={1}\"", e.Row.Cells[20].Text.Trim(), e.Row.Cells[0].Text.Trim());

                    HyperLink System_SN = (HyperLink)e.Row.Cells[18].FindControl("HyperLink1");
                    System_SN.NavigateUrl = "javascript:doDetail('800','600','ContShowDetail.aspx?cust_custno=" + e.Row.Cells[20].Text.Trim() + "&cont_contno=" + e.Row.Cells[0].Text.Trim() + "&dpplane=true');";
            }
