...
//			this.tbxEndDate.Text = System.DateTime.Today.AddMonths(11).ToString("yyyy/MM").Trim();
			...
			if(Session["empid"]!=null && Session["empid"].ToString()!="")
			{
				...
				//this.ddlModEmpNo.SelectedIndex = this.ddlModEmpNo.Items.IndexOf(this.ddlModEmpNo.Items.FindByValue(LoginEmpNo));
			}
		...
		private void LoadOldCont()
		{
			...
			if(dv4.Count > 0)
			{
				...
				this.tbxADAoumt.Text = dv4[0]["cont_adamt"].ToString().Trim();
