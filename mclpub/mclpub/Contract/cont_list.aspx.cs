...
namespace mclpub.Contract
{
    public partial class cont_list : System.Web.UI.Page
    {
        ...
        protected void btnQuery_Click(object sender, EventArgs e)
        {
            try
            {
                string strSignDate1 = "", strSignDate2 = "", strStartDate = "", strEndDate = "";
                strSignDate1 = this.tbxSignDate1.Text.ToString().Trim();
                strSignDate1 = strSignDate1 == "" ? "" : strSignDate1.Substring(0, 4) + strSignDate1.Substring(5, 2) + strSignDate1.Substring(8, 2);
                strSignDate2 = this.tbxSignDate2.Text.ToString().Trim();
                strSignDate2 = strSignDate2 == "" ? "" : strSignDate2.Substring(0, 4) + strSignDate2.Substring(5, 2) + strSignDate2.Substring(8, 2);
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            fRed.Borders.Top.Style = TFlxBorderStyle.Medium;
            ...
            #region 懶得重新弄 直接把STYLE硬加上去讓底下的總和多出一條分隔線
            Xls.SetCellValue((dt.Rows.Count * 2) + 2 + 7, 1, "", xfRed);
            Xls.SetCellValue((dt.Rows.Count * 2) + 2 + 7, 2, "", xfRed);
            Xls.SetCellValue((dt.Rows.Count * 2) + 2 + 7, 3, "", xfRed);
            Xls.SetCellValue((dt.Rows.Count * 2) + 2 + 7, 4, "", xfRed);
            Xls.SetCellValue((dt.Rows.Count * 2) + 2 + 7, 5, "", xfRed);
            Xls.SetCellValue((dt.Rows.Count * 2) + 2 + 7, 6, "", xfRed);
            Xls.SetCellValue((dt.Rows.Count * 2) + 2 + 7, 7, "", xfRed);
            Xls.SetCellValue((dt.Rows.Count * 2) + 2 + 7, 8, "", xfRed);
            Xls.SetCellValue((dt.Rows.Count * 2) + 2 + 7, 9, "", xfRed);
            Xls.SetCellValue((dt.Rows.Count * 2) + 2 + 7, 12, "", xfRed);

            #endregion

            Xls.SetCellValue((dt.Rows.Count * 2) + 2 + 7, 10, totaltoa, xfRed);
            Xls.SetCellValue((dt.Rows.Count * 2) + 2 + 7, 11, "次數 (彩/黑/套)：", xfRed);
