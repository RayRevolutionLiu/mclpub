<%@ Page language="c#" Codebehind="njtype.aspx.cs" Src="njtype.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d2.njtype" %>
<%@ Register TagPrefix="kw" TagName="header" Src="../UserControl/header.ascx" %>
<%@ Register TagPrefix="kw" TagName="footer" Src="../UserControl/footer.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<TITLE>新稿製法 - 資料瀏覽</TITLE>
	...
	<body>
		<center>
			...
			<!-- Run at Server Form -->
			<form id="njtype" method="post" runat="server">
				<TABLE id="tbItems" cellSpacing="0" cellPadding="0" width="100%" border="0" align="center">
					...
					<TR>
						...
						<TD vAlign="top" width="*">
							<FONT title="書籍資料維護" color="#333333"><IMG height="10" src="../images/header/right02.gif" width="10" border="0">&nbsp;平面廣告次系統
								...
								<IMG height="10" src="../images/header/right02.gif" width="10" border="0"> 新稿製法 
								- 資料瀏覽 (
					...
					<TR>
						...
						<TD vAlign="top">
							<asp:datagrid id="DataGrid1" runat="server" BorderColor="Black" AutoGenerateColumns="False" AllowPaging="True" PageSize="10">
								...
								<Columns>
									<asp:BoundColumn Visible="False" DataField="njtp_njtpid" ReadOnly="True" HeaderText="ID"></asp:BoundColumn>
									<asp:BoundColumn DataField="njtp_njtpcd" HeaderText="新稿製法代碼"></asp:BoundColumn>
					...
					<TR>
						<TD colspan="2" align="left">
							<font size="2" color="darkred">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;註：為避免因資料被刪，導致舊資料讀取錯誤，若該筆已被使用，將不允許刪除！</font>
						</TD>
					</TR>
					<!-- 搜尋資料功能 -->
					<TR>
						...
						<TD>
							...
							<asp:dropdownlist id="ddlQueryField" runat="server">
								<asp:ListItem Value="njtp_nm" Selected="True">新稿製法名稱</asp:ListItem>
