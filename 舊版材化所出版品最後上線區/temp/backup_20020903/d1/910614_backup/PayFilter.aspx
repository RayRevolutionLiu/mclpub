...
<HTML>
	...
	<body>
		...
		<form id="PayFilter" method="post" runat="server">
			...
			<asp:label id="lblMessage" runat="server" Visible="False" ForeColor="#C000C0" Font-Size="X-Small">**請選擇欲付款之發票**</asp:label>
				...
				<ItemTemplate>
					<TABLE>
						<TR>
							...
							<TD>
								<asp:Label id="lblNo" Width="90" text='<%# DataBinder.Eval(Container.DataItem, "ia_refno")%>' Runat="server"></asp:Label>
							</TD>
							<TD>
								<asp:Label id="lblMfrno" Width="60" text='<%# DataBinder.Eval(Container.DataItem, "ia_mfrno")%>' Runat="server"></asp:Label>
							</TD>
							<TD>
								<asp:Label id="lblCompanyname" Width="160" text='<%# DataBinder.Eval(Container.DataItem, "mfr_inm")%>' Runat="server"></asp:Label>
							</TD>
							<TD>
								<asp:Label id="lblName" Width="90" text='<%# DataBinder.Eval(Container.DataItem, "ia_rnm")%>' Runat="server"></asp:Label>
							</TD>
							<TD>
								<asp:Label id="lblAmt" Width="90" text='<%# DataBinder.Eval(Container.DataItem, "ia_pyat")%>' Runat="server"></asp:Label>
							</TD>
						</TR>
					</TABLE>
				</ItemTemplate>
			...
			<asp:Label id="lblCount" runat="server" ForeColor="Maroon"></asp:Label>
		</form>
	</body>
</HTML>
