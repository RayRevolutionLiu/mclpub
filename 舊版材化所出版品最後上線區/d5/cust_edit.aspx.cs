...
namespace MRLPub.d5
{
	...
	public class cust_edit : System.Web.UI.Page
	{
		...
		private void InitData()
		{
			...
			string strConn2 = System.Configuration.ConfigurationSettings.AppSettings["itridpa_mrlpub"].ToString();
			...
			string custno = dv[0]["cust_custno"].ToString().Trim();
			string nm = dv[0]["cust_nm"].ToString().Trim();
			string jbti = dv[0]["cust_jbti"].ToString().Trim();
			string mfrno = dv[0]["cust_mfrno"].ToString().Trim();
			string tel = dv[0]["cust_tel"].ToString().Trim();
			string fax = dv[0]["cust_fax"].ToString().Trim();
			string cell = dv[0]["cust_cell"].ToString().Trim();
			string email = dv[0]["cust_email"].ToString().Trim();
			string regdate = dv[0]["cust_regdate"].ToString().Trim();
			//string moddate = dv[0]["cust_moddate"].ToString();
			string oldcustno = dv[0]["cust_oldcustno"].ToString().Trim();
			string itpcd = dv[0]["cust_itpcd"].ToString().Trim();
			string btpcd = dv[0]["cust_btpcd"].ToString().Trim();
			string rtpcd = dv[0]["cust_rtpcd"].ToString().Trim();
			...
			ddlEmpNo.DataBind();
			if(ddlEmpNo.Items.FindByValue(dv[0]["cust_srspn_empno"].ToString()) != null)
				ddlEmpNo.Items.FindByValue(dv[0]["cust_srspn_empno"].ToString()).Selected = true;
		}
