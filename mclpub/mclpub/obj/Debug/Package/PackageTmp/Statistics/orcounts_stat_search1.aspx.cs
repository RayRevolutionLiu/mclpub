...
{
    public partial class orcounts_stat_search1 : System.Web.UI.Page
    {
        ...
        public DataTable BindExcel()
        {
            ...
            DataSet ds = myORCount.Selectc2_cont(strBkcd, strYYYYMM, strConttp, fgMOSea, Mtpcd);
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                Xls.SetCellValue(i + 7, 2, dt.Rows[i]["or_contno"].ToString());
                Xls.SetCellValue(i + 7, 3, dt.Rows[i]["mfr_inm"].ToString());
                Xls.SetCellValue(i + 7, 4, dt.Rows[i]["mtp_nm"].ToString());
                Xls.SetCellValue(i + 7, 5, Convert.ToInt32(dt.Rows[i]["PubCounts"].ToString()));
                PubCounts += Convert.ToInt32(dt.Rows[i]["PubCounts"].ToString());
            }
            ...
            Common.excuteExcel(Xls, "ORCounts_stat2a.xls");
