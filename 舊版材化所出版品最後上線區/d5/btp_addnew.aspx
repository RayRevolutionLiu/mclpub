<%@ Page language="c#" Src="btp_addnew.aspx.cs" Codebehind="btp_addnew.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.btp_addnew" %>
	...
	<body>
		<form id="btp_addnew" method="post" runat="server">
			...
			<TABLE cellSpacing="1" cellPadding="3" width="60%" bgColor="#bfcff0" border="0">
				<TR bgColor="#214389">
					<TD colSpan="4">
						<FONT color="#ffffff">新增營業代碼資料</FONT>
					</TD>
				</TR>
				<TR>
					<TD style="WIDTH: 88px">
