...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-bottom: 0px; border-top:0px; border-style:none"
    runat="server" id="table_pager">
        <tr>
            <td>
            <div>
                <asp:LinkButton ID="lbtn_first" runat="server" OnClick="lbtn_first_Click" CausesValidation="false">首頁</asp:LinkButton>
                ...
                <ItemTemplate >
                    <asp:LinkButton ID="lbtn_page" runat="server" CommandArgument='<%#Eval("page") %>'
                        CausesValidation="false" OnClick="lbtn_page_Click"><%#Eval("page")%></asp:LinkButton>
                </ItemTemplate>
                </asp:Repeater>
                <asp:LinkButton ID="lbtn_nextpage" runat="server" Text=">" OnClick="lbtn_nextpage_Click"
                 ...
                 <asp:LinkButton ID="lbtn_next10page" runat="server" Text=">|" OnClick="lbtn_next10page_Click"
                     CausesValidation="false" />
                <asp:LinkButton ID="lbtn_last" runat="server" OnClick="lbtn_last_Click" CausesValidation="false">最末頁</asp:LinkButton>
