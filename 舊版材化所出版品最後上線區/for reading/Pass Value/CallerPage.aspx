<%@ Page language="c#" Codebehind="CallerPage.aspx.cs" AutoEventWireup="false" Inherits="TestProj.CallerPage" %>
...
<P>
    <IMG alt="PickMailTo" src="images/files.bmp" onclick="doMailTo()"> </P>
<P>
<INPUT type=hidden runat="server" id="HiddenData">
<asp:Button id=btnSave runat="server" Text="儲存訂單"></asp:Button></P>
    </form>
