...
namespace MRLPub.d5
{
	...
	/// </summary>
	public class btp_addnew : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				//起始值為末值加一
				SqlDataAdapter cmd=new SqlDataAdapter("select count(*) as C1,max(btp_btpcd) as MaxCountNo from btp",myConn);
				...
				btp_btpcd.Text=strAssignedContNo;
			}
		}
		...
		private void btnAddNew_Click(object sender, System.EventArgs e)
		{
			...
			{
				SqlDataAdapter cmd=new SqlDataAdapter("insert into btp(btp_btpcd,btp_nm) values(@btp_btpcd,@btp_nm)",myConn);
				...
				Response.Redirect("btp.aspx?ID=addnew_ok");
			}
