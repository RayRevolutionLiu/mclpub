<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ores.aspx.cs" Inherits="mclpub.Sys.ores" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        function submitBtn() {
            var ores_orescd = $('#<% =TextBoxores_orescd.ClientID%>');
            var ores_oresnm = $('#<% =TextBoxores_oresnm.ClientID%>');
            ...
            $.post("oresJudge.aspx", { ores_orescd: ores_orescd.val(), ores_oresnm: ores_oresnm.val() }, function (result) {
                if (result == "No!") {
                    alert('此筆資料已經存在!');
                }
                if (result == "Ok!") {
                    alert('新增成功!');
                    window.location.href = "ores.aspx";
                }
                if (result == "Error!") {
                    alert('資料錯誤!');
                }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <span class="font_size12 font_darkblue font_bold">目前位置:&nbsp;系統管理 / 訂單來源檔資料維護</span>
    ...
    <span class="stripeMe">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" PageSize="10"
            ...
            <Columns>
                <asp:BoundField DataField="ores_oresid" HeaderText="ID" />
                <asp:TemplateField HeaderText="訂單來源代碼">
                    <ItemTemplate>
                        <asp:TextBox ID="TextBoxores_orescd" runat="server" MaxLength="2" Width="80px" Text='<%# Bind("ores_orescd") %>' Visible="false" onkeyup="return ValidateNumber($(this),value)"></asp:TextBox>
                        <asp:Label ID="Labelores_orescd" runat="server" Text='<%# Bind("ores_orescd") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="訂單來源名稱">
                    <ItemTemplate>
                        <asp:Label ID="Labelores_oresnm" runat="server" Text='<%# Bind("ores_oresnm") %>'></asp:Label>
                        <asp:TextBox ID="TextBoxores_oresnm" runat="server" Width="80px" Visible="false"  Text='<%# Bind("ores_oresnm") %>' MaxLength="12">
                        </asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
    ...
    <div id="dialog" style="text-align: left; display: none;" title="新增 訂單來源檔資料">
        <span class="stripeMe">
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxores_orescd" runat="server" MaxLength="2" Width="35px" onkeyup="return ValidateNumber($(this),value)"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:textbox id="TextBoxores_oresnm" runat="server" MaxLength="12"></asp:textbox>
                    </td>
                </tr>
            </table>
        </span>
