...
{
	/// <summary>
	/// Summary description for cont_main1.
	/// </summary>
	public class cont_main1 : System.Web.UI.Page
	{
		...
		protected System.Web.UI.WebControls.Label lblEmplain;
		...
		private void ShowCont()
		{
			...
			if(Session["atype"].ToString().Equals("D"))
				rowfilterstr=rowfilterstr+" and cust_mfrno in (" + this.FindMfrByEmpno(Session["empid"].ToString()) + ")";
		...
		private void DataGrid1_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			else if(e.CommandName=="OK")
			{
				...
				//// 按下確定(挑人)的處理: 先轉址
				Response.Redirect("cont_main2.aspx?function1=mod&custno="+DataGrid1.SelectedItem.Cells[4].Text.Trim());
				//if(Context.Request.QueryString["conttp"]=="01")
					//Response.Redirect("cont_main2.aspx?function1=mod&custno="+DataGrid1.SelectedItem.Cells[4].Text.Trim() + "&conttp=01");
				//else if(Context.Request.QueryString["conttp"]=="09")
					//Response.Redirect("cont_main2.aspx?function1=mod&custno="+DataGrid1.SelectedItem.Cells[4].Text.Trim() + "&conttp=09");
