...
{
    public partial class PubFm_label_search : System.Web.UI.Page
    {
        ...
        private DataSet ReturnDataSet()
        {
            ...
            DataSet ds3 = myPub.SelectC2_cont(strBkcd, strConttp, strEmpNo, fgMOSea, strMtpcd, strYYYYMM);
        ...
        private void BindGrid1()
        {
            ...
            if (ReturnDataSet().Tables[0].Rows.Count > 0)
            {
                ...
                lblMessage.Text = "查詢結果: 找到 " + ReturnDataSet().Tables[0].Rows.Count + " 筆雜誌收件人資料!";
            }
            else
            {
        ...
        protected void btnPrintList_Click(object sender, EventArgs e)
        {
            ...
            {
                if (dt.Rows[i]["or_contno"].ToString() == preNo)
                {
                ...
                totalcount = totalcount + Convert.ToInt32(dt.Rows[i]["or_pubcnt"].ToString());
            }
