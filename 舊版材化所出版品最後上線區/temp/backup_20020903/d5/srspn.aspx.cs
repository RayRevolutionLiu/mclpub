...
namespace MRLPub.d5
{
	...
	/// </summary>
	public class srspn : System.Web.UI.Page
	{
		...
		public void BindGrid()
		{
			...
			string SQL = "SELECT dbo.srspn.*, dbo.itriorg.io_orgcname AS OrgAbbName FROM dbo.srspn INNER JOIN dbo.itriorg ON dbo.srspn.srspn_orgcd = dbo.itriorg.io_orgcd order by srspn_atype";
		...
		{
			Response.Redirect("srspn_addnew.aspx");
		}
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			SqlDataAdapter cmd=new SqlDataAdapter("delete from srspn where srspn_id=@srspn_id",myConn);
		
			cmd.SelectCommand.Parameters.Add("@srspn_id",SqlDbType.Int,4).Value=e.Item.Cells[0].Text;
		...
		private void DataGrid1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("srspn_edit.aspx?" + id);
		}
