...
namespace MRLPub.d5
{
	...
	/// </summary>
	public class refm2 : System.Web.UI.Page
	{
		...
		public void BindGrid()
		{
			...
			string SQL = "SELECT dbo.refm.*, dbo.syscd.sys_nm AS sys_nm FROM dbo.refm INNER JOIN dbo.syscd ON dbo.refm.rm_syscd = dbo.syscd.sys_syscd";
		...
		{
			Response.Redirect("refm2_addnew.aspx");
		}
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			SqlDataAdapter cmd=new SqlDataAdapter("delete from refm where rm_rmid=@rm_rmid",myConn);
		
			cmd.SelectCommand.Parameters.Add("@rm_rmid",SqlDbType.Int,4).Value=e.Item.Cells[0].Text;
		...
		private void DataGrid1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("refm2_edit.aspx?" + id);
		}
