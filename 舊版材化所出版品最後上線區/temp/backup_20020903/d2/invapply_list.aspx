<%@ Page language="c#" Codebehind="invapply_list.aspx.cs" Src="invapply_list.aspx.cs" AutoEventWireup="false" Inherits="MRLPub_d2.invapply_list" %>
...
<HTML>
	...
	<BODY ondblclick="doReOrder()" bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		...
		<center>
			...
			<!-- 標題 -->
			<DIV align="center">
				<B><FONT color="darkblue" size="5">發票開立清單</FONT></B>
			</DIV>
			<!-- Run at Server Form -->
			<form ID="invapply_list" name="invapply_list" method="post" runat="server">
				<!-- 暫時連結 Excel 檔 -->
				<a href="invapply_list.xls" class="external">參考樣章</a>
				<br>
			</form>
			<br>
			<!-- 頁尾 Footer -->
