...
{
	/// <summary>
	/// Summary description for njtype.
	/// </summary>
	public class njtype : System.Web.UI.Page
	{
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			// 抓出 廣告相關欄位之值
			string strnjtpcd = e.Item.Cells[1].Text.ToString();
			//Response.Write("strnjtpcd= "+ strnjtpcd + "<BR>");

			// 執行 將值塞入 sqlCommand1.Parameters 中, 以執行 篩選資料
			this.sqlSelectCommand1.Parameters["@njtpcd"].Value = strnjtpcd;
			...
			else
			{
				...
				SqlDataAdapter cmd=new SqlDataAdapter("delete from c2_njtp where njtp_njtpid=@njtp_njtpid",myConn);

				cmd.SelectCommand.Parameters.Add("@njtp_njtpid",SqlDbType.Int,4).Value=e.Item.Cells[0].Text;
		...
		private void DataGrid1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("njtype_edit.aspx?" + id);
		}
		...
		{
			Response.Redirect("njtype_addnew.aspx");
		}
		...
		private void InitializeComponent()
		{
			...
			// sqlSelectCommand1
			//
			this.sqlSelectCommand1.CommandText = @"SELECT COUNT(dbo.c2_pub.pub_contno) AS PubCounts, dbo.c2_njtp.njtp_njtpcd, RTRIM(dbo.c2_njtp.njtp_nm) AS njtp_nm FROM dbo.c2_njtp INNER JOIN dbo.c2_pub ON dbo.c2_njtp.njtp_njtpcd = dbo.c2_pub.pub_njtpcd WHERE (dbo.c2_njtp.njtp_njtpcd = @njtpcd) GROUP BY dbo.c2_njtp.njtp_njtpcd, dbo.c2_njtp.njtp_nm";
			this.sqlSelectCommand1.Connection = this.sqlConnection1;
			this.sqlSelectCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@njtpcd", System.Data.SqlDbType.VarChar, 2, "njtp_njtpcd"));
			//
			// sqlConnection1
			//
