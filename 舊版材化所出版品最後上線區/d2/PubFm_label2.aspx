<%@ Page language="c#" Codebehind="PubFm_label2.aspx.cs" Src="PubFm_label2.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d2.PubFm_label2" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>平面廣告標籤 當月未刊登</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="PubFm_label2" method="post" runat="server">
			<asp:datalist id="DataList1" runat="server" RepeatColumns="2" BorderColor="Black" ShowHeader="False" ShowFooter="False" Width="100%" CellPadding="0" RepeatDirection="Horizontal" BorderWidth="0px">
				...
				<ItemTemplate>
					...
					<asp:Label id="lblPubCnt1" runat="server" Font-Names="新細明體">
								未登本數：<%# DataBinder.Eval(Container.DataItem, "or_unpubcnt") %>
						</asp:Label><BR>
					&nbsp;&nbsp;&nbsp;&nbsp;
...
<asp:Label id="lblConttp1" runat="server" Font-Names="新細明體">
			...
			<asp:datalist id="DataList2" runat="server" RepeatColumns="2" ShowHeader="False" ShowFooter="False" Width="100%" CellPadding="5" RepeatDirection="Horizontal">
				...
				<ItemTemplate>
					...
					<asp:Label id="lblPubCnt2" runat="server" Font-Names="新細明體">
								未登本數：<%# DataBinder.Eval(Container.DataItem, "or_unpubcnt") %>
						</asp:Label><BR>
					&nbsp;&nbsp;
