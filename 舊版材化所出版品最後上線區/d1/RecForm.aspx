...
<HTML>
	...
	<body>
		<form id="RecForm" method="post" runat="server">
			...
			<TABLE id="table2" dataSrc="#DSO2" cellSpacing="0" cellPadding="0" border="0">
				...
				<tbody bgColor="#e7e7ff">
					<TR>
						...
						<TD>
							<input dataFld="公司名稱" id="tt" style="WIDTH: 60px; HEIGHT: 22px" type="text" maxLength="40" size="7" name="tt">
						</TD>
						<TD>
			...
			<br>
			&nbsp;
			<asp:Label id="Label1" runat="server" Font-Size="X-Small" ForeColor="#C04000">註:<br>姓名欄位限制:15個中文 或 30個英文<br>公司名稱欄位限制:20個中文 或 40個英文</asp:Label>
		</form>
