...
namespace MRLPub.d5
{
	...
	public class cust_addnew : System.Web.UI.Page
	{
		...
		private void InitData()
		{
			...
			string strConn3 = System.Configuration.ConfigurationSettings.AppSettings["mrlpub3"].ToString();
		...
		private void btnAddNew_Click(object sender, System.EventArgs e)
		{
			...
			else
			{
				SqlDataAdapter cmd=new SqlDataAdapter
					("insert into cust(cust_custno,cust_nm,cust_jbti,cust_mfrno,cust_tel,cust_fax,cust_cell,cust_email,cust_regdate,cust_moddate,cust_oldcustno,cust_itpcd,cust_rtpcd,cust_btpcd) values(@cust_custno,@cust_nm,@cust_jbti,@cust_mfrno,@cust_tel,@cust_fax,@cust_cell,@cust_email,@cust_regdate,@cust_moddate,@cust_oldcustno,@cust_itpcd,@cust_rtpcd,@cust_btpcd)",myConn);
