...
{
    public partial class itp : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                TextBoxitp_itpcd.Text = strAssignedContNo;
            }
        }

        public void BindGrid()
        {
            DataSet ds = myitp.Selectitp();
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            Label Labelitp_itpcd = (Label)thisRow.Cells[1].FindControl("Labelitp_itpcd");
            Label Labelitp_nm = (Label)thisRow.Cells[2].FindControl("Labelitp_nm");

            TextBox TextBoxitp_itpcd = (TextBox)thisRow.Cells[1].FindControl("TextBoxitp_itpcd");
            TextBox TextBoxitp_nm = (TextBox)thisRow.Cells[2].FindControl("TextBoxitp_nm");
        ...
        protected void SubBtn_Click(object sender, EventArgs e)
        {
            ...
            //string Strfilter = " 1=1 AND itp_itpcd = '" + TextBoxitp_itpcd.Text.Trim() + "'";
            ...
            myitp.Updateitp(TextBoxitp_itpcd.Text.Trim(), TextBoxitp_nm.Text.Trim(), itp_itpid);
