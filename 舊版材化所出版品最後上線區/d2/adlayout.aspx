...
<%@ Page language="c#" Codebehind="adlayout.aspx.cs" Src="adlayout.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d2.adlayout" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<TITLE>廣告版面 - 資料瀏覽</TITLE>
	...
	<body>
		<center>
			...
			<!-- Run at Server Form -->
			<form id="adlayout" method="post" runat="server">
					...
					<TR>
						...
						<TD vAlign="top" width="*">
							<FONT title="書籍資料維護" color="#333333"><IMG height="10" src="../images/header/right02.gif" width="10" border="0">&nbsp;平面廣告次系統
								...
								<IMG height="10" src="../images/header/right02.gif" width="10" border="0"> 廣告版面 
								- 資料瀏覽 (
					...
					<TR>
						...
						<TD vAlign="top">
							<asp:datagrid id="DataGrid1" runat="server" BorderColor="Black" AutoGenerateColumns="False" AllowPaging="True" PageSize="10">
								...
								<Columns>
									<asp:BoundColumn Visible="False" DataField="ltp_ltpid" ReadOnly="True" HeaderText="ID"></asp:BoundColumn>
									<asp:BoundColumn DataField="ltp_ltpcd" HeaderText="廣告版面代碼"></asp:BoundColumn>
									<asp:BoundColumn DataField="ltp_nm" HeaderText="廣告版面名稱"></asp:BoundColumn>
					...
					<TR>
						...
						<TD>
							...
							<asp:dropdownlist id="ddlQueryField" runat="server">
								<asp:ListItem Value="ltp_nm" Selected="True">廣告版面名稱</asp:ListItem>
								<asp:ListItem Value="ltp_ltpcd">廣告版面代碼</asp:ListItem>
							</asp:dropdownlist>
