...
<%@ Page language="c#" Codebehind="RemailSearch.aspx.cs" src="RemailSearch.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d1.RemailSearch" %>
...
<HTML>
	...
	<body>
		...
		<form id="RemailSearch" method="post" runat="server">
			<center>
				<table>
					<tr>
						<td style="WIDTH: 627px" align="left">
							<font color="#333333" size="2"><IMG height="10" src="images/header/right02.gif" width="10" border="0">
								...
								補書處理<IMG height="10" src="images/header/right02.gif" width="10" border="0">查詢 </font>
						</td>
					</tr>
				</table>
			...
			<CENTER>
				...
				<asp:datagrid id="DataGrid2" runat="server" AutoGenerateColumns="False" BorderStyle="None" BorderWidth="1px" BorderColor="#3366CC" BackColor="White" CellPadding="4">
					...
					<Columns>
						...
						<asp:BoundColumn DataField="rm_seq" HeaderText="補書序號">
							<HeaderStyle Width="28px">
							</HeaderStyle>
						</asp:BoundColumn>
						...
						<asp:BoundColumn DataField="rm_oritem" HeaderText="收件人序號">
