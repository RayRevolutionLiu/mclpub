    ...
    public partial class PlaneCont_2 : System.Web.UI.Page
    {
        ...
        protected void PCGV2OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                System_SN.NavigateUrl = "javascript:doDetail('800','600','ContShowDetail.aspx?cust_custno=" + Request.QueryString["custno"].ToString() + "&cont_contno=" + e.Row.Cells[0].Text.Trim() + "&dpplane=false');";

                Button BtnEdit = (Button)e.Row.Cells[18].FindControl("Button2");
                BtnEdit.PostBackUrl = string.Format("javascript:location.href=\"PlaneCont2Edit.aspx?cust_custno={0}&cont_contno={1}\"", Request.QueryString["custno"].ToString(), e.Row.Cells[0].Text.Trim());
