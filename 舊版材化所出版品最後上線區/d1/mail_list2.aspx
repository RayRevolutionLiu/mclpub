	...
	<body>
		<form id="odlist" method="post" runat="server">
			<%
				...
				sqlcmd1 = "SELECT         tmp_label1.*, c1_cust.cust_nm, mfr.mfr_inm, c1_or.or_nm, c1_or.or_addr, c1_or.or_zip, c1_or.or_fgmosea "
                ...
                sqlcmd1 = sqlcmd1 & "c1_order.o_otp1seq = tmp_label1.od_otp1seq INNER JOIN "
				...
				sqlcmd1 = sqlcmd1 & "WHERE c1_or.or_fgmosea = '"& Request("mosea") & "'"
...
'					XLS.AddVariable("mail_type", MailType)		' >>$mail_type
					...
					SrcBook = Server.MapPath("mail_list2.xls")
					
					' Generate SpreadSheet and Stream to Client, Open in Place
					XLS.Generate(SrcBook, "mail_list2.xls", True)
