							...
							<TD align="left" width="100%">
								<asp:DataGrid id="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderColor="Black">
									...
									<Columns>
										...
										<asp:BoundColumn DataField="sys_syscd" HeaderText="系統代碼"></asp:BoundColumn>
										<asp:BoundColumn DataField="sys_nm" HeaderText="系統代碼名稱"></asp:BoundColumn>
										<asp:BoundColumn DataField="sys_deptcd" HeaderText="部門代碼"></asp:BoundColumn>
						...
						<TR height="40">
							<TD align="left" width="100%">
								...
								<asp:DropDownList id="ddlQueryField" runat="server">
									<asp:ListItem Value="sys_nm" Selected="True">系統代碼名稱</asp:ListItem>
									<asp:ListItem Value="sys_syscd">系統代碼</asp:ListItem>
								</asp:DropDownList>
