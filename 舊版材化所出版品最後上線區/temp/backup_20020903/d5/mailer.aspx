...
<%@ Page language="c#" Src="mailer.aspx.cs" Codebehind="mailer.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.mailer" %>
...
<HTML>
	...
	<body>
		...
		<form id="mailer" method="post" runat="server">
			<P>
				<FONT face="新細明體">
						...
						<TR vAlign="top" height="124">
							<TD align="left" width="100%">
								<asp:DataGrid id="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderColor="Black">
									...
									<Columns>
										<asp:BoundColumn Visible="False" DataField="ml_mlid" ReadOnly="True" HeaderText="ID"></asp:BoundColumn>
										<asp:BoundColumn DataField="ml_mlcd" HeaderText="寄件人代碼"></asp:BoundColumn>
										<asp:BoundColumn DataField="ml_nm" HeaderText="寄件人姓名"></asp:BoundColumn>
						...
						<TR height="40">
							<TD align="left" width="100%">
								...
								<asp:DropDownList id="ddlQueryField" runat="server">
									<asp:ListItem Value="ml_nm" Selected="True">寄件人姓名</asp:ListItem>
									<asp:ListItem Value="ml_mlcd">寄件人代碼</asp:ListItem>
								</asp:DropDownList>
