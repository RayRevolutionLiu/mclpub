...
<HTML>
	...
	<body>
		...
		<form id="bookp_get" method="post" target="_self" runat="server">
			...
			<br>
			<!-- DataGrid 開始 -->
			<asp:datagrid id="DataGrid1" runat="server" ItemStyle-HorizontalAlign="Center" AllowPaging="False" PageSize="12" BackColor="White" BorderColor="Black" BorderStyle="None" AutoGenerateColumns="False">
