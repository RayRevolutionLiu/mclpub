...
{
	/// <summary>
	/// Summary description for MRightAd.
	/// </summary>
	public class MRightAd : System.Web.UI.Page
	{
		...
		{	
			...
			{
				//根本沒有落版檔案時....
				Response.Write("今天尚未落版");
				return;
			}					
				DataSet TextAdDS = new DataSet();
				TextAdDS.ReadXml(Server.MapPath(".") + "/" + DateTime.Today.ToString("yyyyMMdd", null) + ".xml");
