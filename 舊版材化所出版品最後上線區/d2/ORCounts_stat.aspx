				...
				<tr>
					<td align="middle">
						<font color="#333333" size="2"><IMG height="10" src="../images/header/right02.gif" width="10" border="0">
							...
							統計表 <IMG height="10" src="../images/header/right02.gif" width="10" border="0"> 郵寄本數統計表</font>
					</td>
				</tr>
			</table>
			&nbsp; 
					...
					<TBODY>
						...
						<TR>
							<TD width="*">
								...
								<asp:label id="lblCountType" runat="server" Font-Size="X-Small">當月 有登本數／未登本數：</asp:label>
								...
								<asp:linkbutton id="lnbShow" runat="server">查詢</asp:linkbutton><FONT face="新細明體">&nbsp;
									<asp:linkbutton id="lnbClearAll" runat="server">清除重查</asp:linkbutton></FONT>
								<br>
								<!-- 查詢結果顯示 -->
