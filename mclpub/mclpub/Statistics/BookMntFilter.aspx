<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="BookMntFilter.aspx.cs" Inherits="mclpub.Statistics.BookMntFilter" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <span class="font_size12 font_darkblue font_bold">目前位置:&nbsp;統計管理 / 印製份數統計表</span>
<span class="stripeMe">
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="right" width="220" class="font_bold">郵寄類別：</td>
    <td>
  ...
  <tr>
    ...
    <td align="right" width="220" class="font_bold">雜誌期數：</td>
    <td>
        <asp:Label ID="lbBookNo" runat="server"></asp:Label>
        <span class="font_bold">期</span>
    </td>
  </tr>
  </table>
</span>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false"
    ...
    <Columns>
        ...
        <asp:BoundField DataField="mtp_mtpcd" HeaderText="郵寄類別" />
        <asp:BoundField DataField="tmp_param1" HeaderText="訂閱份數" />
        <asp:BoundField DataField="tmp_param2" HeaderText="本數" />
    </Columns>
