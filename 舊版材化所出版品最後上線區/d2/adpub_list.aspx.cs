...
{
	/// <summary>
	/// Summary description for adpub_list.
	/// </summary>
	public class adpub_list : System.Web.UI.Page
	{
		...
		private void CountPubData()
		{
			...
			// 使用 DataSet 方法, 並指定使用的 table 名稱
			this.sqlDataAdapter2.SelectCommand.Parameters["@yyyymm"].Value = strYYYYMM;
			this.sqlDataAdapter2.SelectCommand.Parameters["@bkcd"].Value = strBkcd;
			...
			{
				// 轉址
				string RedirectURL = "adpub_list2.aspx";
...
//				"rue;user id=webuser;workstation id=17-0890711-01;packet size=4096";
			...
			// sqlSelectCommand4
			// 
			this.sqlSelectCommand4.CommandText = "SELECT srspn_id, RTRIM(srspn_empno) AS srspn_empno, RTRIM(srspn_cname) AS srspn_c" +
			...
			this.sqlSelectCommand2.CommandText = "SELECT TOP 100 PERCENT 0 AS ItemNo, dbo.c2_pub.pub_contno, dbo.c2_pub.pub_pubseq," +
				...
				"cd, dbo.c2_pub.pub_njtpcd + \' \' + dbo.c2_njtp.njtp_nm AS nostr, dbo.c2_cont.cont" +
				"_empno, dbo.c2_cont.cont_contno, dbo.c2_cont.cont_syscd FROM dbo.c2_pub INNER JO" +
				"IN dbo.c2_cont ON dbo.c2_pub.pub_contno = dbo.c2_cont.cont_contno AND dbo.c2_pub" +
				".pub_syscd = dbo.c2_cont.cont_syscd INNER JOIN dbo.mfr ON dbo.c2_cont.cont_mfrno" +
				" = dbo.mfr.mfr_mfrno INNER JOIN dbo.c2_lprior ON dbo.c2_pub.pub_ltpcd = dbo.c2_l" +
				"prior.lp_ltpcd AND dbo.c2_pub.pub_clrcd = dbo.c2_lprior.lp_clrcd AND dbo.c2_pub." +
				"pub_pgscd = dbo.c2_lprior.lp_pgscd AND dbo.c2_pub.pub_bkcd = dbo.c2_lprior.lp_bk" +
				"cd LEFT OUTER JOIN dbo.c2_clr ON dbo.c2_pub.pub_clrcd = dbo.c2_clr.clr_clrcd LEF" +
				"T OUTER JOIN dbo.c2_pgsize ON dbo.c2_pub.pub_pgscd = dbo.c2_pgsize.pgs_pgscd LEF" +
				"T OUTER JOIN dbo.c2_ltp ON dbo.c2_pub.pub_ltpcd = dbo.c2_ltp.ltp_ltpcd LEFT OUTE" +
				"R JOIN dbo.c2_njtp ON dbo.c2_pub.pub_njtpcd = dbo.c2_njtp.njtp_njtpcd LEFT OUTER" +
				" JOIN dbo.book ON dbo.c2_pub.pub_origbkcd = dbo.book.bk_bkcd LEFT OUTER JOIN dbo" +
				".srspn ON dbo.c2_cont.cont_empno = dbo.srspn.srspn_empno WHERE (dbo.c2_pub.pub_y" +
				"yyymm = @yyyymm) AND (dbo.c2_pub.pub_bkcd = @bkcd) AND (dbo.c2_cont.cont_fgtemp " +
				"= \'0\') AND (dbo.c2_cont.cont_fgpubed = \'1\') ORDER BY dbo.c2_lprior.lp_priorseq, " +
				"dbo.c2_pub.pub_pgno, dbo.c2_pub.pub_contno, dbo.c2_pub.pub_yyyymm DESC, dbo.c2_p" +
				"ub.pub_pubseq";
