	...
	<body>
		...
		<span class="stripeMe">
            ...
            <Columns>
                ...
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="LKedit" CommandArgument='<%# Eval("im_imseq")%>' Text="修改" CausesValidation="false"></asp:LinkButton>
                </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderStyle-Width="4%">
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton2" runat="server" CommandName="LKdel" CommandArgument='<%# Eval("im_imseq")%>' Text="刪除" CausesValidation="false"></asp:LinkButton>
                </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="im_imseq" HeaderText="序號" />
                <asp:BoundField DataField="im_mfrno" HeaderText="廠商統編" />
