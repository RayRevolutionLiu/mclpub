...
<%@ Page language="c#" Src="mtp.aspx.cs" Codebehind="mtp.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.mtp" %>
...
<HTML>
	...
	<body>
		...
		<form id="mtp" method="post" runat="server">
			<P>
				<FONT face="新細明體">
					<TABLE id="tbItems" cellSpacing="0" cellPadding="0" width="720" border="0" align="center">
						...
						<TR>
							<TD vAlign="top" align="left" width="100%" height="224">
								<asp:DataGrid id="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderColor="Black">
									...
									<Columns>
										<asp:BoundColumn Visible="False" DataField="mtp_mtpid" ReadOnly="True" HeaderText="ID"></asp:BoundColumn>
										<asp:BoundColumn DataField="mtp_mtpcd" HeaderText="郵寄類別代碼"></asp:BoundColumn>
						...
						<TR height="40">
							<TD align="left" width="100%">
								...
								<asp:DropDownList id="ddlQueryField" runat="server">
									<asp:ListItem Value="mtp_nm" Selected="True">郵寄類別名稱</asp:ListItem>
									<asp:ListItem Value="mtp_mtpcd">郵寄類別代碼</asp:ListItem>
								</asp:DropDownList>
