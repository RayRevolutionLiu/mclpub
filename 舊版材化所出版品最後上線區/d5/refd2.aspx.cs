...
namespace MRLPub.d5
{
	...
	/// </summary>
	public class refd2 : System.Web.UI.Page
	{
		...
		public void BindGrid()
		{
			...
			string SQL = "SELECT dbo.refd.*, dbo.syscd.sys_nm AS sys_nm FROM dbo.refd INNER JOIN dbo.syscd ON dbo.refd.rd_syscd = dbo.syscd.sys_syscd";
		...
		{
			Response.Redirect("refd2_addnew.aspx");
		}
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			SqlDataAdapter cmd=new SqlDataAdapter("delete from refd where rd_rdid=@rd_rdid",myConn);
		
			cmd.SelectCommand.Parameters.Add("@rd_rdid",SqlDbType.Int,4).Value=e.Item.Cells[0].Text;
		...
		private void DataGrid1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("refd2_edit.aspx?" + id);
		}
