...
<html>
	...
	<body>
		...
		<span class="stripeMe">
			...
			<table id="table2" dataSrc="#DSO2" cellSpacing="0" cellPadding="0" border="0" width="100%" class="font_blacklink font_size13">
				...
				<tbody>
					<tr>
						...
						<td>
							<input dataFld="姓名" id="tt1" type="text" maxLength="30" size="5" name="tt1">
						</td>
						<td>
							<input dataFld="公司名稱" id="tt"  type="text" maxLength="40" size="7" name="tt">
						</td>
						<td>
						...
						<td style="WIDth: 43px">
							<input dataFld="郵遞區號" id="tt4" type="text" maxLength="5" size="1" name="tt4">
						</td>
						<td>
							<input dataFld="電話" id="tt6" type="text" size="5" name="tt6" maxLength="30">
						</td>
						<td>
							<input dataFld="傳真" id="tt7" type="text" size="3" name="tt7">
						</td>
						<td>
			...
			<br />
			&nbsp;			
			<asp:Label id="Label1" runat="server" ForeColor="#C04000">註:<br />姓名欄位限制:15個中文 或 30個英文<br />公司名稱欄位限制:20個中文 或 40個英文</asp:Label>
			</span>
		</form>
