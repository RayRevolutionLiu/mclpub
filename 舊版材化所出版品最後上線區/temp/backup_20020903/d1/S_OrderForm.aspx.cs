...
namespace MRLPub.d1
{
	...
	/// </summary>
	public class S_OrderForm : System.Web.UI.Page
	{
...
//				Response.Write(hiddenAddress.Value);
		...
		{    
			...
			// sqlConnection2
			// 
			//			this.sqlConnection2.ConnectionString = "data source=ISCCOM1;initial catalog=mrlpub;password=db600;persist security info=T" +
			//				"rue;user id=webuser;workstation id=03212-840695;packet size=4096";
			this.sqlConnection2.ConnectionString = ConfigurationSettings.AppSettings["mrlpub2"].ToString();
			// 
			// sqlSelectCommand3
			// 
