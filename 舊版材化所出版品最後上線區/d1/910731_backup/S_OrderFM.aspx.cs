...
{
	/// <summary>
	/// Summary description for S_OrderFM.
	/// </summary>
	public class S_OrderFM : System.Web.UI.Page
	{
		...
		protected System.Web.UI.HtmlControls.HtmlInputRadioButton rblInvcd1;
		protected System.Web.UI.HtmlControls.HtmlInputRadioButton rblInvcd2;
		protected System.Web.UI.HtmlControls.HtmlInputRadioButton rblInvcd3;
		...
		protected System.Web.UI.HtmlControls.HtmlInputText tbxAmt;
		...
		{    
			...
			// sqlSelectCommand1
			// 
			this.sqlSelectCommand1.CommandText = @"SELECT o_oid, o_syscd, o_custno, o_otp1cd, o_otp1seq, o_otp2cd, o_mfrno, o_inm, o_ijbti, o_iaddr, o_izip, o_itel, o_ifax, o_icell, o_iemail, o_pytpcd, o_fgpreinv, o_date, o_moddate, o_oldvdate, o_empno, o_xmldata, o_orescd, o_invcd, o_taxtp, o_iano, o_status, o_cancel, o_indate, o_special FROM dbo.c1_order";
			this.sqlSelectCommand1.Connection = this.sqlConnection1;
			// 
			// sqlSelectCommand7
			// 
			this.sqlSelectCommand7.CommandText = "SELECT srspn_id, srspn_empno AS empno, RTRIM(srspn_cname) AS cname, srspn_atype, " +
				"srspn_empno FROM dbo.srspn";
			this.sqlSelectCommand7.Connection = this.sqlConnection1;
			// 
			// sqlSelectCommand6
			// 
			this.sqlSelectCommand6.CommandText = @"SELECT dbo.c1_cust.cust_custid, dbo.c1_cust.cust_custno, dbo.c1_cust.cust_fgoi, dbo.c1_cust.cust_fgoe, dbo.c1_cust.cust_mfrno, dbo.c1_cust.cust_nm, dbo.mfr.mfr_inm, dbo.mfr.mfr_mfrid, dbo.mfr.mfr_mfrno FROM dbo.c1_cust INNER JOIN dbo.mfr ON dbo.c1_cust.cust_mfrno = dbo.mfr.mfr_mfrno";
