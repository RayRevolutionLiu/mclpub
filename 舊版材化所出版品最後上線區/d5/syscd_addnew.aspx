<%@ Page language="c#" Src="syscd_addnew.aspx.cs" Codebehind="syscd_addnew.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.syscd_addnew" %>
...
<HTML>
	...
	<body>
		<form id="syscd_addnew" method="post" runat="server">
			<P>
				<FONT face="新細明體">
