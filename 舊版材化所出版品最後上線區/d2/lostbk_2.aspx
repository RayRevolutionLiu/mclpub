...
<%@ Page language="c#" Codebehind="lostbk_2.aspx.cs" Src="lostbk_2.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d2.lostbk_2" %>
...
<HTML>
	...
	<body>
		...
		<center>
			...
			&nbsp; 
			<!-- Run at Server Form-->
			<form id="lostbk_2" method="post" runat="server">
				<TABLE style="WIDTH: 80%" cellSpacing="0" cellPadding="4" align="center" bgColor="#bfcff0">
					...
					<TR align="left">
						...
						<TD class="cssData">
							<asp:TextBox id="tbxLostDate" runat="server" Width="65px"></asp:TextBox>
							&nbsp; <IMG id="img_signdate" onclick='javascript:pick_date("tbxLostDate");return false;' height="18" alt="查詢日期" src="../images/calendar01.gif" width="18">
						</TD>
					</TR>
					<TR align="left">
						<TD class="cssTitle" align="right">
				...
				<FONT face="新細明體">&nbsp; </FONT>
				<asp:button id="btnCancel" runat="server" Text="取消回前頁" Height="28px"></asp:button>
			</form>
			&nbsp; 
			<!-- 頁尾 Footer -->
