...
<%@ Page language="c#" Codebehind="ContNew.aspx.cs" Src="ContNew.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d4.WorkingProcess.ContNew" %>
...
<HTML>
	...
	<body>
		<form id="ContNew" method="post" runat="server">
			...
			<TABLE id="tblX" cellSpacing="0" cellPadding="0" width="100%">
				...
				<TR>
					<TD align="middle"><asp:panel id="pnlContBody" Runat="server" Width="100%">
...
name=imgMfrDetail></TD>
              ...
              name=imgCustDetail></TD>
									...
									<TD><!--合約書基本資料-->
										<TABLE cellSpacing="0" cellPadding="2" width="100%" border="0">
											...
											<TR>
												...
												<TD>
													<asp:radiobuttonlist id="rblPayOnce" runat="server" Enabled="False" RepeatDirection="Horizontal">
											...
											<TR>
												...
												<TD colSpan="3">
													<asp:textbox id="tbxRemark" runat="server" Width="90%" MaxLength="50"></asp:textbox></TD>
											</TR>
										</TABLE>
									</TD>
								</TR>
									...
									<TD>
										<TABLE class="TableColor" cellSpacing="0" cellPadding="1" width="100%" border="0">
											<TR>
												...
												<TD>
													<asp:textbox id="tbxCCont" runat="server" Width="250px" MaxLength="25"></asp:textbox></TD>
											</TR>
											<TR>
												...
												<TD>
													...
													<asp:regularexpressionvalidator id="revCsDate" runat="server" ControlToValidate="tbxCsDate" Display="Dynamic" ErrorMessage="格式錯誤，請輸入正確格式" ValidationExpression="[1-2]\d{3}\/[0-2]\d\/[0-3]\d" CssClass="ValidatorStyle"></asp:regularexpressionvalidator>(如：2002/12/31)</TD>
											</TR>
											<TR>
												<TD align="right">產品設備內文：
												</TD>
												<TD>
													<asp:textbox id="tbxPdCont" runat="server" Width="500px" MaxLength="250" Rows="3" TextMode="MultiLine"></asp:textbox></TD>
											</TR>
										</TABLE>
									</TD>
								</TR>
                  ...
                  alt=ATP_MATP src="../../images/edit.gif" name=imgAtpMatp>
													<asp:datagrid id="dgdAtpMatp1" runat="server" CssClass="DataGridStyle" CellPadding="2" ShowHeader="False" AutoGenerateColumns="False">
                  ...
                  alt=ATP_MATP src="../../images/edit.gif" name=imgAtpMatp>
													<asp:datagrid id="dgdAtpMatp2" runat="server" CssClass="DataGridStyle" CellPadding="2" ShowHeader="False" AutoGenerateColumns="False">
														<SelectedItemStyle CssClass="SelectedItemStyle"></SelectedItemStyle>
														<AlternatingItemStyle CssClass="AlternatingItemStyle"></AlternatingItemStyle>
														<ItemStyle CssClass="ItemStyle"></ItemStyle>
														<HeaderStyle CssClass="HeaderStyle"></HeaderStyle>
            ...
            alt=詳細 src="..\..\images\new.gif" name=imgAddInvMfr></TD>
								...
								<TR>
									<TD>
										...
										<asp:button id="btnNoSave" runat="server" Text="取消儲存" CausesValidation="False"></asp:button></TD>
								</TR>
								<TR>
									<TD>
		...
		function delete_confirm(e){
			if(event.srcElement.type=="submit" && document.all(event.srcElement.name).value=="取消儲存")
				event.returnValue=confirm("確認不儲存此合約(立即清除資料)?");
		}
