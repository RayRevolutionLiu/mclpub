	...
	<body>
		<form id="odlist" method="post" runat="server">
			<%
				...
				sqlcmd1 = sqlcmd1 & "WHERE (py.py_pytpcd = '03') and py_pysdate='"& Request("yyyymm") & "' and py_pysseq='"&Request("batch") &"'"
...
'								A1(i,3) = Rs1("ia_pyat").Value
								...
								A1(i,9) = Rs1("ia_invno").Value
								A1(i,12) = Rs1("ia_syscd").Value
								A1(i,13) = Rs1("ia_iano").Value
							end if
						else
							A1(i,0) = count + 1
							count = count + 1
...
'							A1(i,3) = Rs1("ia_pyat").Value
							...
							A1(i,5) = Rs1("mfr_inm").Value
							A1(i,6) = Rs1("ia_mfrno").Value
							A1(i,7) = Rs1("py_moseq").Value
							A1(i,8) = Rs1("py_moitem").Value
							A1(i,9) = Rs1("ia_invno").Value
							A1(i,12) = Rs1("ia_syscd").Value
							A1(i,13) = Rs1("ia_iano").Value
						end if
						A1(i,10) = Rs1("iad_projno").Value
						A1(i,11) = Rs1("iad_desc").Value
...
'					Loop
					...
					SrcBook = Server.MapPath("py_list3.xls")
					
					' Generate SpreadSheet and Stream to Client, Open in Place
					XLS.Generate(SrcBook, "py_list3.xls", True)
