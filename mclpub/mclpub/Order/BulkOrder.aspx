<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BulkOrder.aspx.cs" Inherits="mclpub.Order.BulkOrder"  MasterPageFile="~/MasterPage.Master" ValidateRequest="false" %>
<asp:Content id="Content1" ContentPlaceholderID="ContentPlaceHolder1" runat="server">

    <span class="font_size12 font_darkblue font_bold">目前位置:&nbsp;訂戶管理 / 雜誌叢書訂單處理 / 贈戶訂單整批作業</span> 
<span class="stripeMe">
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr id="trUntilDate" runat="server" visible="false">
...
<asp:datalist id="DataList1" runat="server" GridLines="Horizontal" Width="100%" 
        ...
        onitemdatabound="DataList1_ItemDataBound" BorderStyle="None" >
				<HeaderTemplate>
                <table width="100%">
						<tr>
