...
<%@ Page language="c#" Codebehind="cont_main1.aspx.cs" Src="cont_main1.aspx.cs"  AutoEventWireup="false" Inherits="MRLPub.d2.cont_main1" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<TITLE>維護合約書 步驟一</TITLE>
	...
	<body>
		<center>
			...
			&nbsp; 
			<!-- Run at Server Form -->
			<form id="cont_main1" method="post" runat="server">
				<!-- 查詢條件 Table -->
				<TABLE style="WIDTH: 95%" cellSpacing="0" cellPadding="2" bgColor="#bfcff0">
					<TR bgColor="#214389">
						<td colSpan="2">
					...
					<TR>
						...
						<TD rowSpan="3">
							<asp:label id="lblEmplain" runat="server" ForeColor="DarkRed">1. 請輸入任一關鍵詞來查詢, 然後按下 "查詢".<br>
							2. 查出資料後, 按下 "修改客戶資料" 可修改該客戶的資料.<br>3. 查出資料後, 按下 "確定" 可繼續[新增合約書]步驟, 並帶入該客戶的相關資料.<br>
							<font color="gray">註: 如果搜尋無該客戶資料, 請先輸入<U>廠商統編(再按下旁邊的小圖示)</U>
									<br>
									來搜尋檢查該廠商是否存在?!
									<br>
									A. 若廠商不存在, 請先按下 '新增廠商資料', 再 '新增客戶資料';
									<br>
									B. 若廠商存在, 請直接按下 '新增客戶資料'.
									<br>
								</font>
							</asp:label>
						</TD>
					...
					<TR>
						<TD colSpan="2">
							<asp:datagrid id="DataGrid1" Runat="server" CellPadding="2" BorderStyle="None" BackColor="White"
								BorderWidth="1px" BorderColor="#3366CC" AutoGenerateColumns="False" AllowPaging="True">
