	...
	<body>
		...
		<form id="OrderForm" method="post" runat="server">
			<center>
				...
				<input id="btnSave" onclick="doSubmit()" type="button" value="儲存訂單" name="btnSave"><input id="btnCancel" onclick='javascritp:window.location.href="../default.aspx"' type="button" value="取消回首頁" name="btnCancel">
			</center>
		</form>
...
//			window.location.href="http://mrlweb.itri.org.tw/mrlpub/d1/PayFilter.aspx?caller=order";
//			window.location.href="http://mrlweb.itri.org.tw/mrlpub/d1/PayTypeForm.aspx?caller=order&id="+window.document.all("hiddenOrderNo").value;
//		else{
			if(window.confirm("要繼續新增訂單?")){
				if(window.document.all("hiddenType1").value=="01")
					window.location.href="SearchCust1.aspx?type1=01&function1=new";
				else if(window.document.all("hiddenType1").value=="09")
					window.location.href="SearchCust1.aspx?type1=09&function1=new";
			}
			else
