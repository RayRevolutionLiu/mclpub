...
<%@ Page language="c#" Src="mltp.aspx.cs" Codebehind="mltp.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.mltp" %>
...
<HTML>
	...
	<body>
		...
		<form id="mltp" method="post" runat="server">
			<P>
				<FONT face="新細明體">
						...
						<TR>
							<TD align="left" width="100%" vAlign="top" height="22">
								<FONT color="#333333" size="2"><IMG height="10" src="../images/header/right02.gif" width="10" border="0">
									...
									寄件人郵寄類別資料維護 <FONT color="dimgray">(
						...
						<TR vAlign="top" height="224">
							<TD align="left" width="100%">
								<asp:DataGrid id="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderColor="Black">
									...
									<Columns>
										<asp:BoundColumn Visible="False" DataField="mltp_mltpid" ReadOnly="True" HeaderText="ID"></asp:BoundColumn>
						...
						<TR height="40">
							<TD align="left" width="100%">
								...
								<asp:DropDownList id="ddlQueryField" runat="server">
									<asp:ListItem Value="mltp_mlcd" Selected="True">寄件人代碼</asp:ListItem>
									<asp:ListItem Value="mltp_syscd">系統代碼</asp:ListItem>
									<asp:ListItem Value="mltp_mltpcd">寄件人郵寄類別代碼</asp:ListItem>
								</asp:DropDownList>
