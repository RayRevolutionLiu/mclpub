...
namespace MRLPub.d5
{
	...
	/// </summary>
	public class pytp : System.Web.UI.Page
	{
		...
		{
			Response.Redirect("pytp_addnew.aspx");
		}
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			SqlDataAdapter cmd=new SqlDataAdapter("delete from pytp where pytp_pytpid=@pytp_pytpid",myConn);
		
			cmd.SelectCommand.Parameters.Add("@pytp_pytpid",SqlDbType.Int,4).Value=e.Item.Cells[0].Text;
		...
		private void DataGrid1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("pytp_edit.aspx?" + id);
		}
