<%@ Page language="c#" Codebehind="filterlostlabel.aspx.cs" src="filterlostlabel.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d1.filterlostlabel" %>
...
<HTML>
	...
	<body>
		<form id="filterlostlabel" method="post" runat="server">
				...
				<ItemTemplate>
					<TABLE>
						<TR>
							...
							<TD>
								<asp:Label id="lblSeq" Width="40" text='<%# DataBinder.Eval(Container.DataItem, "lst_seq")%>' Runat="server"></asp:Label>
							</TD>
							<TD>
								<asp:Label id="lblRecName" Width="60" text='<%# DataBinder.Eval(Container.DataItem, "or_nm")%>' Runat="server"></asp:Label>
							</TD>
							<TD>
								<asp:Label id="lblCont" Width="150" text='<%# DataBinder.Eval(Container.DataItem, "lst_cont")%>' Runat="server"></asp:Label>
							</TD>
							<TD>
								<asp:Label id="lblRea" Width="90" text='<%# DataBinder.Eval(Container.DataItem, "lst_rea")%>' Runat="server"></asp:Label>
							</TD>
							<TD>
								<asp:Label id="lblFlagSent" Width="60" text='<%# DataBinder.Eval(Container.DataItem, "lst_fgsent")%>' Runat="server"></asp:Label>
							</TD>
						</TR>
					</TABLE>
				</ItemTemplate>
