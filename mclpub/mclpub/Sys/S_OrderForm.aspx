<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="S_OrderForm.aspx.cs" Inherits="mclpub.Sys.S_OrderForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <span class="font_size12 font_darkblue font_bold">目前位置:&nbsp;系統管理 / 雜誌叢書訂單處理 / 新增舊訂單(不新增ia及py) / 新增訂單</span> 
    <span class="stripeMe">
    <br />
...
<script language="javascript">
    ...
    function doGetrec() {
        ...
        vreturn = window.showModalDialog("../Order/RecForm.aspx", myObject, "dialogHeight:400px;dialogWidth:1000px;center:yes;scroll:yes;status:no;help:no;");
    ...
    function doSelectrec(obj) {
        ...
        vreturn = window.showModalDialog("../Order/SetrecForm.aspx", myObject, "dialogHeight:500px;dialogWidth:530px;");
        if (vreturn) {
    ...
    function pick_dateStart(obj) {
        ...
        strFeature = "";
        strFeature += "dialogHeight:350px;dialogWidth:380px;center:yes;scroll:yes;status:no;help:no;";
        var vreturn = window.showModalDialog("../Order/Calendar.htm", oParam, strFeature);
        if (vreturn)
    ...
    function doSubmit() {
        ...
        xmlHTTP.open("post", "S_SaveOrder.aspx", false);
