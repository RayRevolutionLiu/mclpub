<%@ Page language="c#" Src="refd2_addnew.aspx.cs" Codebehind="refd2_addnew.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.refd2_addnew" %>
...
<HTML>
	...
	<body>
		<form id="refd_addnew" method="post" runat="server">
			<P>
				<FONT face="新細明體">
			...
			<TABLE cellSpacing="1" cellPadding="3" width="77%" bgColor="#bfcff0" border="0">
				<TR bgColor="#214389">
					<TD colSpan="4">
						<FONT color="#ffffff">新增轉 SAP 傳票摘要檔資料</FONT>
					</TD>
				</TR>
				<TR>
