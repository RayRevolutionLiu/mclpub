<%@ Page language="c#" Codebehind="adprom_label.aspx.cs" Src="adprom_label.aspx.cs" AutoEventWireup="false" Inherits="MRLPub_d2.adprom_label" %>
...
<HTML>
	...
	<BODY ondblclick="doReOrder()" bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		...
		<center>
			...
			<!-- 標題 -->
			<DIV align="center">
				<B><FONT color="darkblue" size="5">廣告推廣戶標籤</FONT></B>
			</DIV>
			<!-- Run at Server Form -->
			<form ID="lbl_adprom" name="lbl_adprom" method="post" runat="server">
				<!-- 暫時連結 Excel 檔 -->
