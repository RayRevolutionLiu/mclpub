...
{
	/// <summary>
	/// Summary description for RptIncomeQuery.
	/// </summary>
	public class RptIncomeQuery : MRLPub.d4.Pages.Page
	{
		...
		private void btnPrint_Click(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				string strbuf;
				strbuf="RptIncome.aspx?whoami=" + this.WhoAmI.CName+"&strdate="+tbxSDate.Text.Trim()+"~"+tbxEDate.Text.Trim();
				if(cbxSrspn.Checked==true)
