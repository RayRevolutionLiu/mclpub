...
'			sqlCmdRsCount = sqlCmdRsCount & "WHERE (cont_fgtemp = '0') AND (cont_fgcancel = '0') AND cont_fgclosed='0'"			
			...
			sqlCmdData = ""
			sqlCmdData = SqlCmdData & "SELECT c4_cont.*, cust_custno, cust_nm, mfr_mfrno, mfr_inm, wkmatp_matpstr, wkatp_atpstr, wkfbk_fbkstr "
			sqlCmdData = SqlCmdData & "FROM c4_cont LEFT OUTER JOIN cust ON cont_custno = cust_custno "
			sqlCmdData = SqlCmdData & "LEFT OUTER JOIN mfr ON cust_mfrno = mfr_mfrno AND cont_mfrno = mfr_mfrno "
...
'			sqlCmdData = SqlCmdData & "WHERE (cont_fgtemp = '0') AND (cont_fgcancel = '0') AND cont_fgclosed='0'"
			...
			DIM sqlCmdAdr
			sqlCmdAdr = ""
			sqlCmdAdr = sqlCmdAdr & "SELECT c4_adr.*, mfr.mfr_inm,"
			...
			sqlCmdAdr = sqlCmdAdr & "FROM c4_adr INNER JOIN "
			sqlCmdAdr = sqlCmdAdr & "c4_cont ON c4_adr.adr_contno = c4_cont.cont_contno INNER JOIN "
			sqlCmdAdr = sqlCmdAdr & "mfr ON c4_cont.cont_mfrno = mfr.mfr_mfrno LEFT OUTER JOIN "
			sqlCmdAdr = sqlCmdAdr & "invmfr ON c4_adr.adr_syscd = invmfr.im_syscd AND "
			sqlCmdAdr = sqlCmdAdr & "c4_adr.adr_contno = invmfr.im_contno AND "
			sqlCmdAdr = sqlCmdAdr & "c4_adr.adr_imseq = invmfr.im_imseq "
			...
			sqlCmdAdrCount = sqlCmdAdrCount & "FROM c4_adr INNER JOIN "
			sqlCmdAdrCount = sqlCmdAdrCount & "c4_cont ON c4_adr.adr_contno = c4_cont.cont_contno INNER JOIN "
			sqlCmdAdrCount = sqlCmdAdrCount & "mfr ON c4_cont.cont_mfrno = mfr.mfr_mfrno LEFT OUTER JOIN "
			sqlCmdAdrCount = sqlCmdAdrCount & "invmfr ON c4_adr.adr_syscd = invmfr.im_syscd AND "
			sqlCmdAdrCount = sqlCmdAdrCount & "c4_adr.adr_contno = invmfr.im_contno AND "
			sqlCmdAdrCount = sqlCmdAdrCount & "c4_adr.adr_imseq = invmfr.im_imseq "
