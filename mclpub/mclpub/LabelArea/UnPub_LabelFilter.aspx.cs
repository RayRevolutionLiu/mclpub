...
{
    public partial class UnPub_LabelFilter : System.Web.UI.Page
    {
        ...
        protected void CheckBtn_Click(object sender, EventArgs e)
        {
            ...
            if (MyUn.CreateLabelList(yyyymm))
            {
                hiddenBookPno.Value = MyUn.GetBookPno(ddlBookCode.SelectedItem.Value.Trim(), yyyymm);
        ...
        protected void btnPrintList_Click(object sender, EventArgs e)
        {
            ...
            Xls.SetCellValue(1, 1, "贈書大宗標籤清單 － 當月未刊登");
            Xls.SetCellValue(7, 10, "未登本數");
        ...
        {
            // 抓出篩選條件
            Session["UnMAILLABEL"] = GetFilters();
            string fgMOSea = this.ddlfgMOSea.SelectedItem.Value.ToString().Trim();
