        ...
        protected void GridView01OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                // 特別欄位之輸出格式轉換 - 變更簽約日期的格式
                    ...
                    System_SN.NavigateUrl = "javascript:doDetail('800','600','ContShowDetail.aspx?cust_custno=" + e.Row.Cells[7].Text.Trim() + "&cont_contno=" + e.Row.Cells[0].Text.Trim() + "&dpplane=false');";
            }
        ...
        protected void GridView02_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                // 特別欄位之輸出格式轉換 - 變更簽約日期的格式
                    ...
                    System_SN2.NavigateUrl = string.Format("javascript:location.href=\"PlaneCont2Edit.aspx?cust_custno={0}&cont_contno={1}\"", e.Row.Cells[7].Text.Trim(), e.Row.Cells[0].Text.Trim());
