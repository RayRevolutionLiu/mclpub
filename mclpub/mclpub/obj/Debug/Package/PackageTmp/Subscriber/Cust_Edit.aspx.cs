        ...
        private void InitData()
        {
            ...
            else
            {
                ...
                if (Request.QueryString["ID"] != null)
                {
                    ...
                    //綁定一進來就是登入者
                    if (ddlEmpNo.Items.FindByValue(Account.GetAccInfo().srspn_empno.ToString())!=null)
                    ddlEmpNo.Items.FindByValue(Account.GetAccInfo().srspn_empno.ToString()).Selected = true;
