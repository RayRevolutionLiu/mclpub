<%@ Page language="c#" Src="btp.aspx.cs" Codebehind="btp.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.btp" %>
						...
						<TR vAlign="top" height="224">
							<TD align="left" width="100%">
								<asp:DataGrid id="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderColor="Black">
									...
									<Columns>
										<asp:BoundColumn Visible="False" DataField="btp_btpid" ReadOnly="True" HeaderText="ID"></asp:BoundColumn>
										<asp:BoundColumn DataField="btp_btpcd" HeaderText="營業代碼"></asp:BoundColumn>
										<asp:BoundColumn DataField="btp_nm" HeaderText="營業代碼名稱"></asp:BoundColumn>
						...
						<TR>
							<TD align="left" width="100%" height="40">
								...
								<asp:DropDownList id="ddlQueryField" runat="server">
									<asp:ListItem Value="btp_nm" Selected="True">營業代碼名稱</asp:ListItem>
									<asp:ListItem Value="btp_btpcd">營業代碼</asp:ListItem>
								</asp:DropDownList>
