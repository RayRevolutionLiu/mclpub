<%@ Page language="c#" Codebehind="QueryCust.aspx.cs" Src="QueryCust.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d4.QueryCust" %>
...
<HTML>
  ...
  <body>
    ...
    <form id="QueryCust" method="post" runat="server">
<FONT 
face=新細明體>
...
<asp:linkbutton id=lnbShow tabIndex=5 runat="server">查詢</asp:linkbutton></TD>
    <TD>
...
<asp:label id=lblMessage runat="server" ForeColor="Red"></asp:label></TD></TR>
  <TR>
    <TD>合約編號：
<asp:textbox id=tbxContNo tabIndex=4 runat="server" Width="80px" AutoPostBack="True" MaxLength="6"></asp:textbox>
<asp:linkbutton id=lnbQryCont tabIndex=5 runat="server">查詢合約</asp:linkbutton></TD>
    <TD><FONT color=maroon>4.亦可由此直接查詢合約</FONT></TD></TR>
  <TR>
    <TD colSpan=2>
