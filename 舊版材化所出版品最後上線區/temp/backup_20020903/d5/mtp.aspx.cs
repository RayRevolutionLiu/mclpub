...
namespace MRLPub.d5
{
	...
	/// </summary>
	public class mtp : System.Web.UI.Page
	{
		...
		{
			Response.Redirect("mtp_addnew.aspx");
		}
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			SqlDataAdapter cmd=new SqlDataAdapter("delete from mtp where mtp_mtpid=@mtp_mtpid",myConn);
		
			cmd.SelectCommand.Parameters.Add("@mtp_mtpid",SqlDbType.Int,4).Value=e.Item.Cells[0].Text;
		...
		private void DataGrid1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("mtp_edit.aspx?" + id);
		}
