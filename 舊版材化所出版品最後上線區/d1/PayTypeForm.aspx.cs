...
namespace MRLPub.d1
{
	...
	public class PayTypeForm : System.Web.UI.Page
	{
		...
		protected System.Data.SqlClient.SqlCommand sqlUpdateInvmfr;
		protected System.Web.UI.HtmlControls.HtmlInputText tbxPost;
...
//				Response.Write(dv1[0][0].ToString());
		...
		{    
			...
			this.sqlUpdateInvmfr = new System.Data.SqlClient.SqlCommand();
			...
			// sqlUpdateInvmfr
			// 
			this.sqlUpdateInvmfr.CommandText = "UPDATE dbo.c3_invmfr SET im_fgia = @im_fgia, im_pytpcd = @im_pytpcd WHERE (im_sys" +
				"cd = @im_syscd) AND (im_appno = @im_appno) AND (im_imseq = @im_imseq)";
			this.sqlUpdateInvmfr.Connection = this.sqlConnection1;
			this.sqlUpdateInvmfr.Parameters.Add(new System.Data.SqlClient.SqlParameter("@im_fgia", System.Data.SqlDbType.Char, 1, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "im_fgia", System.Data.DataRowVersion.Current, null));
			this.sqlUpdateInvmfr.Parameters.Add(new System.Data.SqlClient.SqlParameter("@im_pytpcd", System.Data.SqlDbType.Char, 2, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "im_pytpcd", System.Data.DataRowVersion.Current, null));
			this.sqlUpdateInvmfr.Parameters.Add(new System.Data.SqlClient.SqlParameter("@im_syscd", System.Data.SqlDbType.Char, 2, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "im_syscd", System.Data.DataRowVersion.Current, null));
			this.sqlUpdateInvmfr.Parameters.Add(new System.Data.SqlClient.SqlParameter("@im_appno", System.Data.SqlDbType.Char, 6, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "im_appno", System.Data.DataRowVersion.Current, null));
			this.sqlUpdateInvmfr.Parameters.Add(new System.Data.SqlClient.SqlParameter("@im_imseq", System.Data.SqlDbType.Char, 2, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "im_imseq", System.Data.DataRowVersion.Current, null));
			// 
			// sqlDeleteComPyd
			// 
			...
			// sqlSelectCommand2
			// 
			this.sqlSelectCommand2.CommandText = "SELECT dbo.ia.ia_iaid, dbo.ia.ia_syscd, dbo.ia.ia_iano, dbo.iad.iad_fk1, dbo.iad." +
				"iad_fk2, dbo.iad.iad_iaditem, dbo.iad.iad_iano, dbo.iad.iad_syscd FROM dbo.ia IN" +
				"NER JOIN dbo.iad ON dbo.ia.ia_syscd = dbo.iad.iad_syscd AND dbo.ia.ia_iano = dbo" +
				".iad.iad_iano";
			...
			// sqlInsertComPy
			// 
			this.sqlInsertComPy.CommandText = @"INSERT INTO dbo.py(py_pyno, py_amt, py_pytpcd, py_date, py_moseq, py_moitem, py_chkno, py_chkbnm, py_chkdate, py_waccno, py_wdate, py_wbcd, py_ccno, py_cctp, py_ccauthcd, py_ccvdate, py_ccdate, py_fgprinted, py_syscd, py_pysdate, py_pysseq, py_pysitem, py_post) VALUES (@py_pyno, @py_amt, @py_pytpcd, @py_date, @py_moseq, @py_moitem, @py_chkno, @py_chkbnm, @py_chkdate, @py_waccno, @py_wdate, @py_wbcd, @py_ccno, @py_cctp, @py_ccauthcd, @py_ccvdate, @py_ccdate, @py_fgprinted, @py_syscd, @py_pysdate, @py_pysseq, @py_pysitem, @py_post)";
			...
			this.sqlInsertComPy.Parameters.Add(new System.Data.SqlClient.SqlParameter("@py_post", System.Data.SqlDbType.Real, 4, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "py_post", System.Data.DataRowVersion.Current, null));
			// 
			// sqlDataAdapter2
			// 
...
//			this.sqlInsertComPy.Parameters["@py_amt"].Value=lblAmt.Text.Trim();
			this.sqlInsertComPy.Parameters["@py_amt"].Value=amt.ToString();
			...
			this.sqlInsertComPy.Parameters["@py_post"].Value=tbxPost.Value;
			switch(ddlPayType.SelectedItem.Value)
			{
				case "01":
				case "06":
...
//				}
		...
		private void Update_c1_order_pytpcd()
		{
			...
			this.sqlDataAdapter2.Fill(ds1, "ia");
			DataView dv2 = ds1.Tables["ia"].DefaultView;
			...
			for(int i=0; i<(strbuf.Length/10);i++)
			{
				...
				else if(nostr.Substring(0,2)=="C3")
				{
					...
					this.sqlUpdateInvmfr.Parameters["@im_pytpcd"].Value=ddlPayType.SelectedItem.Value.Trim();
					this.sqlUpdateInvmfr.Parameters["@im_fgia"].Value="5";	//已繳款
					this.sqlUpdateInvmfr.Parameters["@im_syscd"].Value="C3";
					this.sqlUpdateInvmfr.Parameters["@im_appno"].Value=dv2[0].Row["iad_fk1"].ToString();
					this.sqlUpdateInvmfr.Parameters["@im_imseq"].Value=dv2[0].Row["iad_fk2"].ToString();
					this.sqlUpdateInvmfr.Connection.Open();
					this.sqlUpdateInvmfr.ExecuteNonQuery();
					this.sqlUpdateInvmfr.Connection.Close();
				}
			}
		}
