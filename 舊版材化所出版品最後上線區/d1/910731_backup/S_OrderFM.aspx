...
<%@ Page language="c#" Codebehind="S_OrderFM.aspx.cs" src="S_OrderFM.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d1.S_OrderFM" %>
...
<HTML>
	...
	<body>
		...
		<form id="S_OrderFM" method="post" runat="server">
			<center>
				<table>
					<tr>
