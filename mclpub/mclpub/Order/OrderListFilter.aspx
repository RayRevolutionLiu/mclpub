...
<asp:Content id="Content1" ContentPlaceholderID="ContentPlaceHolder1" runat="server">
    <span class="font_size12 font_darkblue font_bold">目前位置:&nbsp;訂戶管理 / 雜誌叢書訂單處理 / 訂單明細表</span> 
<span class="stripeMe">
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td>
        ...
        <asp:Label id="Label1" runat="server"  ForeColor="Maroon">(yyyy/mm/dd)</asp:Label>
      </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
        <asp:TextBox ID="tbxRecName" runat="server" MaxLength="20"></asp:TextBox>
      </td>
  </tr>
  </table>
</span>
