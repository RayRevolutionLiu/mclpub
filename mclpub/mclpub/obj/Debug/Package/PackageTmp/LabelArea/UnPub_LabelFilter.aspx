<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnPub_LabelFilter.aspx.cs" Inherits="mclpub.LabelArea.UnPub_LabelFilter"  MasterPageFile="~/MasterPage.Master"%>

<asp:Content id="Content1" ContentPlaceholderID="ContentPlaceHolder1" runat="server">
    <span class="font_size12 font_darkblue font_bold">目前位置:&nbsp;標籤管理 / 網路廣告標籤處理 / 大宗標籤(當月未刊登)</span>
<span class="stripeMe">
...
<span class="stripeMe">
    ...
    <asp:BoundField DataField="ma_mnt" HeaderText="未登本數" />
