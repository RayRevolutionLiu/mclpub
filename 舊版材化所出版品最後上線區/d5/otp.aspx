							...
							<TD align="left" width="100%">
								<asp:DataGrid id="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderColor="Black">
									...
									<Columns>
										...
										<asp:BoundColumn DataField="otp_otp1cd" HeaderText="訂購類別1代碼"></asp:BoundColumn>
										<asp:BoundColumn DataField="otp_otp1nm" HeaderText="訂購類別1名稱"></asp:BoundColumn>
										<asp:BoundColumn DataField="otp_otp2cd" HeaderText="訂購類別2代碼"></asp:BoundColumn>
										<asp:BoundColumn DataField="otp_otp2nm" HeaderText="訂購類別2名稱"></asp:BoundColumn>
						...
						<TR>
							<TD align="left" width="100%" height="40">
								...
								<asp:DropDownList id="ddlQueryField" runat="server">
									<asp:ListItem Value="otp_otp1nm" Selected="True">訂購類別1名稱</asp:ListItem>
									<asp:ListItem Value="otp_otp2nm">訂購類別2名稱</asp:ListItem>
								</asp:DropDownList>
