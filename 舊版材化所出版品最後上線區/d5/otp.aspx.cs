...
namespace MRLPub.d5
{
	...
	/// </summary>
	public class otp : System.Web.UI.Page
	{
		...
		{
			Response.Redirect("otp_addnew.aspx");
		}
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			SqlDataAdapter cmd=new SqlDataAdapter("delete from c1_otp where otp_otpid=@otp_otpid",myConn);
		
			cmd.SelectCommand.Parameters.Add("@otp_otpid",SqlDbType.Int,4).Value=e.Item.Cells[0].Text;
		...
		private void DataGrid1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("otp_edit.aspx?" + id);
		}
