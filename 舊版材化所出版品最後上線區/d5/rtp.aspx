...
<%@ Page language="c#" Src="rtp.aspx.cs" Codebehind="rtp.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.rtp" %>
						...
						<TR vAlign="top" height="224">
							<TD align="left" width="100%">
								<asp:DataGrid id="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderColor="Black">
									...
									<Columns>
										<asp:BoundColumn Visible="False" DataField="rtp_rtpid" ReadOnly="True" HeaderText="ID"></asp:BoundColumn>
										<asp:BoundColumn DataField="rtp_rtpcd" HeaderText="閱讀代碼"></asp:BoundColumn>
										<asp:BoundColumn DataField="rtp_nm" HeaderText="閱讀代碼名稱"></asp:BoundColumn>
						...
						<TR height="40">
							<TD align="left" width="100%">
								...
								<asp:DropDownList id="ddlQueryField" runat="server">
									<asp:ListItem Value="rtp_nm" Selected="True">閱讀代碼名稱</asp:ListItem>
									<asp:ListItem Value="rtp_rtpcd">閱讀代碼</asp:ListItem>
								</asp:DropDownList>
