...
<%@ Page language="c#" Codebehind="iaFm2_Recia.aspx.cs" Src="iaFm2_Recia.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d2.iaFm2_Recia" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>發票開立單回復(Recovery) - 大批月結 步驟二: 回復發票開立單</title>
	...
	<body>
		<!-- 頁首 Header -->
		<center>			<kw:header id="Header" runat="server"></kw:header>
		...
		<table dataFld="items" id="tbItems" style="WIDTH: 739px">
			<tr>
				<td style="WIDTH: 100%" align="left"><font color="#333333" size="2"><IMG height="10" src="../images/header/right02.gif" width="10" border="0">
						...
						發票開立單回復(Recovery) - 大批月結 步驟二: 回復發票開立單</font>
				</td>
			</tr>
		</table>
		<!-- Run at Server Form-->
		<form id="iaFm2_Recia" method="post" runat="server">
