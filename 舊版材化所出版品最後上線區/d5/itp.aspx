...
<%@ Page language="c#" Src="itp.aspx.cs" Codebehind="itp.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.itp" %>
...
<HTML>
	...
	<!-- 頁首 Header -->
		...
		<form id="itp" method="post" runat="server">
			<P>
				<FONT face="新細明體">
						...
						<TR vAlign="top" height="224">
							<TD align="left" width="100%">
								<asp:DataGrid id="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderColor="Black">
									...
									<Columns>
										<asp:BoundColumn Visible="False" DataField="itp_itpid" ReadOnly="True" HeaderText="ID"></asp:BoundColumn>
										<asp:BoundColumn DataField="itp_itpcd" HeaderText="領域代碼"></asp:BoundColumn>
										<asp:BoundColumn DataField="itp_nm" HeaderText="領域代碼名稱"></asp:BoundColumn>
						...
						<TR height="40">
							<TD align="left" width="100%">
								...
								<asp:DropDownList id="ddlQueryField" runat="server">
									<asp:ListItem Value="itp_nm" Selected="True">領域代碼名稱</asp:ListItem>
									<asp:ListItem Value="itp_itpcd">領域代碼</asp:ListItem>
								</asp:DropDownList>
