...
<%@ Page language="c#" Codebehind="RemailFM.aspx.cs" src="RemailFM.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d1.RemailFM" %>
...
<HTML>
	...
	<body>
		...
		<form id="RemailFM" method="post" runat="server">
			<center>
				<table>
					<tr>
						<td style="WIDTH: 627px" align="left">
							<font color="#333333" size="2"><IMG height="10" src="images/header/right02.gif" width="10" border="0">
								...
								補書處理<IMG height="10" src="images/header/right02.gif" width="10" border="0">補書資料修改</font>
						</td>
					</tr>
				</table>
				<TABLE style="WIDTH: 596px; HEIGHT: 68px" cellSpacing="0" cellPadding="4" bgColor="#bfcff0">
					...
					<tr>
						...
						<td style="WIDTH: 300px; HEIGHT: 1px" colSpan="3">
							<asp:label id="lblRecAddr" Runat="server" ForeColor="Maroon"></asp:label>
						</td>
					</tr>
					<tr bgColor="#214389">
						<td colSpan="4">
							<font color="white">補書資料</font>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="WIDTH: 192px; HEIGHT: 31px" colspan="3">
							<asp:textbox id="tbxRemailDate" runat="server" Width="82px" Enabled="False"></asp:textbox>
						</td>
					</tr>
					<tr>
				...
				<asp:button id="btnUpdate" runat="server" Text="修改補書資料"></asp:button>
