...
<span class="font_size12 font_darkblue font_bold">目前位置:&nbsp;客戶管理 / <asp:Label ID="showWhere" runat="server" Text="新增客戶資料"></asp:Label></span>  
<span class="font_red font_size12">*為必填欄位</span>    
  ...
  <tr>
   ...
   <tr>
    ...
    <span class="stripeMe">
            <font color="#696969" face="新細明體">(範例:03-1234567#123)<asp:requiredfieldvalidator 
            id="Requiredfieldvalidator3" runat="server" ControlToValidate="cust_tel" 
            ErrorMessage="必填欄位!" Display="Dynamic"></asp:requiredfieldvalidator>
        </font></span></td>
    ...
    <td>
        ...
        <asp:regularexpressionvalidator id="RegularExpressionValidator3" runat="server" ControlToValidate="cust_email" ErrorMessage="Email格式錯誤!" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:regularexpressionvalidator>
    </td>
    </tr>
    <tr>
