				...
				<tr>
					<td>
						<font color="#333333" size="2"><IMG height="10" src="images/header/right02.gif" width="10" border="0">
							...
							繳款處理<IMG height="10" src="images/header/right02.gif" width="10" border="0">繳款資料</font>
					</td>
				</tr>
			</table>
			...
			<asp:panel id="Panel3" runat="server" Visible="False">
				<TABLE style="WIDTH: 235px; HEIGHT: 72px" cellSpacing="0" cellPadding="0" border="0">
					...
					<TR bgColor="#e7e7ff">
						...
						<TD style="WIDTH: 113px">
							<INPUT id="tbxWbcb" style="WIDTH: 38px" type="text" maxLength="3" size="1" name="tbxWbcb" runat="server">
						</TD>
					</TR>
				</TABLE>
			</asp:panel>
