...
namespace MRLPub.d5
{
	...
	/// </summary>
	public class bookp : System.Web.UI.Page
	{
		...
		public void BindGrid()
		{
			...
			string SQL = "SELECT dbo.bookp.*, dbo.book.bk_nm AS bk_nm FROM dbo.bookp INNER JOIN dbo.book ON dbo.bookp.bkp_bkcd = dbo.book.bk_bkcd";
		...
		{
			Response.Redirect("bookp_addnew.aspx");
		}
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			string strConn = System.Configuration.ConfigurationSettings.AppSettings["mrlpub1"].ToString();
			SqlConnection myConn=new SqlConnection(strConn);
			SqlDataAdapter cmd=new SqlDataAdapter("delete from bookp where bkp_bkpid=@bkp_bkid",myConn);
		
			cmd.SelectCommand.Parameters.Add("@bkp_bkid",SqlDbType.Int,4).Value=e.Item.Cells[0].Text;
		...
		private void DataGrid1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("bookp_edit.aspx?" + id);
		}
