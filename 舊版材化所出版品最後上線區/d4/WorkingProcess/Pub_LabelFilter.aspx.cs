...
namespace MRLPub.d4.WorkingProcess
{
	...
	/// </summary>
	public class Pub_LabelFilter : MRLPub.d4.Pages.Page
	{
		...
		private void btnPrintLabel_Click(object sender, System.EventArgs e)
		{
			...
			// 轉址
			string	strbuf;
			strbuf = "PubFm_label.aspx?fgmosea=" + fgMOSea + "&bkpno=" + hiddenBookPno.Value.Trim();
		...
		private void btnPrintList_Click(object sender, System.EventArgs e)
		{
			...
			string	strbuf;
			strbuf = "Pub_LabelList.aspx?bk=" + strBk + "&yyyymm=" + strYYYYMM + "&srspn=" + strSrspn + "&conttp=" + strConttp + "&fgmosea=" + fgMOSea 
