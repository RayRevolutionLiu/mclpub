...
$("#<% =createdate.ClientID%>").datepicker(
{
    ...
    <span class="stripeMe">
    <span class="font_size12 font_darkblue font_bold">目前位置:&nbsp;客戶管理 / 新增廠商資料</span>  
  ...
  <tr>
    ...
    <span class="stripeMe">
        ...
        <asp:CheckBox ID="foreignChk" runat="server" Text="國外廠商請勾選" />
   ...
   <tr>
    ...
    <tr>
        ...
        <asp:TextBox ID="mfr_izip" runat="server" Width="42px" MaxLength="5"></asp:TextBox>
            <a href="http://www.post.gov.tw/post/internet/f_searchzone/index.jsp" target="_blank">郵遞區號查詢</a>
    ...
    <tr>
     ...
     <tr>
        ...
        <td>
        <asp:TextBox ID="createdate" runat="server"></asp:TextBox>
<span class="stripeMe">
    ...
    <td align="right" colspan="2">
        <asp:Button ID="submitBtn" runat="server" Text="確定新增" onclick="submitBtn_Click" />
        <input id="Button1" type="button" value="放棄新增" onclick="location.href='Company.aspx'" class="btn_mouseout" onmouseover="this.className='btn_mouseover'" onmouseout="this.className='btn_mouseout'"/>  
    </td>
    </tr>
        </table>
    </span>
