...
{
	/// <summary>
	/// Summary description for adcolor.
	/// </summary>
	public class adcolor : System.Web.UI.Page
	{
		...
		private void InitializeComponent()
		{
			...
			// sqlSelectCommand1
			//
			this.sqlSelectCommand1.CommandText = @"SELECT COUNT(dbo.c2_pub.pub_contno) AS PubCounts, dbo.c2_clr.clr_clrcd, dbo.c2_clr.clr_nm FROM dbo.c2_pub INNER JOIN dbo.c2_clr ON dbo.c2_pub.pub_clrcd = dbo.c2_clr.clr_clrcd WHERE (dbo.c2_clr.clr_clrcd = @clrcd) GROUP BY dbo.c2_clr.clr_clrcd, dbo.c2_clr.clr_nm";
			this.sqlSelectCommand1.Connection = this.sqlConnection1;
			this.sqlSelectCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@clrcd", System.Data.SqlDbType.VarChar, 2, "clr_clrcd"));
			//
			// sqlConnection1
			//
//			this.sqlConnection1.ConnectionString = "data source=ISCCOM2;initial catalog=mrlpub;password=db600;persist security info=T" +
//				"rue;user id=webuser;workstation id=17-0890711-01;packet size=4096";
			this.sqlConnection1.ConnectionString = System.Configuration.ConfigurationSettings.AppSettings["itridpa_mrlpub"].ToString();
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			// 抓出 廣告相關欄位之值
			string strclrcd = e.Item.Cells[1].Text.ToString();
			//Response.Write("strclrcd= "+ strclrcd + "<BR>");

			// 執行 將值塞入 sqlCommand1.Parameters 中, 以執行 篩選資料
			this.sqlSelectCommand1.Parameters["@clrcd"].Value = strclrcd;
			...
			else
			{
				...
				SqlDataAdapter cmd=new SqlDataAdapter("delete from c2_clr where clr_clrid=@clr_clrid",myConn);

				cmd.SelectCommand.Parameters.Add("@clr_clrid",SqlDbType.Int,4).Value=e.Item.Cells[0].Text;
		...
		private void DataGrid1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("adcolor_edit.aspx?" + id);
		}
		...
		{
			Response.Redirect("adcolor_addnew.aspx");
		}
