			...
			<form id="cont_main1" method="post" runat="server">
				...
				<TABLE style="WIDTH: 95%" cellSpacing="0" cellPadding="2" bgColor="#bfcff0">
					...
					<TR>
						...
						<TD rowSpan="3">
							<asp:label id="Label6" runat="server" ForeColor="DarkRed">1. 請輸入任一關鍵詞來查詢, 然後按下 "查詢".<br>
							...
							<font color="gray">註: 避免重覆新增廠商資料 - 請先 '輸入<U>廠商統一編號</U>後, 按下<U>旁邊的按鈕</U>來查詢!
									<br>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;如查無資料, 再按下方之 '<U>新增廠商資料</U>' 來新增廠商!</font><br>
									4. 已知欲修改之合約書編號, 可直接由 此連結<br>&nbsp;&nbsp;&nbsp;&nbsp; <A href="adpub_main21.aspx" target="_self">
									落版處理/廣告落版資料維護-由年月落版進入</A> 來直接修改!
									</asp:label>
						</TD>
					</TR>
					<TR>
