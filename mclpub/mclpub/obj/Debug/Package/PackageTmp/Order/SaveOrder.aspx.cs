...
namespace mclpub.Order
{
    public partial class SaveOrder : System.Web.UI.Page
    {
        ...
        {
            //System.IO.StreamReader sr = new StreamReader(Request.InputStream);
            //Response.Write(sr.ReadToEnd());
            //DataSet ds = new DataSet();
            //this.sqlDataAdapter5.Fill(ds, "ia");
            //Response.Write("aaa");
            //Response.Write("bbb");
            ...
            XmlDoc.LoadXml(Server.UrlDecode(Request.Form["transValueXml"].ToString()));
            ...
            if (ItemDetail.InnerXml.ToString().Length > 3500)
            {
                Response.Write("訂單明細資料過多,請分批新增");
                return;
            }
            XmlElement root;
            ...
            this.sqlInsertCom_order.Parameters["@o_status"].Value = "1";
            this.sqlInsertCom_order.Parameters["@o_moduid"].Value = reg.Trim();
            this.sqlInsertCom_order.Parameters["@o_oldvdate"].Value = "";
        ...
        private void InitializeComponent()
        {
            ...
            string Conn = ConfigurationManager.AppSettings["itridpr_mrlpub"];
            ...
            // sqlConnection1
            // 
            this.sqlConnection1.ConnectionString = Conn;
            // 
            // sqlDataAdapter4
            // 
            ...
            this.sqlInsertCom_order.Parameters.Add(new System.Data.SqlClient.SqlParameter("@o_empno", System.Data.SqlDbType.Char, 7, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "o_empno", System.Data.DataRowVersion.Current, null));
            ...
            this.sqlInsertCom_order.Parameters.Add(new System.Data.SqlClient.SqlParameter("@o_status", System.Data.SqlDbType.Char, 1, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "o_status", System.Data.DataRowVersion.Current, null));
            this.sqlInsertCom_order.Parameters.Add(new System.Data.SqlClient.SqlParameter("@o_moduid", System.Data.SqlDbType.Char, 7, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "o_moduid", System.Data.DataRowVersion.Current, null));
            // 
            // sqlSelectCom_order
            // 
        ...
        private bool InsertIAData()
        {
            ...
            this.sqlDataAdapter3.Fill(ds1, "c1_obtp");
            DataView dv1 = ds1.Tables["c1_obtp"].DefaultView;
            DataSet ds = new DataSet();
            this.sqlDataAdapter5.Fill(ds, "ia");
            DataView dv = ds.Tables["ia"].DefaultView;
            string iano = dv[0].Row["max_iano"].ToString();
            ...
            for (int j = 0; j < 8 - j1; j++)
                iano = "0" + iano;
            //-------新增發票開立單檔--------//
            for (int i = 0; i < this.sqlInsertCommand2.Parameters.Count; i++)
            {
                this.sqlInsertCommand2.Parameters[i].Value = "";
            }
            this.sqlInsertCommand2.Parameters["@ia_iano"].Value = iano;
            this.sqlInsertCommand2.Parameters["@ia_syscd"].Value = "C1";
            this.sqlInsertCommand2.Parameters["@ia_refno"].Value = "C1" + iano;
            this.sqlInsertCommand2.Parameters["@ia_mfrno"].Value = ItemOrder["統一編號"].FirstChild.OuterXml;
            int amt = 0;
            ...
            this.sqlInsertCommand2.Parameters["@ia_pyat"].Value = amt.ToString();
            ...
            if (ItemOrder["付款方式"].FirstChild.OuterXml == "06" || ItemOrder["付款方式"].FirstChild.OuterXml == "07")
                this.sqlInsertCommand2.Parameters["@ia_fgitri"].Value = ItemOrder["付款方式"].FirstChild.OuterXml;
            else
                this.sqlInsertCommand2.Parameters["@ia_fgitri"].Value = "";
            this.sqlInsertCommand2.Parameters["@ia_rnm"].Value = ItemOrder["發票收件人姓名"].FirstChild.OuterXml;
            this.sqlInsertCommand2.Parameters["@ia_raddr"].Value = ItemOrder["發票收件人地址"].FirstChild.OuterXml;
            this.sqlInsertCommand2.Parameters["@ia_rzip"].Value = ItemOrder["發票收件人郵遞區號"].FirstChild.OuterXml;
            if (ItemOrder["發票收件人職稱"].FirstChild != null)
                this.sqlInsertCommand2.Parameters["@ia_rjbti"].Value = ItemOrder["發票收件人職稱"].FirstChild.OuterXml;
            else
                this.sqlInsertCommand2.Parameters["@ia_rjbti"].Value = "";
            if (ItemOrder["發票收件人電話"].FirstChild != null)
                this.sqlInsertCommand2.Parameters["@ia_rtel"].Value = ItemOrder["發票收件人電話"].FirstChild.OuterXml;
            else
                this.sqlInsertCommand2.Parameters["@ia_rtel"].Value = "";
            this.sqlInsertCommand2.Parameters["@ia_invcd"].Value = ItemOrder["發票類別"].FirstChild.OuterXml;
            this.sqlInsertCommand2.Parameters["@ia_taxtp"].Value = ItemOrder["發票課稅別"].FirstChild.OuterXml;
            this.sqlInsertCommand2.Parameters["@ia_fgnonauto"].Value = "0";
            this.sqlInsertCommand2.Parameters["@ia_status"].Value = "";
            this.sqlInsertCommand2.Parameters["@ia_contno"].Value = ItemOrder["訂單流水號"].FirstChild.OuterXml;
            ...
            if (resultflag)
            {
                ...
                for (int i = 0; i < ItemDetail.ChildNodes.Count; i++)
                {
                    for (int i1 = 0; i1 < this.sqlInsertCommand4.Parameters.Count; i1++)
                    {
                        this.sqlInsertCommand4.Parameters[i1].Value = "";
                    }
                    this.sqlInsertCommand4.Parameters["@iad_syscd"].Value = "C1";
                    this.sqlInsertCommand4.Parameters["@iad_iano"].Value = iano;
                    str2 = Convert.ToString(i + 1);
                    item = 3 - str2.Length;
                    for (int k = 0; k < item; k++)
                        str2 = "0" + str2;
                    this.sqlInsertCommand4.Parameters["@iad_iaditem"].Value = str2;
                    this.sqlInsertCommand4.Parameters["@iad_fk1"].Value = ItemOrder["訂戶編號"].FirstChild.OuterXml;
                    this.sqlInsertCommand4.Parameters["@iad_fk2"].Value = ItemOrder["訂購類別一"].FirstChild.OuterXml;
                    this.sqlInsertCommand4.Parameters["@iad_fk3"].Value = ItemOrder["訂單流水號"].FirstChild.OuterXml.Substring(10, 3);
                    this.sqlInsertCommand4.Parameters["@iad_fk4"].Value = ItemDetail.ChildNodes.Item(i).SelectSingleNode("項次").InnerText;
                    this.sqlInsertCommand4.Parameters["@iad_projno"].Value = ItemDetail.ChildNodes.Item(i).SelectSingleNode("計劃代號").InnerText;
                    this.sqlInsertCommand4.Parameters["@iad_costctr"].Value = ItemDetail.ChildNodes.Item(i).SelectSingleNode("成本中心").InnerText;
                    //				dv1 = ds1.Tables["c1_obtp"].DefaultView;
                    dv1.RowFilter = "obtp_otp1cd='" + ItemOrder["訂購類別一"].FirstChild.OuterXml + "' and obtp_obtpcd='"
                        + ItemDetail.ChildNodes.Item(i).SelectSingleNode("書籍類別").InnerText + "'";
                    this.sqlInsertCommand4.Parameters["@iad_desc"].Value = dv1[0].Row["obtp_obtpnm"].ToString();
                    if ((ItemDetail.ChildNodes.Item(i).SelectSingleNode("訂閱起時").InnerText != "") && (ItemDetail.ChildNodes.Item(i).SelectSingleNode("訂閱訖時").InnerText != ""))
                    {
                        if ((ItemDetail.ChildNodes.Item(i).SelectSingleNode("訂閱起時").InnerText.Length >= 7) && (ItemDetail.ChildNodes.Item(i).SelectSingleNode("訂閱訖時").InnerText.Length >= 7))
                            this.sqlInsertCommand4.Parameters["@iad_desc"].Value = this.sqlInsertCommand4.Parameters["@iad_desc"].Value + ItemDetail.ChildNodes.Item(i).SelectSingleNode("訂閱起時").InnerText.Substring(0, 7)
                                + "~" + ItemDetail.ChildNodes.Item(i).SelectSingleNode("訂閱訖時").InnerText.Substring(0, 7);
                    }
                    //				this.sqlInsertCommand4.Parameters["@iad_unit"].Value="";
                    this.sqlInsertCommand4.Parameters["@iad_qty"].Value = Convert.ToInt32(ItemDetail.ChildNodes.Item(i).SelectSingleNode("總數量").InnerText);
                    //				this.sqlInsertCommand4.Parameters["@iad_uprice"].Value=0.0;
                    this.sqlInsertCommand4.Parameters["@iad_amt"].Value = Convert.ToInt32(ItemDetail.ChildNodes.Item(i).SelectSingleNode("金額").InnerText);
                    this.sqlInsertCommand4.Connection.Open();
                    this.sqlInsertCommand4.ExecuteNonQuery();
                    this.sqlInsertCommand4.Connection.Close();
                }
                ...
                this.sqlUpdateCommand1.Parameters["@o_iano"].Value = iano;
