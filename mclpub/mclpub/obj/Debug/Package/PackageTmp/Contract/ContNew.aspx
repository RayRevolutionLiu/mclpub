<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContNew.aspx.cs" Inherits="mclpub.Contract.ContNew"  MasterPageFile="~/MasterPage.Master" MaintainScrollPositionOnPostback="true"%>
...
<script language="javascript">
    ...
    <span class="font_size12 font_darkblue font_bold">目前位置:&nbsp;廣告合約管理 / 網路廣告合約書 步驟三:新增合約書內容</span>  
    <span class="stripeMe">
    <center>
    ...
    <span class="stripeMe">
								...
								<TR>
									<th colspan="4">材料特性及應用產業相關資料</th>
											...
											<TR>
												<TD vAlign="top" width="50%" colspan="2">材料特性：<IMG class="ico" alt="ATP_MATP" src="<%=ResolveUrl("~/Art/images/btn_data.gif")%>" border="0" onclick="doDetail('900','600','AtpMatp.aspx?NewContNo=<% Response.Write(lblContNo.Text.Trim()); %>&ClassId=1');">
												...
												<TD vAlign="top" colspan="2">應用產業：<IMG class="ico" alt="ATP_MATP" src="<%=ResolveUrl("~/Art/images/btn_data.gif")%>" border="0" onclick="doDetail('900','600','AtpMatp.aspx?NewContNo=<% Response.Write(lblContNo.Text.Trim()); %>&ClassId=2');">
					            ...
					            <TR>
		                            ...
		                            <span class="stripeMe">
                                        <IMG 
            onclick="doDetail('900','600','FreeBook.aspx?Act=New&CustNo=<% Response.Write(lblCustNo.Text); %>&NewContNo=<% Response.Write(lblContNo.Text.Trim()); %>&OldContNo=<% Response.Write(tbxOldContNo.Text.Trim()); %>');" 
