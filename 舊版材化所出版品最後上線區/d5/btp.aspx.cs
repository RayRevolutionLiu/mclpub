...
namespace MRLPub.d5
{
	...
	/// </summary>
	public class btp : System.Web.UI.Page
	{
		...
		{
			Response.Redirect("btp_addnew.aspx");
		}
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			string strConn = System.Configuration.ConfigurationSettings.AppSettings["itridpa_mrlpub"].ToString();
			SqlConnection myConn=new SqlConnection(strConn);
			SqlDataAdapter cmd=new SqlDataAdapter("delete from btp where btp_btpid=@btp_btpid",myConn);
		
			cmd.SelectCommand.Parameters.Add("@btp_btpid",SqlDbType.Int,4).Value=e.Item.Cells[0].Text;
		...
		private void DataGrid1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("btp_edit.aspx?" + id);
		}
