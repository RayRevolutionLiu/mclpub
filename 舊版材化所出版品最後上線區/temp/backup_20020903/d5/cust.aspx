<%@ Page language="c#" Src="cust.aspx.cs" Codebehind="cust.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.cust" %>
	...
	<body>
		...
		<CENTER>
			<FORM id="cust" method="post" runat="server">
				<FONT face="新細明體">
					<TABLE id="tbItems" cellSpacing="0" cellPadding="0" width="720" border="0">
						<TR>
