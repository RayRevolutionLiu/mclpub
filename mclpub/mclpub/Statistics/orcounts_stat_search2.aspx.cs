...
{
    public partial class orcounts_stat_search2 : System.Web.UI.Page
    {
        ...
        public DataTable BindExcel()
        {
            ...
            DataSet ds = myORCount.Selectc2_cont2(strBkcd, strYYYYMM, strConttp, fgMOSea, Mtpcd);
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            Xls.SetCellValue(1, 1, "郵寄本數統計表 － 合約內未刊");
            ...
            Common.excuteExcel(Xls, "ORCounts_stat2b.xls");
