<%@ Page language="c#" Src="bookp_edit.aspx.cs" Codebehind="bookp_edit.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.bookp_edit" %>
	...
	<body>
		<form id="bookp_addnew" method="post" runat="server">
			...
			<TABLE cellSpacing="1" cellPadding="3" width="55%" bgColor="#bfcff0" border="0">
				<TR bgColor="#214389">
					<TD colSpan="4">
						<FONT color="#ffffff">修改書籍期別資料</FONT>
					</TD>
				</TR>
				<TR>
					<TD style="WIDTH: 99px">
