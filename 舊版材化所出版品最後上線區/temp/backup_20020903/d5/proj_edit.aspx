<%@ Page language="c#" Src="proj_edit.aspx.cs" Codebehind="proj_edit.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.proj_edit" %>
...
<HTML>
	...
	<body>
		<form id="proj_edit" method="post" runat="server">
			<P>
				<FONT face="新細明體">
			...
			<TABLE cellSpacing="1" cellPadding="3" width="65%" bgColor="#bfcff0" border="0">
				<TR bgColor="#214389">
					<TD colSpan="4">
						<FONT color="#ffffff">修改計劃代號資料</FONT>
					</TD>
				</TR>
				<TR>
					<TD style="WIDTH: 99px">
				...
				<TR>
					...
					<TD colSpan="2">
						...
						<asp:regularexpressionvalidator id="Regularexpressionvalidator1" runat="server" ValidationExpression="[0-9]{2}" ErrorMessage="請輸入 2 位數字!" ControlToValidate="proj_fgitri" Display="Dynamic"></asp:regularexpressionvalidator>
					</TD>
				</TR>
				<TR>
					<TD style="WIDTH: 99px">
