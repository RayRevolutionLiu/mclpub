...
{
	/// <summary>
	/// Summary description for LostMod.
	/// </summary>
	public class LostMod : System.Web.UI.Page
	{
		...
		{    
			...
			// sqlDaLostOr
			// 
			this.sqlDaLostOr.SelectCommand = this.sqlSelectCommand1;
			// 
			// sqlSelectCommand1
			// 
			this.sqlSelectCommand1.CommandText = "SELECT dbo.c4_cont.cont_syscd, dbo.c4_cont.cont_contno, dbo.c4_cont.cont_custno, " +
				...
				"t.ma_oritem, CONVERT (CHAR(2), dbo.c4_ramt.ma_pubmnt) + \'/\' + CONVERT (CHAR(2), " +
				"dbo.c4_ramt.ma_unpubmnt) AS fbkmnt, dbo.c4_lost.lst_seq, dbo.c4_lost.lst_cont, d" +
				"bo.c4_lost.lst_date, dbo.c4_lost.lst_rea, dbo.c4_lost.lst_fgsent, dbo.c4_freebk." +
				"fbk_contno, dbo.c4_freebk.fbk_syscd, dbo.c4_lost.lst_contno, dbo.c4_lost.lst_fbk" +
				"item, dbo.c4_lost.lst_oritem, dbo.c4_lost.lst_syscd, dbo.c4_or.or_contno, dbo.c4" +
				"_or.or_syscd, dbo.c4_ramt.ma_contno, dbo.c4_ramt.ma_syscd FROM dbo.c4_cont INNER" +
				" JOIN dbo.c4_or ON dbo.c4_cont.cont_syscd = dbo.c4_or.or_syscd AND dbo.c4_cont.c" +
				"ont_contno = dbo.c4_or.or_contno INNER JOIN dbo.cust ON dbo.c4_cont.cont_custno " +
				"= dbo.cust.cust_custno INNER JOIN dbo.mfr ON dbo.c4_cont.cont_mfrno = dbo.mfr.mf" +
				"r_mfrno INNER JOIN dbo.c4_freebk ON dbo.c4_cont.cont_syscd = dbo.c4_freebk.fbk_s" +
				"yscd AND dbo.c4_cont.cont_contno = dbo.c4_freebk.fbk_contno INNER JOIN dbo.c4_ra" +
				"mt ON dbo.c4_cont.cont_syscd = dbo.c4_ramt.ma_syscd AND dbo.c4_cont.cont_contno " +
				"= dbo.c4_ramt.ma_contno AND dbo.c4_freebk.fbk_fbkitem = dbo.c4_ramt.ma_fbkitem A" +
				"ND dbo.c4_or.or_oritem = dbo.c4_ramt.ma_oritem INNER JOIN dbo.c4_lost ON dbo.c4_" +
				"cont.cont_syscd = dbo.c4_lost.lst_syscd AND dbo.c4_cont.cont_contno = dbo.c4_los" +
				"t.lst_contno AND dbo.c4_freebk.fbk_fbkitem = dbo.c4_lost.lst_fbkitem AND dbo.c4_" +
				"or.or_oritem = dbo.c4_lost.lst_oritem";
			...
			// sqlDaContOr
			// 
			this.sqlDaContOr.SelectCommand = this.sqlSelectCommand2;
			// 
			// sqlSelectCommand2
			// 
...
//			{
//				case "0":
//					strFilter += "(lst_fgsent='Y' OR lst_fgsent='N')";
//					break;
//				case "1":
...
//			fcount++;
		...
		{
			//製作比較合理的SELECT COMMAND
			//第一層的filter
			string strFilter1 = "";
			switch(this.rblSent.SelectedItem.Value.Trim())
			{
				case "0":
					strFilter1 += "(lst_fgsent='Y' OR lst_fgsent='N')";
					break;
				case "1":
					strFilter1 += "(lst_fgsent='C')";
					break;
				case "2":
					strFilter1 += "(lst_fgsent='d')";
					break;
			}
			string strCmd1 = "SELECT DISTINCT dbo.c4_cont.cont_syscd, dbo.c4_cont.cont_contno, dbo.c4_cont.cont_custno, "+
							"dbo.c4_cont.cont_conttp, dbo.c4_cont.cont_sdate, dbo.c4_cont.cont_edate, "+
							"dbo.c4_cont.cont_mfrno, dbo.c4_or.or_oritem, dbo.c4_or.or_nm, dbo.c4_or.or_jbti, "+
							"dbo.c4_or.or_addr, dbo.c4_or.or_tel, dbo.cust.cust_nm, dbo.mfr.mfr_inm, "+
							"dbo.cust.cust_custno, dbo.mfr.mfr_mfrno, dbo.c4_freebk.fbk_fbkitem, "+
							"dbo.c4_freebk.fbk_bkcd, dbo.c4_ramt.ma_pubmnt, dbo.c4_ramt.ma_unpubmnt, "+
							"dbo.c4_ramt.ma_fbkitem, dbo.c4_ramt.ma_oritem, dbo.c4_freebk.fbk_contno, "+
							"dbo.c4_freebk.fbk_syscd, dbo.c4_or.or_contno, dbo.c4_or.or_syscd, "+
							"dbo.c4_ramt.ma_contno, dbo.c4_ramt.ma_syscd, CONVERT(CHAR(2), "+
							"dbo.c4_ramt.ma_pubmnt) + '/' + CONVERT(CHAR(2), dbo.c4_ramt.ma_unpubmnt) AS fbkmnt "+
							"FROM dbo.c4_cont INNER JOIN "+
							"dbo.c4_or ON dbo.c4_cont.cont_syscd = dbo.c4_or.or_syscd AND "+
							"dbo.c4_cont.cont_contno = dbo.c4_or.or_contno INNER JOIN "+
							...
							"dbo.c4_freebk ON dbo.c4_cont.cont_syscd = dbo.c4_freebk.fbk_syscd AND  "+
							"dbo.c4_cont.cont_contno = dbo.c4_freebk.fbk_contno INNER JOIN "+
							"dbo.c4_ramt ON dbo.c4_cont.cont_syscd = dbo.c4_ramt.ma_syscd AND "+ 
							"dbo.c4_cont.cont_contno = dbo.c4_ramt.ma_contno AND "+
							"dbo.c4_freebk.fbk_fbkitem = dbo.c4_ramt.ma_fbkitem AND "+ 
							"dbo.c4_or.or_oritem = dbo.c4_ramt.ma_oritem INNER JOIN "+
							"dbo.c4_lost ON dbo.c4_cont.cont_syscd = dbo.c4_lost.lst_syscd AND "+
							"dbo.c4_cont.cont_contno = dbo.c4_lost.lst_contno AND "+
							"dbo.c4_freebk.fbk_fbkitem = dbo.c4_lost.lst_fbkitem AND "+ 
							"dbo.c4_or.or_oritem = dbo.c4_lost.lst_oritem "+
							" WHERE " + strFilter1;
			string strCmd2 = "SELECT * FROM (" + strCmd1 + ") DRIVERTBL";
			this.sqlDaContOr.SelectCommand.CommandText = strCmd2;
			//以上為合理的SELECT COMMAND
