<%@ Page language="c#" Codebehind="RemailAdd.aspx.cs" Src="RemailAdd.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d4.RemailAdd" %>
...
<table>
  <tr>
    <td style="WIDTH: 627px" align=left><font 
      color=#333333 size=2><IMG height=10 src="images/header/right02.gif" width=10 border=0 > &nbsp;材料世界網廣告次系統<IMG height=10 src="images/header/right02.gif" width=10 border=0 > 補書處理 <IMG height=10 src="images/header/right02.gif" width=10 border=0 >&nbsp;補書登錄 
</FONT></TD></TR></TABLE>
<TABLE style="WIDTH: 604px" cellSpacing=0 cellPadding=2 bgColor=#bfcff0>
  ...
  <TR>
    ...
    <td colSpan=3><asp:radiobuttonlist id=rblSent runat="server" RepeatDirection="Horizontal" Enabled=False>
