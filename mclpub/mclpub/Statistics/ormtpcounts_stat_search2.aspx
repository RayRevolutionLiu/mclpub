<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ormtpcounts_stat_search2.aspx.cs" Inherits="mclpub.Statistics.ormtpcounts_stat_search2" %>
  ...
  <tr>
    ...
    <span class="stripeMe">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="font_blacklink font_size13"
            ...
            <Columns>
                <asp:BoundField DataField="conttpnm" HeaderText="合約類別" />
                <asp:BoundField DataField="bknm" HeaderText="書籍名稱" />
                <asp:BoundField DataField="mtpnm" HeaderText="郵寄類別名稱" />
                <asp:BoundField DataField="Unpubcnt" HeaderText="未登本數" />
                <asp:BoundField DataField="UnPubCounts" HeaderText="份數" />
