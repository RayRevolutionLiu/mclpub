				...
				<TABLE cellSpacing="0" cellPadding="4" width="92%" bgColor="#bfcff0" border="0">
					...
					<TR>
						...
						<TD class="cssData">
							...
							<IMG id="img_signdate" onclick='javascript:pick_date("tbxSignDate", "tbxStartDate", "tbxEndDate");return false;'
								height="18" alt="查詢日期" src="../images/calendar01.gif" width="18">&nbsp; <FONT color="blue">
								[</FONT><FONT color="red">*</FONT><FONT color="blue">為必填欄位]</FONT>
							<br>
					...
					<TR>
						<TD class="cssTitle" vAlign="middle" align="center" colSpan="4">
					...
					<TR>
						<TD colSpan="4">
							<asp:datagrid id="DataGrid1" runat="server" AutoGenerateColumns="False" BorderColor="#3366CC"
								BorderWidth="1px" BackColor="White" BorderStyle="None" CellPadding="2" Font-Size="XX-Small">
					...
					<TR>
						<TD colSpan="4">
							<asp:datagrid id="Datagrid2" runat="server" CellPadding="2" BorderStyle="None" BackColor="White"
								BorderWidth="1px" BorderColor="#3366CC" AutoGenerateColumns="False">
								<HeaderStyle Font-Bold="True" BackColor="#BFCFF0"></HeaderStyle>
								<Columns>
