	...
	<body>
		<form id="ormtpcount2_stat2a" method="post" runat="server">
			<%
				...
				sqlcmd2 = sqlcmd2 & " CASE WHEN cont_conttp = '01' THEN '一般' ELSE '推廣' END AS cont_conttpName, "
				...
				sqlcmd1 = sqlcmd1 & " CASE WHEN cont_conttp = '01' THEN '一般' ELSE '推廣' END AS cont_conttpName, "
				...
				' 若有資料, 則輸出至 ExcelSpeedGen
					...
					'A1(X,5) = sum_PubCounts & " 份"
					'A1(X,6) = sum_Counts & " 本"
					TotalPubCounts = TotalPubCounts & " 份"
