...
namespace MRLPub.d5
{
	...
	public class book : System.Web.UI.Page
	{
		...
		{
			Response.Redirect("book_addnew.aspx");
		}
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			SqlDataAdapter cmd=new SqlDataAdapter("delete from book where bk_bkid=@bk_bkid",myConn);
		
			cmd.SelectCommand.Parameters.Add("@bk_bkid",SqlDbType.Int,4).Value=e.Item.Cells[0].Text;
		...
		private void DataGrid1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("book_edit.aspx?" + id);
		}
