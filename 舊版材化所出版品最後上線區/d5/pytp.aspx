...
<%@ Page language="c#" Src="pytp.aspx.cs" Codebehind="pytp.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.pytp" %>
...
<HTML>
	...
	<body>
		...
		<form id="pytp" method="post" runat="server">
			<P>
				<FONT face="新細明體">
						...
						<TR vAlign="top" height="224">
							<TD align="left" width="100%">
								<asp:DataGrid id="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderColor="Black">
									...
									<Columns>
										<asp:BoundColumn Visible="False" DataField="pytp_pytpid" ReadOnly="True" HeaderText="ID"></asp:BoundColumn>
										<asp:BoundColumn DataField="pytp_pytpcd" HeaderText="付款方式代碼"></asp:BoundColumn>
										<asp:BoundColumn DataField="pytp_nm" HeaderText="付款方式名稱"></asp:BoundColumn>
						...
						<TR height="40">
							<TD align="left" width="100%">
								...
								<asp:DropDownList id="ddlQueryField" runat="server">
									<asp:ListItem Value="pytp_nm" Selected="True">付款方式名稱</asp:ListItem>
									<asp:ListItem Value="pytp_pytpcd">付款方式代碼</asp:ListItem>
								</asp:DropDownList>
