<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="DeleteIa.aspx.cs" Inherits="mclpub.SetAccount.DeleteIa" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<span class="font_size12 font_darkblue font_bold">目前位置:&nbsp;帳務管理 / 雜誌叢書發票處理 / 註銷發票</span>
<span class="stripeMe">
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td>
        ...
        <input id="hiddenIano" runat="server" type="hidden" />
...
<table border="0" width="100%" cellspacing="0" cellpadding="0" runat="server" id="SearchIcon">
    <tr>
        ...
        <td align="right">
            &nbsp;
            <asp:Button ID="btnDelete" runat="server" Text="註銷發票" Visible="False" 
