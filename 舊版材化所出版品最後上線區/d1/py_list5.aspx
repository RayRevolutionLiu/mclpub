	...
	<body>
		<form id="odlist" method="post" runat="server">
			<%
				...
				sqlcmd1 = sqlcmd1 & "WHERE (py.py_pytpcd = '05') and py_pysdate='"& Request("yyyymm") & "' and py_pysseq='"&Request("batch") &"'"
...
'							A1(i,3) = Rs1("ia_pyat").Value
							...
							A1(i,5) = Rs1("mfr_inm").Value
							A1(i,6) = Rs1("ia_mfrno").Value
							A1(i,7) = Rs1("py_ccno").Value
							A1(i,8) = Rs1("py_ccauthcd").Value
							A1(i,9) = Rs1("py_ccvdate").Value
							A1(i,10) = Rs1("ia_invno").Value
							A1(i,13) = Rs1("ia_syscd").Value
							A1(i,14) = Rs1("ia_iano").Value
						end if
...
'					Loop
					...
					SrcBook = Server.MapPath("py_list5.xls")
					
					' Generate SpreadSheet and Stream to Client, Open in Place
					XLS.Generate(SrcBook, "py_list5.xls", True)
