<%@ Page language="c#" Codebehind="iaFm1_Rec.aspx.cs" Src="iaFm1_Rec.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d2.iaFm1_Rec" %>
<%@ Register TagPrefix="kw" TagName="header" Src="../UserControl/header.ascx" %>
<%@ Register TagPrefix="kw" TagName="footer" Src="../UserControl/footer.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<TITLE>發票開立單回復(Recovery) - 一次付款 - 步驟一: 挑選發票廠商</TITLE>
		...
		<table dataFld="items" id="tbItems" style="WIDTH: 739px">
			<tr>
				<td style="WIDTH: 100%" align="left"><font color="#333333" size="2"><IMG height="10" src="../images/header/right02.gif" width="10" border="0">
						...
						發票開立單回復(Recovery) - 一次付款 - 步驟一: 挑選發票廠商</font>
				</td>
			</tr>
		</table>
		<!-- Run at Server Form-->
		<form id="iaFm1_Rec" method="post" runat="server">
			...
			<br>
			<!-- 操作步驟 -->
			<asp:label id="lblMemo1" runat="server" Font-Size="X-Small" ForeColor="#C04000">操作步驟 1：請挑選要回復的合約書編號及發票廠商收件人, 再按下 '確認挑選' 按鈕!</asp:label><br>
