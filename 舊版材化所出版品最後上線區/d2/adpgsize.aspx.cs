...
{
	/// <summary>
	/// Summary description for adpgsize.
	/// </summary>
	public class adpgsize : System.Web.UI.Page
	{
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			// 抓出 廣告相關欄位之值
			string strpgscd = e.Item.Cells[1].Text.ToString();
			//Response.Write("strpgscd= "+ strpgscd + "<BR>");

			// 執行 將值塞入 sqlCommand1.Parameters 中, 以執行 篩選資料
			this.sqlSelectCommand1.Parameters["@pgscd"].Value = strpgscd;
			...
			else
			{
				...
				SqlDataAdapter cmd=new SqlDataAdapter("delete from c2_pgsize where pgs_pgsid=@pgs_pgsid",myConn);

				cmd.SelectCommand.Parameters.Add("@pgs_pgsid",SqlDbType.Int,4).Value=e.Item.Cells[0].Text;
		...
		private void DataGrid1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("adpgsize_edit.aspx?" + id);
		}
		...
		{
			Response.Redirect("adpgsize_addnew.aspx");
		}
		...
		private void InitializeComponent()
		{
			...
			// sqlSelectCommand1
			//
			this.sqlSelectCommand1.CommandText = @"SELECT COUNT(dbo.c2_pub.pub_contno) AS PubCounts, dbo.c2_pgsize.pgs_pgscd, dbo.c2_pgsize.pgs_nm FROM dbo.c2_pgsize INNER JOIN dbo.c2_pub ON dbo.c2_pgsize.pgs_pgscd = dbo.c2_pub.pub_pgscd WHERE (dbo.c2_pgsize.pgs_pgscd = @pgscd) GROUP BY dbo.c2_pgsize.pgs_pgscd, dbo.c2_pgsize.pgs_nm";
			this.sqlSelectCommand1.Connection = this.sqlConnection1;
			this.sqlSelectCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@pgscd", System.Data.SqlDbType.VarChar, 2, "pgs_pgscd"));
			//
			// sqlConnection1
			//
