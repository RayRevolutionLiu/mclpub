...
namespace MRLPub.d5
{
	...
	/// </summary>
	public class rtp : System.Web.UI.Page
	{
		...
		{
			Response.Redirect("rtp_addnew.aspx");
		}
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			SqlDataAdapter cmd=new SqlDataAdapter("delete from rtp where rtp_rtpid=@rtp_rtpid",myConn);
		
			cmd.SelectCommand.Parameters.Add("@rtp_rtpid",SqlDbType.Int,4).Value=e.Item.Cells[0].Text;
		...
		private void DataGrid1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("rtp_edit.aspx?" + id);
		}
