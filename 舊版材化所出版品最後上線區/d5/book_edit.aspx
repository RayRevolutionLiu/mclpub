<%@ Page language="c#" Src="book_edit.aspx.cs" Codebehind="book_edit.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d5.book_edit" %>
	...
	<body>
		<form id="book_addnew" method="post" runat="server">
						...
						<TR>
							<TD align="left" width="100%">
								<FONT color="#333333" size="2"><IMG height="10" src="../images/header/right02.gif" width="10" border="0">&nbsp;共同檔案
									<IMG height="10" src="../images/header/right02.gif" width="10" border="0">&nbsp;書籍資料維護&nbsp;<IMG height="10" src="../images/header/right02.gif" width="10" border="0">
									修改書籍資料 </FONT>
							</TD>
						</TR>
					</TABLE>
			...
			<TABLE cellSpacing="1" cellPadding="3" width="55%" bgColor="#bfcff0" border="0">
				<TR bgColor="#214389">
					<TD colSpan="4">
						<FONT color="#ffffff">修改書籍資料</FONT>
					</TD>
				</TR>
				<TR>
					<TD style="WIDTH: 75px">
						<P align="right">
							<FONT color="#ff0000">&nbsp;<FONT color="#ff0000">* </FONT></FONT>書籍代碼:
						</P>
					</TD>
