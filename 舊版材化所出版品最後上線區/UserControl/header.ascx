<!-- 表頭: MenuBar 區 ... 已到Layer(65) -->
<%@ Control CodeBehind="header.ascx.cs" src="header.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="mrlpub.UserControl.header" %>
<html>
	<HEAD>
...
//-->
	...
	<BODY topmargin="0" leftmargin="0">
		<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-width: 0"
			bordercolor="#29498C" bgcolor="29284A" width="100%" id="AutoNumber1">
			<tr>
				<td width="100%" style="border-style: none; border-width: medium">
					<img border="0" src="/mrlpub/images/header/Logo0.jpg" height="30"></td>
			</tr>
		</table>
		<TABLE WIDTH="100%" BORDER="1" CELLPADDING="3" CELLSPACING="0" height="18" style="border-collapse: collapse"
			bordercolor="#d6e0fe">
			<TR>
				<TD width="56" align="center" height="12" onMouseOver="this.style.background='#1A3264';"
					onMouseOut="this.style.background='#3366CC';" bgcolor="#3366CC" nowrap><A HREF="/mrlpub/Default.aspx" class="header">
						系統首頁</A></TD>
				<TD bgcolor="#3366CC" width="117" align="center" height="12" onMouseOver="this.style.background='#1A3264';"
					onMouseOut="this.style.background='#3366CC';" nowrap><A HREF="#" onMouseOver="JavaM(1)" onMouseOut="Hide(1)" class="header">
						雜誌叢書訂閱次系統</A></TD>
				<TD bgcolor="#3366CC" width="92" align="center" height="12" onMouseOver="this.style.background='#1A3264';"
					onMouseOut="this.style.background='#3366CC';" nowrap><A HREF="#" onMouseOver="JavaM(2)" onMouseOut="Hide(2)" class="header">
						平面廣告次系統</A></TD>
				<TD bgcolor="#3366CC" width="127" align="center" height="12" onMouseOver="this.style.background='#1A3264';"
					onMouseOut="this.style.background='#3366CC';" nowrap><A HREF="#" onMouseOver="JavaM(3)" onMouseOut="Hide(3)" class="header">
						材料世界網收費次系統</A></TD>
				<TD bgcolor="#3366CC" width="92" align="center" height="12" onMouseOver="this.style.background='#1A3264';"
					onMouseOut="this.style.background='#3366CC';" nowrap><A HREF="#" onMouseOver="JavaM(4)" onMouseOut="Hide(4)" class="header">
						網路廣告次系統</A></TD>
				<TD bgcolor="#3366CC" width="56" align="center" height="12" onMouseOver="this.style.background='#1A3264';"
					onMouseOut="this.style.background='#3366CC';" nowrap><A HREF="#" onMouseOver="JavaM(20)" onMouseOut="Hide(20)" class="header">
						共用檔案</A></TD>
				<TD bgcolor="#3366CC" width="52" align="center" height="12" onMouseOver="this.style.background='#1A3264';"
					onMouseOut="this.style.background='#3366CC';" nowrap><A HREF="#" onMouseOver="JavaM(32)" onMouseOut="Hide(32)" class="header">
						SAP轉檔</A></TD>
				<TD bgcolor="#3366CC" width="52" align="center" height="12" onMouseOver="this.style.background='#1A3264';"
					onMouseOut="this.style.background='#3366CC';" nowrap><A HREF="#" onMouseOver="JavaM(64)" onMouseOut="Hide(64)" class="header">
						特殊需求</A></TD>
				<TD bgcolor="#3366CC" align="center" height="12" nowrap>
				</TD>
			</TR>
		</TABLE>
		</SPAN>
...
Layer[1] =    new LayerSpecs(61,44,80,
	     ...
	     '<A HREF="/mrlpub/d1/UnpaidListFilter.aspx" onMouseOver="JavaM(1)" class="header"> &nbsp; 催款處理</A> ',
...
//4
Layer[4] =    new LayerSpecs(418,44,80,
            ...
            '<A HREF="#" onMouseOver="JavaM(60,4)" class="header"> &nbsp; 標籤處理</A> &nbsp; '+arrow,
	     	'<A HREF="/mrlpub/d1/UnpaidListFilter.aspx" onMouseOver="JavaM(4)" class="header"> &nbsp; 催款處理</A> ',
            '<A HREF="#" onMouseOver="JavaM(58,4)" class="header"> &nbsp; 其他報表</A> &nbsp; '+arrow,
	     	'<A HREF="/mrlpub/temp.aspx" onMouseOver="JavaM(4)" class="header"> &nbsp; 資料搜尋</A> '
);
...
//7
Layer[64] =    new LayerSpecs(639,44,167,
            '<A HREF="/mrlpub/d1/S_SearchCust1.aspx" class="header"> &nbsp; 新增舊訂單( 不新增 ia 及 py )</A> ',
            '<A HREF="/mrlpub/d1/S_FixCostCenter.aspx" class="header"> &nbsp; 成本中心異動修正</A> '
);
...
Layer[21] =    new LayerSpecs(286,116,138,
            ...
            '<A HREF="/mrlpub/d1/PayFMFilter.aspx" class="header"> &nbsp; 修改繳款單</A> ',
            '<A HREF="/mrlpub/d1/PayDelete.aspx" class="header"> &nbsp; 刪除繳款單</A> ',
            '<A HREF="/mrlpub/d1/CheckList7.aspx" class="header"> &nbsp; 繳款單檢核表</A> ',
            '<A HREF="/mrlpub/d1/PayListFilter.aspx" class="header"> &nbsp; 繳款清單產生</A> ',
            '<A HREF="/mrlpub/d1/RecoveryPayList.aspx" class="header"> &nbsp; 繳款清單回復(Recovery)</A> ',
            '<A HREF="/mrlpub/d1/PayListPrint.aspx" class="header"> &nbsp; 列印繳款清單</A> '
);
...
//4-1
Layer[34] =    new LayerSpecs(499,44,110,
            '<A HREF="#" onMouseOver="JavaM(35,34,4)" class="header"> &nbsp; 合約書</A> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; '+arrow,
            '<A HREF="/mrlpub/d4/WorkingProcess/ContChkList.aspx" onMouseOver="JavaM(34,4)" class="header"> &nbsp; 合約書檢核表</A> ',
            '<A HREF="#" onMouseOver="JavaM(36,34,4)" class="header"> &nbsp; 合約書清單</A> &nbsp; &nbsp; &nbsp; &nbsp; '+arrow,
            '<A HREF="/mrlpub/d4/WorkingProcess/ContCanceled.aspx" onMouseOver="JavaM(34,4)" class="header"> &nbsp; 已註銷合約處理</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/RptAdAmtQuery.aspx" onMouseOver="JavaM(34,4)" class="header"> &nbsp; 廣告費用檢查清單</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/RptCustQuery.aspx" onMouseOver="JavaM(34,4)" class="header"> &nbsp; 客戶基本資料清單</A> '
);

//4-1-1
Layer[35] =    new LayerSpecs(610,44,80,
            '<A HREF="/mrlpub/d4/WorkingProcess/ContQueryCust.aspx" class="header"> &nbsp; 新增合約書</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/ContQueryMaintain.aspx" class="header"> &nbsp; 維護合約書</A> '
);

//4-1-3
Layer[36] =    new LayerSpecs(610,82,70,
            '<A HREF="/mrlpub/d4/WorkingProcess/RptSingleCont0.aspx" class="header"> &nbsp; 單一合約</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/RptContList0.aspx" class="header"> &nbsp; 大批合約</A> '
);
//4-2
Layer[56] =    new LayerSpecs(499,62,80,
            '<A HREF="/mrlpub/d4/WorkingProcess/RptGetAd.aspx" onMouseOver="JavaM(56,4)" class="header"> &nbsp; 催稿單</A> '
);

//4-3
Layer[37] =    new LayerSpecs(499,80,110,
            '<A HREF="/mrlpub/d4/WorkingProcess/AdrQueryCont.aspx" onMouseOver="JavaM(37,4)" class="header"> &nbsp; 廣告落版處理</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/RptAdrBillQuery.aspx" onMouseOver="JavaM(37,4)" class="header"> &nbsp; 廣告落版單</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/RptAdrQuery.aspx" onMouseOver="JavaM(37,4)" class="header"> &nbsp; 廣告落版統計表</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/AdrQueryPublished.aspx" onMouseOver="JavaM(37,4)" class="header"> &nbsp; 美編上稿處理</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/RptFileUpQuery.aspx" onMouseOver="JavaM(37,4)" class="header"> &nbsp; 美編上稿清單</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/AdrGenXml.aspx" onMouseOver="JavaM(37,4)" class="header"> &nbsp; 產生落版播出檔</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/AdrXmlManage.aspx" onMouseOver="JavaM(37,4)" class="header"> &nbsp; 刪除落版播出檔</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/RptAdMadeQuery.aspx" onMouseOver="JavaM(37,4)" class="header"> &nbsp; 廣告製稿統計表</A> '
);

//4-4
Layer[52] = new LayerSpecs(499,98,120,
	'<A HREF="#" onMouseOver="JavaM(61,52,4)" class="header"> &nbsp; 發票開立單產生</A> &nbsp; '+arrow,
	'<A HREF="#" onMouseOver="JavaM(62,52,4)" class="header"> &nbsp; 發票開立檢核表</A> &nbsp; '+arrow,
	'<A HREF="#" onMouseOver="JavaM(63,52,4)" class="header"> &nbsp; 發票開立單回復</A> &nbsp; '+arrow
);

//4-4-1
Layer[61] =    new LayerSpecs(620,98,70,
            '<A HREF="/mrlpub/d4/WorkingProcess/IA1Query.aspx" class="header"> &nbsp; 單一廠商</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/IAQuery.aspx" class="header"> &nbsp; 大批月結</A> '
);

//4-4-2
Layer[62] =    new LayerSpecs(620,117,70,
            '<A HREF="/mrlpub/d4/WorkingProcess/RptIA1_ChkFilter.aspx" class="header"> &nbsp; 單一廠商</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/RptIA_ChkFilter.aspx" class="header"> &nbsp; 大批月結</A> '
);

//4-4-3
Layer[63] =    new LayerSpecs(620,136,70,
            '<A HREF="/mrlpub/d4/WorkingProcess/IA1RecoveryQuery.aspx" class="header"> &nbsp; 單一廠商</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/IARecoveryQuery.aspx" class="header"> &nbsp; 大批月結</A> '
);

//4-5
Layer[57] =    new LayerSpecs(499,116,138,
            '<A HREF="/mrlpub/d1/PayFilter.aspx?caller=" class="header"> &nbsp; 新增繳款單</A> ',
            '<A HREF="/mrlpub/d1/PayFMFilter.aspx" class="header"> &nbsp; 修改繳款單</A> ',
            '<A HREF="/mrlpub/d1/PayDelete.aspx" class="header"> &nbsp; 刪除繳款單</A> ',
            '<A HREF="/mrlpub/d1/CheckList7.aspx" class="header"> &nbsp; 繳款單檢核表</A> ',
...
//4-6
Layer[53] =    new LayerSpecs(499,134,95,
            '<A HREF="/mrlpub/d4/WorkingProcess/RemailAdd.aspx" onMouseOver="JavaM(53,4)" class="header"> &nbsp; 補書登錄</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/RemailMaintain.aspx" onMouseOver="JavaM(53,4)" class="header"> &nbsp; 補書修改/刪除</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/RmListFilter.aspx" onMouseOver="JavaM(53,4)" class="header"> &nbsp; 補書清單</A> '
);

//4-7
Layer[59] =    new LayerSpecs(499,152,95,
            '<A HREF="/mrlpub/d4/WorkingProcess/LostAdd.aspx" onMouseOver="JavaM(59,4)" class="header"> &nbsp; 缺書登錄</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/LostMaintain.aspx" onMouseOver="JavaM(59,4)" class="header"> &nbsp; 缺書修改/刪除</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/LostListFilter.aspx" onMouseOver="JavaM(59,4)" class="header"> &nbsp; 缺書清單</A> '
);

//4-8
Layer[60] =    new LayerSpecs(499,170,130,
            '<A HREF="/mrlpub/d4/WorkingProcess/Pub_LabelFilter.aspx" class="header"> &nbsp; 大宗標籤(當月刊登)</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/UnPub_LabelFilter.aspx" class="header"> &nbsp; 大宗標籤(當月未刊登)</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/RmLabelFilter.aspx" class="header"> &nbsp; 補書標籤</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/LostLabelFilter.aspx" class="header"> &nbsp; 缺書標籤</A> '
);

//4-9
Layer[58] =    new LayerSpecs(499,206,115,
            '<A HREF="/mrlpub/d4/WorkingProcess/RptIncomeQuery.aspx" onMouseOver="JavaM(58,4)" class="header"> &nbsp; 廣告收入統計表</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/RptMailMntQuery.aspx" onMouseOver="JavaM(58,4)" class="header"> &nbsp; 郵寄本數統計表</A> &nbsp; ' ,
            '<A HREF="#" onMouseOver="JavaM(65, 58, 4)" class="header"> &nbsp; 印製份數統計表</A> &nbsp; '+arrow
);

//4-9-1
Layer[65] =    new LayerSpecs(615,244,80,
            '<A HREF="/mrlpub/d4/WorkingProcess/RptBookMntQuery.aspx?type=pub" class="header"> &nbsp; 當月刊登</A> ',
            '<A HREF="/mrlpub/d4/WorkingProcess/RptBookMntQuery.aspx?type=unpub" class="header"> &nbsp; 當月未刊登</A> '
);
//test
