...
<%@ Page language="c#" Codebehind="LostAdd.aspx.cs" Src="LostAdd.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d4.LostAdd" %>
...
<table>
  <tr>
    <td style="WIDTH: 627px" align=left><font 
      color=#333333 size=2><IMG height=10 src="images/header/right02.gif" width=10 border=0 > &nbsp;材料世界網廣告次系統<IMG height=10 src="images/header/right02.gif" width=10 border=0 > 缺書處理 <IMG height=10 src="images/header/right02.gif" width=10 border=0 >&nbsp;缺書登錄 
</font></td></tr></table>
...
<DIV align=left><asp:datagrid id=dgdContOr runat="server" AllowPaging="True" CellPadding="2" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" BorderStyle="None" AutoGenerateColumns="False" Font-Size="X-Small">
...
<asp:ButtonColumn Text="缺書登錄" ButtonType="PushButton" CommandName="Select"></asp:ButtonColumn>
				...
				</asp:datagrid><asp:label id=lblInfo Runat="server"></asp:label><asp:datagrid id=dgdLost runat="server" CellPadding="2" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" BorderStyle="None" AutoGenerateColumns="False" Font-Size="X-Small">
<FooterStyle ForeColor="#003399" BackColor="#99CCCC">
</FooterStyle>
