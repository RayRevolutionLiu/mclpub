...
namespace MRLPub.d5
{
	...
	/// </summary>
	public class syscd : System.Web.UI.Page
	{
		...
		{
			Response.Redirect("syscd_addnew.aspx");
		}
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			SqlDataAdapter cmd=new SqlDataAdapter("delete from syscd where sys_sysid=@sys_sysid",myConn);
		
			cmd.SelectCommand.Parameters.Add("@sys_sysid",SqlDbType.Int,4).Value=e.Item.Cells[0].Text;
		...
		private void DataGrid1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("syscd_edit.aspx?" + id);
		}
