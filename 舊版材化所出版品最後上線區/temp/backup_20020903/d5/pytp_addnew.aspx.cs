...
namespace MRLPub.d5
{
	...
	/// </summary>
	public class pytp_addnew : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				//起始值為末值加一
				SqlDataAdapter cmd=new SqlDataAdapter("select count(*) as C1,max(pytp_pytpcd) as MaxCountNo from pytp",myConn);
				...
				pytp_pytpcd.Text=strAssignedContNo;
			}
		}
		...
		private void btnAddNew_Click(object sender, System.EventArgs e)
		{
			...
			{
				SqlDataAdapter cmd=new SqlDataAdapter("insert into pytp(pytp_pytpcd,pytp_nm) values(@pytp_pytpcd,@pytp_nm)",myConn);
				...
				Response.Redirect("pytp.aspx?ID=addnew_ok");
			}
