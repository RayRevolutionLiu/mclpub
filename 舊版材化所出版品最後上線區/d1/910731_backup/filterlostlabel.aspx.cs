...
{
	/// <summary>
	/// Summary description for filterlostlabel.
	/// </summary>
	public class filterlostlabel : System.Web.UI.Page
	{
		...
		{    
			...
			this.sqlInsertCommand2.CommandText = "INSERT INTO dbo.c1_lost(lst_syscd, lst_custno, lst_otp1cd, lst_otp1seq, lst_orite" +
				"m, lst_seq, lst_date, lst_fgsent) VALUES (@lst_syscd, @lst_custno, @" +
				"lst_otp1cd, @lst_otp1seq, @lst_oritem, @lst_seq, @lst_date, @lst_fgsent, @lst_st" +
				"atus)";
