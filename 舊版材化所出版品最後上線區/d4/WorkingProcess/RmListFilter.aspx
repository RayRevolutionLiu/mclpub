<%@ Page language="c#" Codebehind="RmListFilter.aspx.cs" src="RmListFilter.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d4.RmListFilter" %>
						...
						<TABLE class="TableColor" style="WIDTH: 604px" cellSpacing="0" cellPadding="2">
							...
							<tr>
								...
								<td>
									...
									<IMG class="ico" title="日曆" onclick="javascript:pick_date_single(tbxRemailDate1.name)" src="../../images/calendar01.gif">
									～<asp:textbox id="tbxRemailDate2" runat="server" Width="84px"></asp:textbox><IMG class="ico" title="日曆" onclick="javascript:pick_date_single(tbxRemailDate2.name)" src="../../images/calendar01.gif">
								</td>
							</tr>
							<tr>
								<td align="right">
