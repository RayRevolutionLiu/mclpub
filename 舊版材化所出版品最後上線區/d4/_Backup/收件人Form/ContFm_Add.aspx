		...
		<center>
			...
			<form id="ContFm_Add" method="post" runat="server">
				...
				<TABLE cellSpacing="0" cellPadding="4" width="92%" bgColor="#bfcff0" border="0">
					...
					<TR bgColor="#214389">
						<td colSpan="4">
							<font color="#ffffff">合約書基本資料&nbsp;&nbsp;</font>&nbsp;&nbsp;<font siz2="2" color="yellow">(本區沒有載入歷史資料, 
								請自行輸入確認!)</font>&nbsp;
							...
							<TABLE borderColor="#214389" cellSpacing="1" cellPadding="1" width="90%" border="0">
								...
								<TR vAlign="center" align="left">
									...
									<TD class="cssData" colspan="2">
										<font color="#c00000">(彩/套/黑白次數=總刊登次數 + 贈送次數)</font>
									</TD>
								</TR>
								<TR vAlign="center" align="left">
									<TD class="cssTitle" noWrap align="right">
					...
					<TR bgColor="#214389">
						<TD colSpan="4">
							...
							<asp:ImageButton id="imbORRefresh" runat="server" ImageUrl="../images/refresh.gif" AlternateText="重新整理 雜誌收件人資料"></asp:ImageButton>
						</TD>
					</TR>
					<TR>
						<TD colspan="4">
					...
					<TR bgcolor="#ffffff">
						<TD colSpan="4" align="middle">
							...
							&nbsp;&nbsp;
							<asp:Button id="btnCancel" runat="server" Text="放棄新增"></asp:Button>
							<FONT face="新細明體">&nbsp;&nbsp; </FONT>
							<asp:Button id="btnBack" runat="server" Text="取消回首頁"></asp:Button>
						</TD>
					</TR>
				</TABLE>
			</form>
