	...
	public class mfr_detail : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!Page.IsPostBack)
			{
				...
				{
					Response.Write("<font size=2 color=red><b>資料庫中無此 廠商統編, 所以查無資料!</b></font><br><br>");
				}
		...
		{    
			...
			this.sqlConnection1.ConnectionString = "data source=isccom1;initial catalog=mrlpub;password=db600;persist security info=T" +
				"rue;user id=webuser;workstation id=17-0900103-01;packet size=4096";
		...
		private void CheckExist()
		{
			...
			if(dv1.Count <= 0)
			{
				Response.Write("<font size=2 color=red><b>資料庫中無此 廠商統編及其資料, 請先<A HREF='../d5/mfr_addnew.aspx' Target='_blank'>新增此廠商</A>!</b></font><br><br>");
			}
			else
			{
				// 若有此 廠商統編, 則顯示其相關資料
		...
		private void GetData()
		{
			...
			{
				// 若找無資料, 則清除資料
				this.lblMfrIName.Text = "(<font color='RED'>查無此廠商統編, 請先<A HREF='../d5/mfr_addnew.aspx' Target='_blank'>新增此廠商</A>!</font>)";
				this.lblMfrNo.Text = "";
