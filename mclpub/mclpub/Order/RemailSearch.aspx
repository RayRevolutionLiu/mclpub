<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="RemailSearch.aspx.cs" Inherits="mclpub.Sys.RemailSearch"  MaintainScrollPositionOnPostback="true" %>
<%@ Register Src="../UserControl/Pager.ascx" TagName="UCPager" TagPrefix="uc3" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <span class="font_size12 font_darkblue font_bold">目前位置:&nbsp;訂戶管理 / 雜誌叢書訂單處理 /
        <asp:Label ID="titlelb" runat="server"></asp:Label></span>
<span class="stripeMe">
    <table cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                &nbsp;～<asp:TextBox ID="tbxOrderDate2" runat="server" CssClass="UniqueDate"></asp:TextBox>&nbsp;</td>
        </tr>
        <tr>
            <th colspan="4">
...
<span class="stripeMe">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" PageSize="10"
        ...
        AllowPaging="true" PagerSettings-Visible="false" AllowSorting ="true" OnSorting="gv_data_Sorting">
        <Columns>
            ...
            <asp:BoundField DataField="od_sdate" HeaderText="訂閱起時▲" SortExpression ="od_sdate" HeaderStyle-Width="80px" HeaderStyle-ForeColor="White" />
            <asp:BoundField DataField="od_edate" HeaderText="訂閱迄時▲" SortExpression ="od_edate" HeaderStyle-Width="80px" HeaderStyle-ForeColor="White" />
            <asp:TemplateField HeaderStyle-Width="7%" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <asp:Button ID="btnComplement" runat="server" Text="補書" OnClick="btnComplement_Click"
...
<PagerSettings Visible="true"></PagerSettings>
        ...
        <div align="center">
                            ...
                            <asp:LinkButton ID="lbtn_last" runat="server" CausesValidation="false"
                                CommandArgument="last" OnClick="Query_Click">最末頁</asp:LinkButton>
                            &nbsp;共
                            <asp:Label ID="lbl_pagecount" runat="server" Text="0"></asp:Label>&nbsp;頁&nbsp;，
                            共&nbsp;<asp:Label ID="lbl_datacount" runat="server" Text="0"></asp:Label>&nbsp;筆 
                            &nbsp;&nbsp;移至第&nbsp;<asp:DropDownList ID="ddl_gopage" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddl_gopage_SelectedIndexChanged"></asp:DropDownList>
                            &nbsp;頁
        </div>
        </PagerTemplate>
    </asp:GridView>
...
<span class="stripeMe">
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="false" PageSize="10"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="orderno" HeaderText="訂單編號" />
                <asp:BoundField DataField="rm_seq" HeaderText="補書序號" />
                ...
                <asp:BoundField DataField="rm_oritem" HeaderText="收件人序號" />
                <asp:BoundField DataField="or_nm" HeaderText="收件人" />
                <asp:BoundField DataField="rm_cont" HeaderText="補書內容" />
                <asp:TemplateField HeaderStyle-Width="7%" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:Button ID="btnComplement" runat="server" Text="修改資料" OnClick="edit_Click"
                            CausesValidation="false" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
