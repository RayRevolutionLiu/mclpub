<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="iaFm1_Rec.aspx.cs" Inherits="mclpub.SetAccount.iaFm1_Rec"  MaintainScrollPositionOnPostback="true"%>
<%@ Register Src="../UserControl/Pager.ascx" TagName="UCPager" TagPrefix="uc3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<span class="font_size12 font_darkblue font_bold">目前位置:&nbsp;帳務管理 / 平面廣告發票處理 / 發票開立單回復 
    (Recovery)- 一次付款-步驟一:挑選發票廠商</span><span class="stripeMe"><table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
  ...
  <tr>
    ...
    <td align="left">
        ...
        <asp:Label ID="lblMfrNo" runat="server" Font-Size="Small" ForeColor="#C00000"></asp:Label>
...
<span class="font_size13 font_bold font_gray">
    <ol>
       <li>請挑選要回復的合約書編號及發票廠商收件人, 再按下<span class="font_darkblue">確認挑選</span>按鈕</li>
       <li>請挑選要回復的發票開立單編號, 再按下<span class="font_darkblue">確認挑選</span>按鈕!</li>
    </ol>
</span>
