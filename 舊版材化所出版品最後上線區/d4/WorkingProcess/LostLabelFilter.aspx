...
<%@ Page language="c#" Codebehind="LostLabelFilter.aspx.cs" src="LostLabelFilter.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d4.LostLabelFilter" %>
...
<HTML>
	...
	<body>
		<form id="LostLabelFilter" method="post" runat="server">
			...
			<FONT color="#333333" size="2"><IMG height="10" src="../../images/header/right02.gif" width="10" border="0">
				...
				標籤處理 <IMG height="10" src="../../images/header/right02.gif" width="10" border="0">缺書標籤列印
			</FONT>
			<br>
				...
				<ItemTemplate>
					<TABLE>
						<TR>
							...
							<TD>
								<asp:Label id="lblContno" Width="60" text='<%# DataBinder.Eval(Container.DataItem, "lst_contno")%>' Runat="server">
								</asp:Label>
							</TD>
							<TD>
							...
							<TD>
								<asp:Label id="lblFbkitem" Width="40" text='<%# DataBinder.Eval(Container.DataItem, "lst_fbkitem")%>' Runat="server">
								</asp:Label>
							</TD>
							<TD>
								<asp:Label id="lblOritem" Width="40" text='<%# DataBinder.Eval(Container.DataItem, "lst_oritem")%>' Runat="server">
								</asp:Label>
							</TD>
							<TD>
							...
							<TD>
								<asp:Label id="lblSeq" Width="40" text='<%# DataBinder.Eval(Container.DataItem, "lst_seq")%>' Runat="server">
								</asp:Label>
							</TD>
							<TD>
								<asp:Label id="lblCont" Width="150" text='<%# DataBinder.Eval(Container.DataItem, "lst_cont")%>' Runat="server">
								</asp:Label>
							</TD>
							<TD>
								<asp:Label id="lblRea" Width="150" text='<%# DataBinder.Eval(Container.DataItem, "lst_rea")%>' Runat="server">
								</asp:Label>
							</TD>
							<TD>
								<asp:Label id="lblFlagSent" Width="60" text='<%# GetFgSentName(DataBinder.Eval(Container.DataItem, "lst_fgsent")) %>' Runat="server">
								</asp:Label>
							</TD>
						</TR>
					</TABLE>
