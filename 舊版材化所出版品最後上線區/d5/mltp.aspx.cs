...
namespace MRLPub.d5
{
	...
	/// </summary>
	public class mltp : System.Web.UI.Page
	{
		...
		public void BindGrid()
		{
			...
			string SQL = "SELECT dbo.mltp.*, dbo.syscd.sys_nm AS sys_nm, dbo.mailer.ml_nm AS ml_nm, dbo.mtp.mtp_nm AS mtp_nm FROM dbo.mltp INNER JOIN dbo.syscd ON dbo.mltp.mltp_syscd = dbo.syscd.sys_syscd INNER JOIN dbo.mailer ON dbo.mltp.mltp_mlcd = dbo.mailer.ml_mlcd INNER JOIN dbo.mtp ON dbo.mltp.mltp_mltpcd = dbo.mtp.mtp_mtpcd";
		...
		{
			Response.Redirect("mltp_addnew.aspx");
		}
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			SqlDataAdapter cmd=new SqlDataAdapter("delete from mltp where mltp_mltpid=@mltp_mltpid",myConn);
		
			cmd.SelectCommand.Parameters.Add("@mltp_mltpid",SqlDbType.Int,4).Value=e.Item.Cells[0].Text;
		...
		private void DataGrid1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("mltp_edit.aspx?" + id);
		}
