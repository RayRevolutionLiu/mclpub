<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="RemailForm.aspx.cs" Inherits="mclpub.Sys.RemailForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <span class="font_size12 font_darkblue font_bold">目前位置:&nbsp;訂戶管理 / 雜誌叢書訂單處理 / 補書登錄</span>
    <span class="stripeMe">
    ...
    <asp:Button ID="btnOK" runat="server" Text="確定新增補書資料" onclick="btnOK_Click"></asp:Button>
    <asp:Button ID="btnCancel" runat="server" Text="取消回首頁" onclick="btnCancel_Click"></asp:Button>
    </div>
</asp:Content>
