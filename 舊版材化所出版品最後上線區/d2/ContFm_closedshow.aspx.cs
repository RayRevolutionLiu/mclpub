...
{
	/// <summary>
	/// Summary description for ContFm_closedshow.
	/// </summary>
	public class ContFm_closedshow : System.Web.UI.Page
	{
		...
		private void ShowCont()
		{
			...
			for(i=0; i< DataGrid1.Items.Count ; i++)
			{
				...
				// 已註銷註記
				string strfgcancel = DataGrid1.Items[i].Cells[12].Text.ToString().Trim();
		...
		{
			Response.Redirect("ContFm_closedshow.aspx");
		}
