	...
	public class ContFm_Add : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(!Page.IsPostBack)
			{
				...
				{
					// 告知 參考合約書編號 無歷史資料
					this.lblOldContNo.Text = "(無歷史資料, 此為新合約)";
		...
		private void InitialData()
		{
			...
			//Response.Write("TotalCount= " + dv4[0][0].ToString().Trim() + "<br>");
...
//				}	
		...
		private void LoadOldCont()
		{
			...
			if(dv5.Count > 0)
			{
				...
				this.tbxADAoumt.Text = dv5[0]["cont_adamt"].ToString().Trim();
		...
		private void InsertToDB()
		{
			...
			// 合約總金額 自己輸入
			string strTotalAoumt = this.tbxTotalAmt.Text.ToString().Trim();
//			// 計算 合約總金額 = ( (廣告費單價 * 優惠折數) * 總製稿次數)
//			int adamt = int.Parse(this.tbxADAoumt.Text.ToString().Trim());
//			string disc = this.tbxDiscount.Text.ToString().Trim();
//			//Response.Write("disc= " + disc + "<br>");
//			int intdisc = Convert.ToInt32(Convert.ToDecimal(disc));
//			//Response.Write("intdisc= " + intdisc + "<br>");
//			int totjtm = int.Parse(this.tbxTotalJTime.Text.ToString().Trim());
//			int strTotalAoumt = adamt * intdisc * totjtm;
			//Response.Write("strTotalAoumt= " + strTotalAoumt + "<br>");
			string strPubAoumt = "0";
			string strChangeAoumt = "0";
			string strPaidAoumt = "0";
			string strRestAoumt = this.tbxTotalAmt.Text.ToString().Trim();
			...
			string strADAoumt = this.tbxADAoumt.Text.ToString().Trim();
			
			// 廣告聯絡人 區
			string strAUName = this.tbxAuName.Text.ToString().Trim();
			string strAUTel = this.tbxAuName.Text.ToString().Trim();
			string strAUFax = this.tbxAuName.Text.ToString().Trim();
			string strAUCell = this.tbxAuName.Text.ToString().Trim();
			string strAUEmail = this.tbxAuName.Text.ToString().Trim();
			...
			this.sqlCommand1.Parameters["@totamt"].Value = strTotalAoumt;
			this.sqlCommand1.Parameters["@pubamt"].Value = strPubAoumt;
			this.sqlCommand1.Parameters["@chgamt"].Value = strChangeAoumt;
			this.sqlCommand1.Parameters["@paidamt"].Value = strPaidAoumt;
			this.sqlCommand1.Parameters["@restamt"].Value = strRestAoumt;
			this.sqlCommand1.Parameters["@clrtm"].Value = strColorTime;
			this.sqlCommand1.Parameters["@memotm"].Value = strMemoTime;
			this.sqlCommand1.Parameters["@getclrtm"].Value = strGetColorTime;
			this.sqlCommand1.Parameters["@adamt"].Value = strADAoumt;
			...
			if (ResultFlag1)
			{
				...
				litAlert.Text = "<script language=javascript>alert(\"新增合約書成功\");</script>";
			...
			else
			{
				...
				LiteralControl litAlert = new LiteralControl();
				litAlert.Text = "<script language=javascript>alert(\"新增合約書失敗\");</script>";
				Page.Controls.Add(litAlert);
			}
...
//			}
		...
		{    
			...
			// sqlCommand1
			// 
			this.sqlCommand1.CommandText = @"INSERT INTO c2_cont (cont_conttp, cont_bkcd, cont_signdate, cont_empno, cont_mfrno, cont_aunm, cont_autel, cont_aufax, cont_aucell, cont_auemail, cont_sdate, cont_edate, cont_totjtm, cont_madejtm, cont_restjtm, cont_disc, cont_freetm, cont_fgclosed, cont_tottm, cont_pubtm, cont_resttm, cont_chgjtm, cont_custno, cont_totamt, cont_pubamt, cont_chgamt, cont_paidamt, cont_restamt, cont_clrtm, cont_menotm, cont_getclrtm, cont_oldcontno, cont_moddate, cont_fgpayonce, cont_modempno, cont_fgcancel, cont_credate, cont_syscd, cont_contno, cont_adamt) VALUES (@conttp, @bkcd, @signdate, @empno, @mfrno, @aunm, @autel, @aufax, @aucell, @auemail, @sdate, @edate, @totjtm, @madejtm, @restjtm, @disc, @freetm, @fgclosed, @tottm, @pubtm, @resttm, @chgjtm, @custno, @totamt, @pubamt, @chgamt, @paidamt, @restamt, @clrtm, @memotm, @getclrtm, @oldcontno, @moddate, @fgpayonce, @modempno, @fgcancel, @credate, @syscd, @contno, @adamt)";
			...
			this.sqlCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@mfrno", System.Data.SqlDbType.Char, 10, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "cont_mfrno", System.Data.DataRowVersion.Current, null));
			...
			this.sqlCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@custno", System.Data.SqlDbType.Char, 6, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "cont_custno", System.Data.DataRowVersion.Current, null));
			...
			this.sqlCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@memotm", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "cont_menotm", System.Data.DataRowVersion.Current, null));
			...
			this.sqlCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@oldcontno", System.Data.SqlDbType.Char, 7, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "cont_oldcontno", System.Data.DataRowVersion.Current, null));
			...
			this.sqlCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@credate", System.Data.SqlDbType.Char, 8, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "cont_credate", System.Data.DataRowVersion.Current, null));
