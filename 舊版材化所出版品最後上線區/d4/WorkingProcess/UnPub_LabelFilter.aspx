<%@ Page language="c#" Codebehind="UnPub_LabelFilter.aspx.cs" src="UnPub_LabelFilter.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d4.WorkingProcess.UnPub_LabelFilter" %>
<%@ Register TagPrefix="kw" TagName="header" Src="~/UserControl/header.ascx" %>
<%@ Register TagPrefix="kw" TagName="footer" Src="~/UserControl/footer.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>UnPub_LabelFilter</title>
	...
	<body>
		<form id="UnPub_LabelFilter" method="post" runat="server">
					...
					<td>
						...
						<asp:datagrid id="dgdLabel" runat="server" CssClass="DataGridStyle" AutoGenerateColumns="False">
							...
							<Columns>
								...
								<asp:BoundColumn DataField="ma_mnt" HeaderText="未登本數"></asp:BoundColumn>
