	...
	<body>
		<form id="cont_list2" method="post" runat="server">
			<%
				...
				sqlcmd2 = sqlcmd2 & " c2_cont.cont_contno, c2_cont.cont_conttp, "
				sqlcmd2 = sqlcmd2 & " c2_cont.cont_bkcd, RTRIM(c2_cont.cont_mfrno) AS cont_mfrno, "
				sqlcmd2 = sqlcmd2 & " RTRIM(mfr.mfr_inm) AS mfr_inm, c2_or.or_mtpcd, "
				sqlcmd2 = sqlcmd2 & " RTRIM(mtp.mtp_nm) AS mtp_nm, c2_or.or_fgmosea, "
				sqlcmd2 = sqlcmd2 & " COUNT(c2_or.or_pubcnt) AS PubCounts, "
				sqlcmd2 = sqlcmd2 & " c2_cont.cont_sdate, c2_cont.cont_edate, "
				sqlcmd2 = sqlcmd2 & " SUBSTRING(c2_cont.cont_sdate, 1, 4) "
				sqlcmd2 = sqlcmd2 & " + '/' + SUBSTRING(c2_cont.cont_sdate, 5, 2) "
				sqlcmd2 = sqlcmd2 & " + ' ~ ' + SUBSTRING(c2_cont.cont_edate, 1, 4) "
				sqlcmd2 = sqlcmd2 & " + '/' + SUBSTRING(c2_cont.cont_edate, 5, 2) AS cont_sedate "
				sqlcmd2 = sqlcmd2 & " FROM             c2_pub INNER JOIN "
				sqlcmd2 = sqlcmd2 & " c2_cont INNER JOIN "
				sqlcmd2 = sqlcmd2 & " mfr ON c2_cont.cont_mfrno = mfr.mfr_mfrno ON "
				sqlcmd2 = sqlcmd2 & " c2_pub.pub_syscd = c2_cont.cont_syscd AND "
				sqlcmd2 = sqlcmd2 & " c2_pub.pub_contno = c2_cont.cont_contno INNER JOIN "
				sqlcmd2 = sqlcmd2 & " book ON c2_cont.cont_bkcd = book.bk_bkcd INNER JOIN "
				sqlcmd2 = sqlcmd2 & " mtp INNER JOIN "
				sqlcmd2 = sqlcmd2 & " c2_or ON mtp.mtp_mtpcd = c2_or.or_mtpcd ON "
				sqlcmd2 = sqlcmd2 & " c2_cont.cont_syscd = c2_or.or_syscd AND "
				sqlcmd2 = sqlcmd2 & " c2_cont.cont_contno = c2_or.or_contno "
				...
				sqlcmd2 = sqlcmd2 & " AND (c2_or.or_pubcnt > 0) "
				...
				sqlcmd2 = sqlcmd2 & " GROUP BY  c2_cont.cont_contno, c2_cont.cont_conttp, c2_cont.cont_bkcd, "
				sqlcmd2 = sqlcmd2 & " c2_cont.cont_mfrno, mfr.mfr_inm, c2_or.or_mtpcd, "
				sqlcmd2 = sqlcmd2 & " mtp.mtp_nm, c2_or.or_fgmosea, "
				sqlcmd2 = sqlcmd2 & " c2_cont.cont_sdate, c2_cont.cont_edate "
				...
				sqlcmd1 = sqlcmd1 & " c2_cont.cont_contno, c2_cont.cont_conttp, "
				sqlcmd1 = sqlcmd1 & " c2_cont.cont_bkcd, RTRIM(c2_cont.cont_mfrno) AS cont_mfrno, "
				sqlcmd1 = sqlcmd1 & " RTRIM(mfr.mfr_inm) AS mfr_inm, c2_or.or_mtpcd, "
				sqlcmd1 = sqlcmd1 & " RTRIM(mtp.mtp_nm) AS mtp_nm, c2_or.or_fgmosea, "
				sqlcmd1 = sqlcmd1 & " COUNT(c2_or.or_pubcnt) AS PubCounts, "
				sqlcmd1 = sqlcmd1 & " c2_cont.cont_sdate, c2_cont.cont_edate, "
				sqlcmd1 = sqlcmd1 & " SUBSTRING(c2_cont.cont_sdate, 1, 4) "
				sqlcmd1 = sqlcmd1 & " + '/' + SUBSTRING(c2_cont.cont_sdate, 5, 2) "
				sqlcmd1 = sqlcmd1 & " + ' ~ ' + SUBSTRING(c2_cont.cont_edate, 1, 4) "
				sqlcmd1 = sqlcmd1 & " + '/' + SUBSTRING(c2_cont.cont_edate, 5, 2) AS cont_sedate "
				sqlcmd1 = sqlcmd1 & " FROM             c2_pub INNER JOIN "
				sqlcmd1 = sqlcmd1 & " c2_cont INNER JOIN "
				sqlcmd1 = sqlcmd1 & " mfr ON c2_cont.cont_mfrno = mfr.mfr_mfrno ON "
				sqlcmd1 = sqlcmd1 & " c2_pub.pub_syscd = c2_cont.cont_syscd AND "
				sqlcmd1 = sqlcmd1 & " c2_pub.pub_contno = c2_cont.cont_contno INNER JOIN "
				sqlcmd1 = sqlcmd1 & " book ON c2_cont.cont_bkcd = book.bk_bkcd INNER JOIN "
				sqlcmd1 = sqlcmd1 & " mtp INNER JOIN "
				sqlcmd1 = sqlcmd1 & " c2_or ON mtp.mtp_mtpcd = c2_or.or_mtpcd ON "
				sqlcmd1 = sqlcmd1 & " c2_cont.cont_syscd = c2_or.or_syscd AND "
				sqlcmd1 = sqlcmd1 & " c2_cont.cont_contno = c2_or.or_contno "
				...
				sqlcmd1 = sqlcmd1 & " AND (c2_or.or_pubcnt > 0) "
				...
				sqlcmd1 = sqlcmd1 & " GROUP BY  c2_cont.cont_contno, c2_cont.cont_conttp, c2_cont.cont_bkcd, "
				sqlcmd1 = sqlcmd1 & " c2_cont.cont_mfrno, mfr.mfr_inm, c2_or.or_mtpcd, "
				sqlcmd1 = sqlcmd1 & " mtp.mtp_nm, c2_or.or_fgmosea, "
				sqlcmd1 = sqlcmd1 & " c2_cont.cont_sdate, c2_cont.cont_edate "
				...
				' 若有資料, 則輸出至 ExcelSpeedGen
					...
					for i = 0 to rescount -1 step 1
						...
						'Response.Write("mfr_inm= " & Rs1("mfr_inm").Value & ", ")
						'Response.Write("mtp_nm= " & Rs1("mtp_nm").Value & ", ")
						'Response.Write("PubCounts= " & Rs1("PubCounts").Value & "<br>")
					...
					SrcBook = Server.MapPath("ORCounts_stat2a.xls")

					' Generate SpreadSheet and Stream to Client, Open in Place
					XLS.Generate(SrcBook, "ORCounts_stat2a.xls", True)
