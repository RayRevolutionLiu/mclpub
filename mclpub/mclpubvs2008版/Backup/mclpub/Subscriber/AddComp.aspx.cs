        ...
        protected void submitBtn_Click(object sender, EventArgs e)
        {
            if (Request.QueryString["ID"] != null)
            {
                myAdC.UpdateComp(Labelddlmfr_type.Text.Trim(), mfr_inm.Text.Trim(), mfr_addr.Text.Trim(), mfr_izip.Text.Trim(),
                    mfr_respnm.Text.Trim(), mfr_respjbti.Text.Trim(), mfr_tel.Text.Trim(), mfr_fax.Text.Trim(), createdate.Text.Trim(), Request.QueryString["ID"].ToString());
            ...
            else
            {
                ...
                myAdC.InsertNewComp(mfr_mfrno.Text.Trim(), mfr_inm.Text.Trim(), mfr_addr.Text.Trim(), mfr_izip.Text.Trim(),
                    mfr_respnm.Text.Trim(), mfr_respjbti.Text.Trim(), mfr_tel.Text.Trim(), mfr_fax.Text.Trim(), createdate.Text.Trim());
