...
<%@ Page language="c#" Codebehind="RptAdAmtQuery.aspx.cs" src="RptAdAmtQuery.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d4.WorkingProcess.RptAdAmtQuery" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptAdAmtQuery</title>
	...
	<body>
		<form id="RptAdAmtQuery" method="post" runat="server">
				...
				<tr>
					<td align="middle">
						<TABLE id="tbItems" width="90%">
							<TR>
								<TD style="WIDTH: 100%" align="left"><FONT color="#333333" size="2"><IMG height="10" src="../../images/header/right02.gif" width="10" border="0">
										...
										合約處理 <IMG height="10" src="../../images/header/right02.gif" width="10" border="0">&nbsp;廣告費用檢查清單</FONT>
								</TD>
							</TR>
						</TABLE>
						<TABLE class="TableColor" id="Table1" cellSpacing="0" cellPadding="1" width="90%" border="0">
							...
							<TR>
								<TD align="right" width="140"><asp:checkbox id="cbxAdDate" runat="server" Text="廣告日區間："></asp:checkbox></TD>
							...
							<TR>
								...
								<TD><FONT face="新細明體"></FONT><br>
									<asp:button id="btnPrint" runat="server" Text="產生廣告費用檢查清單"></asp:button></TD>
							</TR>
						</TABLE>
