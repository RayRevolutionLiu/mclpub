<%@ Page language="c#" Codebehind="adcolor_edit.aspx.cs" Src="adcolor_edit.aspx.cs" AutoEventWireup="false" Inherits="MRLPub.d2.adcolor_edit" %>
...
<HTML>
	...
	<body>
		<center>
			...
			&nbsp; 
			<!-- Run at Server Form -->
			<form id="adcolor_edit" method="post" runat="server">
				<!-- 修改 Table -->
				<TABLE cellSpacing="1" cellPadding="3" width="55%" bgColor="#bfcff0" border="0">
					<TR bgColor="#214389">
						<TD colSpan="4">
							<FONT color="#ffffff">修改廣告色彩</FONT>
						</TD>
					</TR>
					<TR>
						<TD width="30%">
