...
namespace MRLPub.d5
{
	...
	/// </summary>
	public class mailer : System.Web.UI.Page
	{
		...
		{
			Response.Redirect("mailer_addnew.aspx");
		}
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			SqlDataAdapter cmd=new SqlDataAdapter("delete from mailer where ml_mlid=@ml_mlid",myConn);
		
			cmd.SelectCommand.Parameters.Add("@ml_mlid",SqlDbType.Int,4).Value=e.Item.Cells[0].Text;
		...
		private void DataGrid1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("mailer_edit.aspx?" + id);
		}
