...
namespace mclpub
{
    public class ORForm_DB
    {
        ...
        public void UpdateC2_orALL(string strMfrinm, string strORName, string strORJobTitle, string strORZipcode, string strORAddr, string strORTel, string strORFax, string strORCell, string strOREmail, int strORPubCount, int strORUnPubCount, string strORmtpcd, string strORfgmosea, string strsyscd, string strcontno, string strORItem)
        {
            ...
            oCmd.Parameters.AddWithValue("@pubcnt", strORPubCount);
            oCmd.Parameters.AddWithValue("@unpubcnt", strORUnPubCount);
