...
//				"rue;user id=webuser;workstation id=03212-840695;packet size=4096";
			...
			// sqlUpdateOrderIano
			// 
			this.sqlUpdateOrderIano.CommandText = "UPDATE dbo.c1_order SET o_iano = @o_iano WHERE (o_syscd = @o_syscd) AND (o_custno" +
				" = @o_custno) AND (o_otp1cd = @o_otp1cd) AND (o_otp1seq = @o_otp1seq)";
			...
			// sqlSelectCommand1
			// 
			this.sqlSelectCommand1.CommandText = @"SELECT dbo.c1_order.o_oid, dbo.c1_order.o_syscd, dbo.c1_order.o_custno, dbo.c1_order.o_otp1cd, dbo.c1_order.o_otp1seq, dbo.c1_order.o_otp2cd, dbo.c1_order.o_mfrno, dbo.c1_order.o_date, dbo.c1_order.o_xmldata, dbo.c1_order.o_cancel, dbo.c1_order.o_iano, dbo.c1_cust.cust_nm, dbo.mfr.mfr_inm, dbo.c1_cust.cust_custno, dbo.mfr.mfr_mfrno, dbo.c1_order.o_syscd + dbo.c1_order.o_custno + dbo.c1_order.o_otp1cd + dbo.c1_order.o_otp1seq AS nostr, dbo.c1_order.o_indate, dbo.c1_order.o_special FROM dbo.c1_order INNER JOIN dbo.c1_cust ON dbo.c1_order.o_custno = dbo.c1_cust.cust_custno INNER JOIN dbo.mfr ON dbo.c1_order.o_mfrno = dbo.mfr.mfr_mfrno";
...
//					textarea1.Value=((HtmlInputHidden)DataList1.Items[i].FindControl("hiddenXML")).Value;
		...
		private void DataList_DataBind()
		{
			...
			dv1.RowFilter="o_iano='' and o_indate<>'' and o_cancel='0' and o_special='' and (o_otp1cd='01' or o_otp1cd='09')";
			if(dv1.Count<=0)
