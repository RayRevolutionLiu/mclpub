...
{
	/// <summary>
	/// Summary description for PickRecievers.
	/// </summary>
	public class PickRecievers : System.Web.UI.Page
	{
		protected System.Web.UI.WebControls.DataGrid DataGrid1;
		protected System.Web.UI.WebControls.ImageButton btnSearch;
		protected System.Web.UI.WebControls.Button btnModifyRecDB;
		protected System.Web.UI.WebControls.TextBox tbxSearchKey;
		...
		private void LoadXmlFromDB()
		{
			DataSet ds = new DataSet();
			this.sqlDataAdapter1.Fill(ds, "_1_OR");
			DataView dv = ds.Tables["_1_OR"].DefaultView;
			dv.RowFilter = "or_nm Like '%"+tbxSearchKey.Text+"%'";
			...
			XmlDataDocument px = new XmlDataDocument();
			px.LoadXml("<訂單><收件人資料></收件人資料></訂單>");

			//組合XML..
			px.FirstChild.FirstChild.InnerXml = xmldoc.FirstChild.InnerXml;
			tbxXML.Text = px.InnerXml;
			px.Save(Response.Output);
...
//			Response.Write(sw.ToString());
			...
			//Show 1&2 結果是一樣的
//			XmlDataDocument xdd = new XmlDataDocument(ds.Copy());
//			System.IO.StringWriter sw = new System.IO.StringWriter();
//			System.Xml.XmlTextWriter xtw = new XmlTextWriter(sw);
