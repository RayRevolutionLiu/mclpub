	...
	public class SAP : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				dv2.RowFilter="srspn_empno = '"+reg+"' and (srspn_atype='A' or srspn_atype='F')";
				if(dv2.Count<=0)
...
//					dv1.RowFilter="ias_trans_sap = '0' and ias_fgitri=''";
		...
		{    
			...
			this.sqlSelectCommand1.CommandText = "SELECT ias_iasid, ias_syscd, ias_iasdate, ias_iasseq, ias_toitem, ias_cancel, ias" +
				"_trans_sap, ias_createdate, ias_createmen, ias_fgitri FROM dbo.ias WHERE         (ias_fgitri = '') AND (ias_trans_sap = '0')";
