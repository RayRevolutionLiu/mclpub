...
<HTML>
	...
	<body>
		<form id="ORForm" method="post" runat="server">
			...
			<asp:label id="lblHistoryMessage" runat="server" Font-Size="X-Small" ForeColor="Maroon" DESIGNTIMEDRAGDROP="424"></asp:label>
			<br>
			<!-- 雜誌收件人 新增/修改資料 區 -->
			<font color="#ff0066" size="2">[雜誌收件人 新增/修改資料 區]</font>
			<asp:textbox id="tbxORSysCode" runat="server" Font-Size="X-Small" Visible="False" Enabled="False" WIDTH="30px" MaxLength="2">C2</asp:textbox>
			<FONT color="#ff0066" size="2">&nbsp;
				<asp:textbox id="tbxORContNo" runat="server" Font-Size="X-Small" Visible="False" Enabled="False" WIDTH="50px" MaxLength="6"></asp:textbox>
				&nbsp;&nbsp;
			...
			<TABLE id="tblAdd" style="FONT-SIZE: x-small" borderColor="#bfcff0" cellSpacing="0" cellPadding="0" bgColor="#bfcff0" border="1">
				...
				<TBODY>
					<TR bgColor="#e2eafc">
						...
						<TD>
							<asp:textbox id="tbxORMfrIName" runat="server" Font-Size="X-Small" MaxLength="50" Width="80px"></asp:textbox>
						</TD>
						<TD>
							<asp:textbox id="tbxORName" runat="server" Font-Size="X-Small" MaxLength="30" Width="70px"></asp:textbox>
						</TD>
						<TD>
							<asp:textbox id="tbxORJobTitle" runat="server" Font-Size="X-Small" MaxLength="12" Width="70px"></asp:textbox>
						</TD>
						<TD>
							<asp:textbox id="tbxORTel" runat="server" Font-Size="X-Small" WIDTH="90px" MaxLength="30"></asp:textbox>
						</TD>
						<TD>
							<asp:textbox id="tbxORPubCount" runat="server" Font-Size="X-Small" WIDTH="30px" MaxLength="3"></asp:textbox>
						</TD>
						<TD>
							<asp:textbox id="tbxORUnPubCount" runat="server" Font-Size="X-Small" WIDTH="30px" MaxLength="3"></asp:textbox>
						</TD>
						<TD>
							<asp:dropdownlist id="ddlORmtpcd" runat="server" AutoPostBack="True"></asp:dropdownlist>
						</TD>
						<TD>
					...
					<TR bgColor="#e2eafc">
						...
						<TD colSpan="3">
							<asp:textbox id="tbxORZipcode" runat="server" Font-Size="X-Small" MaxLength="5" Width="40px"></asp:textbox>
							&nbsp;
							<asp:textbox id="tbxORAddr" runat="server" Font-Size="X-Small" WIDTH="230px" MaxLength="120"></asp:textbox>
						</TD>
						<TD>
							<asp:textbox id="tbxORFax" runat="server" Font-Size="X-Small" WIDTH="90px" MaxLength="30"></asp:textbox>
						</TD>
						<TD colSpan="2">
							<asp:textbox id="tbxORCell" runat="server" Font-Size="X-Small" WIDTH="80px" MaxLength="30"></asp:textbox>
						</TD>
						<TD colSpan="2">
							<asp:textbox id="tbxOREmail" runat="server" Font-Size="X-Small" WIDTH="160px" MaxLength="80"></asp:textbox>
						</TD>
					</TR>
				</TBODY>
			</TABLE>
			...
			<br>
			<asp:datagrid id="Datagrid2" runat="server" AutoGenerateColumns="False" BorderColor="#3366CC" BorderWidth="1px" BackColor="White" BorderStyle="None" CellPadding="2">
				<HeaderStyle Font-Bold="True" BackColor="#BFCFF0"></HeaderStyle>
				<Columns>
