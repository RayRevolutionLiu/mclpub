<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RmLabelFilterInternet.aspx.cs" Inherits="mclpub.LabelArea.RmLabelFilterInternet"  MasterPageFile="~/MasterPage.Master"%>

<asp:Content id="Content1" ContentPlaceholderID="ContentPlaceHolder1" runat="server">
    <span class="font_size12 font_darkblue font_bold">目前位置:&nbsp;標籤管理 / 網路廣告標籤處理 / 補書標籤</span>
<span class="stripeMe">
        ...
        onitemdatabound="DataList1_ItemDataBound">
                ...
                <table width="100%">
						<tr>
							...
							<td width="15%">
								<asp:Label id="lblContno" text='<%# DataBinder.Eval(Container.DataItem, "rm_contno")%>' runat="server"></asp:Label>
							</td>
							<td width="15%">
								<asp:Label id="lblCompany" text='<%# DataBinder.Eval(Container.DataItem, "mfr_inm")%>' runat="server"></asp:Label>
							</td>
							<td width="15%">
								<asp:Label id="lblOritem" text='<%# DataBinder.Eval(Container.DataItem, "rm_oritem")%>' runat="server"></asp:Label>
							</td>
							<td width="10%">
